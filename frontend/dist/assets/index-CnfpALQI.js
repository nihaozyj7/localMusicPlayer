const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/base-DT2k5XGZ.js","assets/bridge-CJD-9QGY.js"])))=>i.map(i=>d[i]);
import{d as wt,D as Ke,i as S,b as y,f as ko,g as A,h as xt,o as se,j as ii,k as ht,l as Ue,n as Ts,q as So,r as xo,t as Co}from"./bridge-CJD-9QGY.js";import{j as To,E as bt,D as fn,A as M,b as p,s as i,c as x,r as sr,a as he,d as te,M as me,e as f,f as Eo,p as ut,g as Re,h as Io,k as Do,l as Ao,m as Mo,n as Oo,L as Wn,o as it,q as $t,t as hn,u as Mt,v as Ge,w as $n,x as qa,y as Po,z as Lo,B as mn,C as ar,F as ir,G as Ot,H as la,I as rr,J as vs,K as ri,N as qo,O as or,P as kn,Q as lr,R as Ro,S as No,T as Bo,U as ca,V as oi,W as da,X as Fo,Y as cr,Z as sn,_ as zo,$ as Uo,a0 as jo,a1 as Wo,a2 as dr}from"./base-DT2k5XGZ.js";import{r as Sn,a as Pt,f as Ra,p as ua,S as Ho,l as Vo,u as Ko,b as Qt,s as Go,c as pa,m as Yo,d as li}from"./index-B_RISokY.js";const Xo="modulepreload",Qo=function(t){return"/"+t},ci={},pt=function(e,n,s){let a=Promise.resolve();if(n&&n.length>0){let c=function(d){return Promise.all(d.map(m=>Promise.resolve(m).then(h=>({status:"fulfilled",value:h}),h=>({status:"rejected",reason:h}))))};document.getElementsByTagName("link");const o=document.querySelector("meta[property=csp-nonce]"),l=o?.nonce||o?.getAttribute("nonce");a=c(n.map(d=>{if(d=Qo(d),d in ci)return;ci[d]=!0;const m=d.endsWith(".css"),h=m?'[rel="stylesheet"]':"";if(document.querySelector(`link[href="${d}"]${h}`))return;const g=document.createElement("link");if(g.rel=m?"stylesheet":Xo,m||(g.as="script"),g.crossOrigin="",g.href=d,l&&g.setAttribute("nonce",l),document.head.appendChild(g),m)return new Promise((_,$)=>{g.addEventListener("load",_),g.addEventListener("error",()=>$(new Error(`Unable to preload CSS for ${d}`)))})}))}function r(o){const l=new Event("vite:preloadError",{cancelable:!0});if(l.payload=o,window.dispatchEvent(l),!l.defaultPrevented)throw o}return a.then(o=>{for(const l of o||[])l.status==="rejected"&&r(l.reason);return e().catch(r)})};const Jo={CHILD:2},Na=t=>(...e)=>({_$litDirective$:t,values:e});let Ba=class{constructor(e){}get _$AU(){return this._$AM._$AU}_$AT(e,n,s){this._$Ct=e,this._$AM=n,this._$Ci=s}_$AS(e,n){return this.update(e,n)}update(e,n){return this.render(...n)}};const{I:Zo}=To,di=t=>t,ui=()=>document.createComment(""),Vt=(t,e,n)=>{const s=t._$AA.parentNode,a=e===void 0?t._$AB:e._$AA;if(n===void 0){const r=s.insertBefore(ui(),a),o=s.insertBefore(ui(),a);n=new Zo(r,o,t,t.options)}else{const r=n._$AB.nextSibling,o=n._$AM,l=o!==t;if(l){let c;n._$AQ?.(t),n._$AM=t,n._$AP!==void 0&&(c=t._$AU)!==o._$AU&&n._$AP(c)}if(r!==a||l){let c=n._$AA;for(;c!==r;){const d=di(c).nextSibling;di(s).insertBefore(c,a),c=d}}}return n},Je=(t,e,n=t)=>(t._$AI(e,n),t),el={},ur=(t,e=el)=>t._$AH=e,tl=t=>t._$AH,Es=t=>{t._$AR(),t._$AA.remove()};const pi=(t,e,n)=>{const s=new Map;for(let a=e;a<=n;a++)s.set(t[a],a);return s},Ee=Na(class extends Ba{constructor(t){if(super(t),t.type!==Jo.CHILD)throw Error("repeat() can only be used in text expressions")}dt(t,e,n){let s;n===void 0?n=e:e!==void 0&&(s=e);const a=[],r=[];let o=0;for(const l of t)a[o]=s?s(l,o):o,r[o]=n(l,o),o++;return{values:r,keys:a}}render(t,e,n){return this.dt(t,e,n).values}update(t,[e,n,s]){const a=tl(t),{values:r,keys:o}=this.dt(e,n,s);if(!Array.isArray(a))return this.ut=o,r;const l=this.ut??=[],c=[];let d,m,h=0,g=a.length-1,_=0,$=r.length-1;for(;h<=g&&_<=$;)if(a[h]===null)h++;else if(a[g]===null)g--;else if(l[h]===o[_])c[_]=Je(a[h],r[_]),h++,_++;else if(l[g]===o[$])c[$]=Je(a[g],r[$]),g--,$--;else if(l[h]===o[$])c[$]=Je(a[h],r[$]),Vt(t,c[$+1],a[h]),h++,$--;else if(l[g]===o[_])c[_]=Je(a[g],r[_]),Vt(t,a[h],a[g]),g--,_++;else if(d===void 0&&(d=pi(o,_,$),m=pi(l,h,g)),d.has(l[h]))if(d.has(l[g])){const w=m.get(o[_]),O=w!==void 0?a[w]:null;if(O===null){const C=Vt(t,a[h]);Je(C,r[_]),c[_]=C}else c[_]=Je(O,r[_]),Vt(t,a[h],O),a[w]=null;_++}else Es(a[g]),g--;else Es(a[h]),h++;for(;_<=$;){const w=Vt(t,c[$+1]);Je(w,r[_]),c[_++]=w}for(;h<=g;){const w=a[h++];w!==null&&Es(w)}return this.ut=o,ur(t,c),bt}}),fi="runtime-tokens",ft=new Map;function nl(){let t=document.getElementById(fi);return t||(t=document.createElement("style"),t.id=fi,document.head.appendChild(t)),t.sheet}function pr(){const t=nl();if(!t)return;for(let n=t.cssRules.length-1;n>=0;n-=1)t.deleteRule(n);if(!ft.size)return;const e=[...ft.entries()].map(([n,s])=>`${n}:${s} !important`).join(";");try{t.insertRule(`:root{${e}}`,0)}catch(n){console.warn("[runtime-tokens] 规则插入失败",n)}}function lt(t,e){e==null||e===""?ft.delete(t):ft.set(t,e),pr()}function gn(t){for(const[e,n]of Object.entries(t))n==null||n===""?ft.delete(e):ft.set(e,n);pr()}function sl(){return Object.fromEntries(ft)}const ts={fast:200,medium:350,slow:500};function fa(t){if(!t||t.animations===!1)return"0.001ms";const e=t.animationsSpeed;return!e||e==="fast"?null:`${ts[e]??ts.fast}ms`}function al(){return Math.round(Bt()*.6)}function Bt(){const t=getComputedStyle(document.documentElement).getPropertyValue("--dur").trim();if(!t)return ts.fast;const e=parseFloat(t);if(!Number.isFinite(e))return ts.fast;const n=t.endsWith("ms")?e:t.endsWith("s")?e*1e3:e;return Math.max(0,n)}function Fa(t,e){let n=document.getElementById(t);n||(n=document.createElement("style"),n.id=t,document.head.appendChild(n));const s=n.sheet;if(!s)return;for(let r=s.cssRules.length-1;r>=0;r-=1)s.deleteRule(r);if(!e)return;const a=il(e);for(const r of a)try{s.insertRule(r,s.cssRules.length)}catch(o){console.warn("[runtime-tokens] 跳过无效规则",r,o)}}function il(t){const e=[];let n=0,s="";for(const a of t)s+=a,a==="{"?n+=1:a==="}"&&(n-=1,n===0&&(e.push(s.trim()),s=""));return s.trim()&&e.push(s.trim()),e.filter(Boolean)}const hi=(t,e=document)=>e.querySelector(t);function ha(t,e=""){return p`<svg class=${e||M} aria-hidden="true"><use href="#i-${t}"></use></svg>`}function za(t,e,n={}){let s=document.getElementById(t);if(!s){s=document.createElement("div"),s.id=t,s.className=e;for(const[a,r]of Object.entries(n))s.setAttribute(a,r);document.body.appendChild(s)}return s}const rl=()=>za("menu","menu",{hidden:"",role:"menu"}),ol=()=>za("modal-backdrop","modal-backdrop",{hidden:""}),ll=()=>za("toasts","toasts",{"aria-live":"polite"});let Ze=null,Is=0,ma=null;function vn({x:t,y:e,items:n,anchor:s,onPick:a,align:r="left"}){const o=rl(),l=++Is;Ze&&(clearTimeout(Ze),Ze=null);const c=C=>{Jt(),a?.(C)};fn(n.map(C=>{if(C.kind==="sep")return p`<div class="menu__sep"></div>`;if(C.kind==="label")return p`<div class="menu__label">${C.label}</div>`;const q=C.checked!==void 0?ha("check","menu__check"):null;return p`
        <button
        ...
        >
          ${C.icon?ha(C.icon):M}<span>${C.label}</span>
          ${q||(C.hint?p`<span class="u-num u-dim">${C.hint}</span>`:M)}
        </button>`}),o),o.dataset.state="",o.hidden=!1;const d=o.getBoundingClientRect(),m=window.innerWidth,h=window.innerHeight;let g=t,_=e;if(s){const C=s.getBoundingClientRect();g=r==="right"?C.right-d.width:C.left,_=C.bottom+6,_+d.height>h-8&&(_=C.top-d.height-6)}g=Math.max(8,Math.min(g,m-d.width-8)),_=Math.max(8,Math.min(_,h-d.height-8)),o.style.left=`${g}px`,o.style.top=`${_}px`;const $=C=>{o.contains(C.target)||Jt()},w=C=>{C.key==="Escape"&&Jt()},O=()=>Jt();requestAnimationFrame(()=>{l===Is&&(o.dataset.state="open")}),setTimeout(()=>{document.addEventListener("pointerdown",$,!0),document.addEventListener("keydown",w),window.addEventListener("resize",O)},0),ma=()=>{document.removeEventListener("pointerdown",$,!0),document.removeEventListener("keydown",w),window.removeEventListener("resize",O),ma=null,o.dataset.state="closed",Ze&&clearTimeout(Ze),Ze=setTimeout(()=>{Ze=null,l===Is&&(o.hidden=!0,fn(M,o))},al()+20)}}function Jt(){ma?.()}let et=null,Ds=0;function ee(t){const e=ol(),n=wt("ok");et&&(clearTimeout(et),et=null);const s=++Ds;let a=!1;const r=()=>{a||(a=!0,document.removeEventListener("keydown",d),e.dataset.state="closed",et&&clearTimeout(et),et=setTimeout(()=>{et=null,s===Ds&&(e.hidden=!0,fn(M,e))},Bt()+20))},o=async()=>{const g=e.querySelector(".modal");await t.onCancel?.(g)!==!1&&r()},l=g=>{const _={};return g.querySelectorAll("[data-field]").forEach($=>{_[$.dataset.field]=$.type==="checkbox"?$.checked:$.value}),_},c=async()=>{const g=e.querySelector(".modal"),_=await t.onOk?.(l(g),g);if(_!==!1){if(typeof _=="string"){const $=e.querySelector("#modal-error");$&&($.textContent=_,$.classList.remove("u-hidden"));return}r()}},d=g=>{g.key==="Escape"&&o(),g.key==="Enter"&&!g.shiftKey&&g.target.tagName!=="TEXTAREA"&&(g.preventDefault(),c())};fn(p`
    ...
    `,e),e.dataset.state="",e.hidden=!1,requestAnimationFrame(()=>{s===Ds&&(e.dataset.state="open")});const m=e.querySelector(".modal");e.onclick=g=>{g.target===e&&o()};const h=m.querySelector("input, select, textarea");return setTimeout(()=>h?.focus({preventScroll:!0}),30),document.addEventListener("keydown",d),{close:r,root:m}}let yt=[];function An(){fn(yt.map(t=>p`
        <div class="toast ${t.leaving?"is-leaving":""}" data-tone=${t.tone}>
          <span class="toast__dot"></span>
          ${t.icon?ha(t.icon):M}
          <span>${t.message}</span>
        </div>`),ll())}function u(t,{tone:e="info",duration:n=2800,icon:s=null}={}){const a={id:wt("toast"),message:t,tone:e,icon:s,leaving:!1};yt=[...yt,a],An();let r=null;const o=c=>{r&&clearTimeout(r),c>0&&(r=setTimeout(()=>l(),c))},l=()=>{const c=yt.find(d=>d.id===a.id);!c||c.leaving||(c.leaving=!0,An(),setTimeout(()=>{yt=yt.filter(d=>d.id!==a.id),An()},Bt()+20))};return o(n),{update(c,d=e){a.message=c,a.tone=d,An()},close(){l()}}}function cl(t){return t.currentSrc===Ke||t.src===Ke||t.getAttribute("src")===Ke}function dl(t){!t||t.dataset.coverFallback==="1"||(t.dataset.coverFallback="1",t.addEventListener("error",()=>{cl(t)||(t.src=Ke)},!0))}function ul(){let t=document.getElementById("app-tip");t||(t=document.createElement("div"),t.className="app-tip",t.id="app-tip",t.setAttribute("role","tooltip"),document.body.appendChild(t));let e=null;const n=()=>{const o=getComputedStyle(document.documentElement).getPropertyValue("--h-titlebar").trim(),l=parseFloat(o);return Number.isFinite(l)?l:36};function s(){if(!e)return;const o=e.getBoundingClientRect();t.style.left="0px",t.style.top="0px";const l=t.offsetWidth,c=t.offsetHeight,d=window.innerWidth,m=window.innerHeight,h=n();let g=o.left+o.width/2-l/2,_=o.top-c-6;_<h+4&&(_=o.bottom+6),g=Math.max(8,Math.min(g,d-l-8)),_=Math.max(h+4,Math.min(_,m-c-8)),t.style.left=`${g}px`,t.style.top=`${_}px`}function a(o){const l=o?.getAttribute?.("data-tip");if(!l){r();return}t.textContent=l,t.dataset.visible="true",e=o,s()}function r(){delete t.dataset.visible,e=null}document.addEventListener("mouseover",o=>{const l=o.target.closest?.("[data-tip]");l?a(l):r()}),document.addEventListener("mouseout",o=>{const l=o.target.closest?.("[data-tip]");l&&!l.contains(o.relatedTarget)&&r()}),document.addEventListener("pointerdown",r,!0),window.addEventListener("scroll",r,!0),window.addEventListener("resize",r)}const pl=[{id:"dark-minimal",name:"深色 · 黑白极简",mode:"dark",builtin:!0,swatch:["#08080a","#1b1b1f","#3a3a42","#f4f4f6","#ff4d6d"]},{id:"light-minimal",name:"浅色 · 黑白极简",mode:"light",builtin:!0,swatch:["#f2f2f4","#ffffff","#d8d8dd","#14141a","#e8384f"]},{id:"cover-dark",name:"封面取色 · 深色",mode:"dark",builtin:!0,swatch:["#0b0b12","#2a2a31","#6b6b76","#f7f7fa","#ff4d6d"]}],J=pl.slice();let fr=0;function fl(){return fr}function bs(){return J}function ns(t){return J.find(e=>e.id===t)||J[0]}async function ys(){if(!S())return J;try{const t=await y.listThemes();if(!Array.isArray(t)||!t.length)return J;for(const e of t){if(!e?.id)continue;const n=await y.loadTheme(e.id);typeof n=="string"&&n.trim()&&gl(e.id,n)}hl(t)}catch(t){console.warn("[theme] 主题目录扫描失败",t)}return J}function hl(t){const e=[],n=new Set;for(const s of t){if(!s?.id||n.has(s.id))continue;n.add(s.id);const a={id:s.id,name:s.name||s.id,mode:s.mode||"dark",swatch:Array.isArray(s.swatch)?s.swatch:[],builtin:!!s.builtin},r=J.find(o=>o.id===s.id);r?(Object.assign(r,a),e.push(r)):e.push(a)}for(const s of J)e.includes(s)||Fa(`theme-file-${s.id}`,"");return J.length=0,J.push(...e),fr+=1,J}async function ml(t){return await y.deleteTheme(t),await ys(),{removed:!J.some(n=>n.id===t),themeIds:J.map(n=>n.id)}}function gl(t,e){Fa(`theme-file-${t}`,e)}const vl=["--seed","--seed-2","--bg-app","--bg-window"],bl=["--seed","--seed-2"];function yl(t){return document.documentElement.style.getPropertyValue(t).trim()?String(document.documentElement.style.getPropertyValue(t)):null}function _l(){const t=document.documentElement,e={};for(const n of bl){const s=yl(n);s&&(e[n]=s)}for(const n of vl)t.style.removeProperty(n);return e}const Hn="cover-dark";function bn(t){return!!t&&!ko(t)}let mi=null,As=null,Ms=null;async function Ie(t){const e=document.documentElement,n=window.matchMedia("(prefers-color-scheme: dark)").matches,s=_l();s["--seed"]&&(As=s["--seed"]),s["--seed-2"]&&(Ms=s["--seed-2"]);let a=t.theme||"dark-minimal";if(t.themeMode==="system"){const h=n?"dark":"light",g=J.find(_=>_.mode===h&&_.id!=="cover-dark");g&&(a=g.id)}else if(J.find(h=>h.id===a)?.mode!==t.themeMode){const h=J.find(g=>g.mode===t.themeMode&&g.id!=="cover-dark");h&&(a=h.id)}e.dataset.theme=a,e.dataset.mode=J.find(h=>h.id===a)?.mode||t.themeMode||"dark",t.theme=a;const r=gi(t,a),o=gi(t,a,!0),l=t.accentFromCover!==!1;(t.accentFromCover===!1||mi!==null&&a!==Hn)&&(As=null,Ms=null);const d=r??(l?As:null),m=o??Ms??d;return gn({"--glass-blur":t.glassBlurCustom?`${t.glassBlur}px`:null,"--dur":fa(t),"--seed":d,"--seed-2":m}),mi=d&&a===Hn?Hn:null,$l(),t.glassAlphaCustom&&Ua(t.glassAlpha),a}function gi(t,e,n=!1){return!t||t.accentFromCover!==!0||e!=="cover-dark"?null:Lt(n?t.coverSeed2:t.coverSeed)||null}async function wl(){const e=ns(i.config.theme)?.mode==="light"?"dark":"light";i.config.themeMode=e,await Ie(i.config),x(),u(e==="dark"?"已切换到深色主题":"已切换到浅色主题",{duration:1500})}let mt=null;function Vn(t){return mt||(mt=document.createElement("div"),mt.style.cssText="position:absolute;left:-9999px;top:-9999px;width:1px;height:1px;pointer-events:none;",document.body.appendChild(mt)),mt.style.backgroundColor=t,getComputedStyle(mt).backgroundColor}function Os(t,e){const n=Math.max(0,Math.min(1,e)),s=String(t),a=s.match(/rgba?\(([^)]+)\)/);if(a){const o=a[1].split(/[,/]/).map(m=>parseFloat(m.trim())),[l,c,d]=o;if([l,c,d].every(m=>Number.isFinite(m)))return`rgba(${Math.round(l)}, ${Math.round(c)}, ${Math.round(d)}, ${n})`}const r=s.match(/color\(\s*srgb\s+([\d.]+)\s+([\d.]+)\s+([\d.]+)/i);if(r){const[o,l,c]=r.slice(1,4).map(d=>Math.round(parseFloat(d)*255));if([o,l,c].every(d=>Number.isFinite(d)))return`rgba(${o}, ${l}, ${c}, ${n})`}return null}function ga(){const t=String(Vn("var(--glass-bg)")),e=t.match(/rgba\(\s*[\d.]+\s*,\s*[\d.]+\s*,\s*[\d.]+\s*,\s*([\d.]+)\s*\)/),n=t.match(/\/\s*([\d.]+)\s*\)/),s=parseFloat(e&&e[1]||n&&n[1]||"");return Number.isFinite(s)?Math.round(s*100):62}function Ua(t){const e=Math.max(0,Math.min(1,(Number(t)||0)/100));gn({"--glass-bg":null,"--glass-bg-strong":null,"--glass-bg-weak":null});const n=Vn("var(--glass-bg)"),s=Vn("var(--glass-bg-strong)"),a=Vn("var(--glass-bg-weak)");gn({"--glass-bg":Os(n,e),"--glass-bg-strong":Os(s,Math.min(1,e+.18)),"--glass-bg-weak":Os(a,Math.max(0,e-.22))})}function $l(){const t=document.body;t&&(t.dataset.styleEpoch=String((Number(t.dataset.styleEpoch)||0)+1))}function va(){const t=getComputedStyle(document.documentElement).getPropertyValue("--glass-blur"),e=parseFloat(t);return Number.isFinite(e)?e:22}function Lt(t){const e=String(t??"").trim();if(!e)return"";const n=e.match(/^#?([0-9a-fA-F]{3}|[0-9a-fA-F]{6})$/);if(n){let a=n[1].toLowerCase();return a.length===3&&(a=a[0]+a[0]+a[1]+a[1]+a[2]+a[2]),`#${a}`}const s=e.match(/rgba?\(\s*([\d.]+)[\s,]+([\d.]+)[\s,]+([\d.]+)/i);if(s){const a=r=>Math.max(0,Math.min(255,Math.round(Number(r)))).toString(16).padStart(2,"0");return`#${a(s[1])}${a(s[2])}${a(s[3])}`}return""}let vi="";function kl(t){const e=document.documentElement.dataset.theme||"",n=typeof t=="string"?t.trim():"",s=e===Hn?n:"";s!==vi&&(vi=s,gn({"--cover-bg":s?`url("${s.replace(/["\\]/g,"\\$&")}")`:null}))}function Sl(t,e){const n=Lt(t),s=Lt(e)||n;return n?(gn({"--seed":n,"--seed-2":s}),i.config.coverSeed!==n||i.config.coverSeed2!==s?(i.config.coverSeed=n,i.config.coverSeed2=s,Cl(),!0):!1):!1}const xl="music-player.cover-seed.v1";function Cl(){try{localStorage.setItem(xl,JSON.stringify({seed:i.config.coverSeed||"",seed2:i.config.coverSeed2||"",theme:i.config.theme||""}))}catch{}}function bi(t){try{const e=document.createElement("canvas"),n=32;e.width=n,e.height=n;const s=e.getContext("2d",{willReadFrequently:!0});s.drawImage(t,0,0,n,n);const{data:a}=s.getImageData(0,0,n,n);let r=0,o=0,l=0,c=0,d=0,m=0,h=0,g=0;for(let $=0;$<a.length;$+=4){if(a[$+3]<8)continue;const w=a[$],O=a[$+1],C=a[$+2];d+=w,m+=O,h+=C,g+=1;const q=Math.max(w,O,C),ae=Math.min(w,O,C);if(q<26)continue;const Y=q===0?0:(q-ae)/q;if(Y<.12)continue;const ge=Y*Y*(.35+q/255);r+=w*ge,o+=O*ge,l+=C*ge,c+=ge}const _=c>0?[r/c,o/c,l/c]:g>0?[d/g,m/g,h/g]:null;return _?`rgb(${_.map($=>Math.round(Math.max(0,Math.min(255,$)))).join(", ")})`:null}catch{return null}}function Ps(){i.query="",x()}function Ct(t,e=null){if(i.settingsOpen&&ss(),t==="settings"){hr();return}i.view=t,i.playlistId=t==="playlist"?e:null,i.playerOpen=!1,i.query="",i.playlistSelecting=!1,i.selectedIds=new Set,i.queueOpen=!1,x()}function hr(t=null){i.settingsOpen=!0,t&&(i.settingsSection=t),x()}function ss(){i.settingsOpen=!1,x()}function Tl(t=null){i.settingsOpen?ss():hr(t)}function mr(){return i.settingsOpen===!0}function El(){i.settingsOpen&&(i.settingsRev=(i.settingsRev||0)+1,x(),he())}async function yn({manual:t=!1}={}){if(!i.scanning){i.scanning=!0,i.scanText="正在扫描音乐文件夹…",x();try{const e=await sr({silent:!t});e&&u(`扫描完成：保留 ${A(e.kept)} 首${e.excluded?`，过滤 ${A(e.excluded)} 个`:""}${e.added?`，新增 ${A(e.added)}`:""}${e.removed?`，移除 ${A(e.removed)}`:""}`,{tone:"success",duration:3600})}finally{i.scanning=!1,x()}}}const gr="music-player.search.history.v1",Il=20;function Ls(){try{const t=localStorage.getItem(gr),e=t?JSON.parse(t):[];return Array.isArray(e)?e.filter(n=>typeof n=="string"&&n.trim()):[]}catch{return[]}}function qs(t){try{localStorage.setItem(gr,JSON.stringify(t.slice(0,Il)))}catch{}}const R={keyword:"",seq:0,results:[],query:"",loading:!1,message:"",rev:0};function Se(){R.rev+=1,he()}class Dl extends me{static deps=e=>[e.searchOpen,R.rev];get panelEl(){return this.querySelector("#search-overlay")}updated(){const e=this.panelEl;if(e){if(i.searchOpen){this._closeTimer&&(clearTimeout(this._closeTimer),this._closeTimer=null),e.hidden&&(e.hidden=!1,e.dataset.state="",requestAnimationFrame(()=>{i.searchOpen&&(e.dataset.state="opened")}),requestAnimationFrame(()=>{const n=this.querySelector("#search-input");n?.focus(),n?.select()}));return}e.hidden||(e.dataset.state="closed",this._closeTimer||(this._closeTimer=setTimeout(()=>{this._closeTimer=null,!i.searchOpen&&e&&(e.hidden=!0)},260)))}}disconnectedCallback(){this._closeTimer&&clearTimeout(this._closeTimer),super.disconnectedCallback()}render(){const e=R,n=Ls(),s=!!e.keyword.trim();return p`
      <section
    ...
    `}headline(){const e=R;return e.loading?"搜索中…":e.query?`在线「${e.query}」${A(e.results.length)} 个结果`:""}bodyContent(){const e=R;return e.loading?p`<div class="search-overlay__loading"><span class="search-overlay__spinner"></span>正在搜索「${e.keyword.trim()}」…</div>`:e.message?this.empty(e.message):e.results.length?Ee(e.results,n=>n.id,n=>p`
        ...
        >
          ...
          <span class="search-row__main">
            ...
            <span class="search-row__sub">${n.artist||"未知"} · ${xt(n.duration)}</span>
          </span>
    ...
    `}}function Bs(t){if(!S()){t==="close"&&window.close();return}t==="min"?y.windowMinimize():t==="max"?y.windowToggleMaximize():y.windowClose()}te("mp-titlebar",Fl);function zl(t,e,n){return(e=Hl(e))in t?Object.defineProperty(t,e,{value:n,enumerable:!0,configurable:!0,writable:!0}):t[e]=n,t}function Ne(){return Ne=Object.assign?Object.assign.bind():function(t){for(var e=1;e<arguments.length;e++){var n=arguments[e];for(var s in n)({}).hasOwnProperty.call(n,s)&&(t[s]=n[s])}return t},Ne.apply(null,arguments)}function yi(t,e){var n=Object.keys(t);if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(t);e&&(s=s.filter(function(a){return Object.getOwnPropertyDescriptor(t,a).enumerable})),n.push.apply(n,s)}return n}function De(t){for(var e=1;e<arguments.length;e++){var n=arguments[e]!=null?arguments[e]:{};e%2?yi(Object(n),!0).forEach(function(s){zl(t,s,n[s])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(n)):yi(Object(n)).forEach(function(s){Object.defineProperty(t,s,Object.getOwnPropertyDescriptor(n,s))})}return t}function Ul(t,e){if(t==null)return{};var n,s,a=jl(t,e);if(Object.getOwnPropertySymbols){var r=Object.getOwnPropertySymbols(t);for(s=0;s<r.length;s++)n=r[s],e.indexOf(n)===-1&&{}.propertyIsEnumerable.call(t,n)&&(a[n]=t[n])}return a}function jl(t,e){if(t==null)return{};var n={};for(var s in t)if({}.hasOwnProperty.call(t,s)){if(e.indexOf(s)!==-1)continue;n[s]=t[s]}return n}function Wl(t,e){if(typeof t!="object"||!t)return t;var n=t[Symbol.toPrimitive];if(n!==void 0){var s=n.call(t,e);if(typeof s!="object")return s;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(t)}function Hl(t){var e=Wl(t,"string");return typeof e=="symbol"?e:e+""}function ya(t){"@babel/helpers - typeof";return ya=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},ya(t)}var Vl="1.15.7";function qe(t){if(typeof window<"u"&&window.navigator)return!!navigator.userAgent.match(t)}var Be=qe(/(?:Trident.*rv[ :]?11\.|msie|iemobile|Windows Phone)/i),xn=qe(/Edge/i),_i=qe(/firefox/i),rn=qe(/safari/i)&&!qe(/chrome/i)&&!qe(/android/i),ja=qe(/iP(ad|od|hone)/i),_r=qe(/chrome/i)&&qe(/android/i),wr={capture:!1,passive:!1};function L(t,e,n){t.addEventListener(e,n,!Be&&wr)}function P(t,e,n){t.removeEventListener(e,n,!Be&&wr)}function is(t,e){if(e){if(e[0]===">"&&(e=e.substring(1)),t)try{if(t.matches)return t.matches(e);if(t.msMatchesSelector)return t.msMatchesSelector(e);if(t.webkitMatchesSelector)return t.webkitMatchesSelector(e)}catch{return!1}return!1}}function $r(t){return t.host&&t!==document&&t.host.nodeType&&t.host!==t?t.host:t.parentNode}function we(t,e,n,s){if(t){n=n||document;do{if(e!=null&&(e[0]===">"?t.parentNode===n&&is(t,e):is(t,e))||s&&t===n)return t;if(t===n)break}while(t=$r(t))}return null}var wi=/\s+/g;function pe(t,e,n){if(t&&e)if(t.classList)t.classList[n?"add":"remove"](e);else{var s=(" "+t.className+" ").replace(wi," ").replace(" "+e+" "," ");t.className=(s+(n?" "+e:"")).replace(wi," ")}}function E(t,e,n){var s=t&&t.style;if(s){if(n===void 0)return document.defaultView&&document.defaultView.getComputedStyle?n=document.defaultView.getComputedStyle(t,""):t.currentStyle&&(n=t.currentStyle),e===void 0?n:n[e];!(e in s)&&e.indexOf("webkit")===-1&&(e="-webkit-"+e),s[e]=n+(typeof n=="string"?"":"px")}}function Et(t,e){var n="";if(typeof t=="string")n=t;else do{var s=E(t,"transform");s&&s!=="none"&&(n=s+" "+n)}while(!e&&(t=t.parentNode));var a=window.DOMMatrix||window.WebKitCSSMatrix||window.CSSMatrix||window.MSCSSMatrix;return a&&new a(n)}function kr(t,e,n){if(t){var s=t.getElementsByTagName(e),a=0,r=s.length;if(n)for(;a<r;a++)n(s[a],a);return s}return[]}function Te(){var t=document.scrollingElement;return t||document.documentElement}function K(t,e,n,s,a){if(!(!t.getBoundingClientRect&&t!==window)){var r,o,l,c,d,m,h;if(t!==window&&t.parentNode&&t!==Te()?(r=t.getBoundingClientRect(),o=r.top,l=r.left,c=r.bottom,d=r.right,m=r.height,h=r.width):(o=0,l=0,c=window.innerHeight,d=window.innerWidth,m=window.innerHeight,h=window.innerWidth),(e||n)&&t!==window&&(a=a||t.parentNode,!Be))do if(a&&a.getBoundingClientRect&&(E(a,"transform")!=="none"||n&&E(a,"position")!=="static")){var g=a.getBoundingClientRect();o-=g.top+parseInt(E(a,"border-top-width")),l-=g.left+parseInt(E(a,"border-left-width")),c=o+r.height,d=l+r.width;break}while(a=a.parentNode);if(s&&t!==window){var _=Et(a||t),$=_&&_.a,w=_&&_.d;_&&(o/=w,l/=$,h/=$,m/=w,c=o+m,d=l+h)}return{top:o,left:l,bottom:c,right:d,width:h,height:m}}}function $i(t,e,n){for(var s=Ve(t,!0),a=K(t)[e];s;){var r=K(s)[n],o=void 0;if(o=a>=r,!o)return s;if(s===Te())break;s=Ve(s,!1)}return!1}function qt(t,e,n,s){for(var a=0,r=0,o=t.children;r<o.length;){if(o[r].style.display!=="none"&&o[r]!==T.ghost&&(s||o[r]!==T.dragged)&&we(o[r],n.draggable,t,!1)){if(a===e)return o[r];a++}r++}return null}function Wa(t,e){for(var n=t.lastElementChild;n&&(n===T.ghost||E(n,"display")==="none"||e&&!is(n,e));)n=n.previousElementSibling;return n||null}function ve(t,e){var n=0;if(!t||!t.parentNode)return-1;for(;t=t.previousElementSibling;)t.nodeName.toUpperCase()!=="TEMPLATE"&&t!==T.clone&&(!e||is(t,e))&&n++;return n}function ki(t){var e=0,n=0,s=Te();if(t)do{var a=Et(t),r=a.a,o=a.d;e+=t.scrollLeft*r,n+=t.scrollTop*o}while(t!==s&&(t=t.parentNode));return[e,n]}function Kl(t,e){for(var n in t)if(t.hasOwnProperty(n)){for(var s in e)if(e.hasOwnProperty(s)&&e[s]===t[n][s])return Number(n)}return-1}function Ve(t,e){if(!t||!t.getBoundingClientRect)return Te();var n=t,s=!1;do if(n.clientWidth<n.scrollWidth||n.clientHeight<n.scrollHeight){var a=E(n);if(n.clientWidth<n.scrollWidth&&(a.overflowX=="auto"||a.overflowX=="scroll")||n.clientHeight<n.scrollHeight&&(a.overflowY=="auto"||a.overflowY=="scroll")){if(!n.getBoundingClientRect||n===document.body)return Te();if(s||e)return n;s=!0}}while(n=n.parentNode);return Te()}function Gl(t,e){if(t&&e)for(var n in e)e.hasOwnProperty(n)&&(t[n]=e[n]);return t}function Fs(t,e){return Math.round(t.top)===Math.round(e.top)&&Math.round(t.left)===Math.round(e.left)&&Math.round(t.height)===Math.round(e.height)&&Math.round(t.width)===Math.round(e.width)}var on;function Sr(t,e){return function(){if(!on){var n=arguments,s=this;n.length===1?t.call(s,n[0]):t.apply(s,n),on=setTimeout(function(){on=void 0},e)}}}function Yl(){clearTimeout(on),on=void 0}function xr(t,e,n){t.scrollLeft+=e,t.scrollTop+=n}function Cr(t){var e=window.Polymer,n=window.jQuery||window.Zepto;return e&&e.dom?e.dom(t).cloneNode(!0):n?n(t).clone(!0)[0]:t.cloneNode(!0)}function Tr(t,e,n){var s={};return Array.from(t.children).forEach(function(a){var r,o,l,c;if(!(!we(a,e.draggable,t,!1)||a.animated||a===n)){var d=K(a);s.left=Math.min((r=s.left)!==null&&r!==void 0?r:1/0,d.left),s.top=Math.min((o=s.top)!==null&&o!==void 0?o:1/0,d.top),s.right=Math.max((l=s.right)!==null&&l!==void 0?l:-1/0,d.right),s.bottom=Math.max((c=s.bottom)!==null&&c!==void 0?c:-1/0,d.bottom)}}),s.width=s.right-s.left,s.height=s.bottom-s.top,s.x=s.left,s.y=s.top,s}var ce="Sortable"+new Date().getTime();function Xl(){var t=[],e;return{captureAnimationState:function(){if(t=[],!!this.options.animation){var s=[].slice.call(this.el.children);s.forEach(function(a){if(!(E(a,"display")==="none"||a===T.ghost)){t.push({target:a,rect:K(a)});var r=De({},t[t.length-1].rect);if(a.thisAnimationDuration){var o=Et(a,!0);o&&(r.top-=o.f,r.left-=o.e)}a.fromRect=r}})}},addAnimationState:function(s){t.push(s)},removeAnimationState:function(s){t.splice(Kl(t,{target:s}),1)},animateAll:function(s){var a=this;if(!this.options.animation){clearTimeout(e),typeof s=="function"&&s();return}var r=!1,o=0;t.forEach(function(l){var c=0,d=l.target,m=d.fromRect,h=K(d),g=d.prevFromRect,_=d.prevToRect,$=l.rect,w=Et(d,!0);w&&(h.top-=w.f,h.left-=w.e),d.toRect=h,d.thisAnimationDuration&&Fs(g,h)&&!Fs(m,h)&&($.top-h.top)/($.left-h.left)===(m.top-h.top)/(m.left-h.left)&&(c=Jl($,g,_,a.options)),Fs(h,m)||(d.prevFromRect=m,d.prevToRect=h,c||(c=a.options.animation),a.animate(d,$,h,c)),c&&(r=!0,o=Math.max(o,c),clearTimeout(d.animationResetTimer),d.animationResetTimer=setTimeout(function(){d.animationTime=0,d.prevFromRect=null,d.fromRect=null,d.prevToRect=null,d.thisAnimationDuration=null},c),d.thisAnimationDuration=c)}),clearTimeout(e),r?e=setTimeout(function(){typeof s=="function"&&s()},o):typeof s=="function"&&s(),t=[]},animate:function(s,a,r,o){if(o){E(s,"transition",""),E(s,"transform","");var l=Et(this.el),c=l&&l.a,d=l&&l.d,m=(a.left-r.left)/(c||1),h=(a.top-r.top)/(d||1);s.animatingX=!!m,s.animatingY=!!h,E(s,"transform","translate3d("+m+"px,"+h+"px,0)"),this.forRepaintDummy=Ql(s),E(s,"transition","transform "+o+"ms"+(this.options.easing?" "+this.options.easing:"")),E(s,"transform","translate3d(0,0,0)"),typeof s.animated=="number"&&clearTimeout(s.animated),s.animated=setTimeout(function(){E(s,"transition",""),E(s,"transform",""),s.animated=!1,s.animatingX=!1,s.animatingY=!1},o)}}}}function Ql(t){return t.offsetWidth}function Jl(t,e,n,s){return Math.sqrt(Math.pow(e.top-t.top,2)+Math.pow(e.left-t.left,2))/Math.sqrt(Math.pow(e.top-n.top,2)+Math.pow(e.left-n.left,2))*s.animation}var gt=[],zs={initializeByDefault:!0},Cn={mount:function(e){for(var n in zs)zs.hasOwnProperty(n)&&!(n in e)&&(e[n]=zs[n]);gt.forEach(function(s){if(s.pluginName===e.pluginName)throw"Sortable: Cannot mount plugin ".concat(e.pluginName," more than once")}),gt.push(e)},pluginEvent:function(e,n,s){var a=this;this.eventCanceled=!1,s.cancel=function(){a.eventCanceled=!0};var r=e+"Global";gt.forEach(function(o){n[o.pluginName]&&(n[o.pluginName][r]&&n[o.pluginName][r](De({sortable:n},s)),n.options[o.pluginName]&&n[o.pluginName][e]&&n[o.pluginName][e](De({sortable:n},s)))})},initializePlugins:function(e,n,s,a){gt.forEach(function(l){var c=l.pluginName;if(!(!e.options[c]&&!l.initializeByDefault)){var d=new l(e,n,e.options);d.sortable=e,d.options=e.options,e[c]=d,Ne(s,d.defaults)}});for(var r in e.options)if(e.options.hasOwnProperty(r)){var o=this.modifyOption(e,r,e.options[r]);typeof o<"u"&&(e.options[r]=o)}},getEventProperties:function(e,n){var s={};return gt.forEach(function(a){typeof a.eventProperties=="function"&&Ne(s,a.eventProperties.call(n[a.pluginName],e))}),s},modifyOption:function(e,n,s){var a;return gt.forEach(function(r){e[r.pluginName]&&r.optionListeners&&typeof r.optionListeners[n]=="function"&&(a=r.optionListeners[n].call(e[r.pluginName],s))}),a}};function Zl(t){var e=t.sortable,n=t.rootEl,s=t.name,a=t.targetEl,r=t.cloneEl,o=t.toEl,l=t.fromEl,c=t.oldIndex,d=t.newIndex,m=t.oldDraggableIndex,h=t.newDraggableIndex,g=t.originalEvent,_=t.putSortable,$=t.extraEventProperties;if(e=e||n&&n[ce],!!e){var w,O=e.options,C="on"+s.charAt(0).toUpperCase()+s.substr(1);window.CustomEvent&&!Be&&!xn?w=new CustomEvent(s,{bubbles:!0,cancelable:!0}):(w=document.createEvent("Event"),w.initEvent(s,!0,!0)),w.to=o||n,w.from=l||n,w.item=a||n,w.clone=r,w.oldIndex=c,w.newIndex=d,w.oldDraggableIndex=m,w.newDraggableIndex=h,w.originalEvent=g,w.pullMode=_?_.lastPutMode:void 0;var q=De(De({},$),Cn.getEventProperties(s,e));for(var ae in q)w[ae]=q[ae];n&&n.dispatchEvent(w),O[C]&&O[C].call(e,w)}}var ec=["evt"],le=function(e,n){var s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:{},a=s.evt,r=Ul(s,ec);Cn.pluginEvent.bind(T)(e,n,De({dragEl:b,parentEl:W,ghostEl:D,rootEl:U,nextEl:at,lastDownEl:Gn,cloneEl:j,cloneHidden:He,dragStarted:Zt,putSortable:Q,activeSortable:T.active,originalEvent:a,oldIndex:kt,oldDraggableIndex:ln,newIndex:fe,newDraggableIndex:je,hideGhostForTarget:Ar,unhideGhostForTarget:Mr,cloneNowHidden:function(){He=!0},cloneNowShown:function(){He=!1},dispatchSortableEvent:function(l){re({sortable:n,name:l,originalEvent:a})}},r))};function re(t){Zl(De({putSortable:Q,cloneEl:j,targetEl:b,rootEl:U,oldIndex:kt,oldDraggableIndex:ln,newIndex:fe,newDraggableIndex:je},t))}var b,W,D,U,at,Gn,j,He,kt,fe,ln,je,Mn,Q,_t=!1,rs=!1,os=[],tt,_e,Us,js,Si,xi,Zt,vt,cn,dn=!1,On=!1,Yn,ne,Ws=[],_a=!1,ls=[],_s=typeof document<"u",Pn=ja,Ci=xn||Be?"cssFloat":"float",tc=_s&&!_r&&!ja&&"draggable"in document.createElement("div"),Er=(function(){if(_s){if(Be)return!1;var t=document.createElement("x");return t.style.cssText="pointer-events:auto",t.style.pointerEvents==="auto"}})(),Ir=function(e,n){var s=E(e),a=parseInt(s.width)-parseInt(s.paddingLeft)-parseInt(s.paddingRight)-parseInt(s.borderLeftWidth)-parseInt(s.borderRightWidth),r=qt(e,0,n),o=qt(e,1,n),l=r&&E(r),c=o&&E(o),d=l&&parseInt(l.marginLeft)+parseInt(l.marginRight)+K(r).width,m=c&&parseInt(c.marginLeft)+parseInt(c.marginRight)+K(o).width;if(s.display==="flex")return s.flexDirection==="column"||s.flexDirection==="column-reverse"?"vertical":"horizontal";if(s.display==="grid")return s.gridTemplateColumns.split(" ").length<=1?"vertical":"horizontal";if(r&&l.float&&l.float!=="none"){var h=l.float==="left"?"left":"right";return o&&(c.clear==="both"||c.clear===h)?"vertical":"horizontal"}return r&&(l.display==="block"||l.display==="flex"||l.display==="table"||l.display==="grid"||d>=a&&s[Ci]==="none"||o&&s[Ci]==="none"&&d+m>a)?"vertical":"horizontal"},nc=function(e,n,s){var a=s?e.left:e.top,r=s?e.right:e.bottom,o=s?e.width:e.height,l=s?n.left:n.top,c=s?n.right:n.bottom,d=s?n.width:n.height;return a===l||r===c||a+o/2===l+d/2},sc=function(e,n){var s;return os.some(function(a){var r=a[ce].options.emptyInsertThreshold;if(!(!r||Wa(a))){var o=K(a),l=e>=o.left-r&&e<=o.right+r,c=n>=o.top-r&&n<=o.bottom+r;if(l&&c)return s=a}}),s},Dr=function(e){function n(r,o){return function(l,c,d,m){var h=l.options.group.name&&c.options.group.name&&l.options.group.name===c.options.group.name;if(r==null&&(o||h))return!0;if(r==null||r===!1)return!1;if(o&&r==="clone")return r;if(typeof r=="function")return n(r(l,c,d,m),o)(l,c,d,m);var g=(o?l:c).options.group.name;return r===!0||typeof r=="string"&&r===g||r.join&&r.indexOf(g)>-1}}var s={},a=e.group;(!a||ya(a)!="object")&&(a={name:a}),s.name=a.name,s.checkPull=n(a.pull,!0),s.checkPut=n(a.put),s.revertClone=a.revertClone,e.group=s},Ar=function(){!Er&&D&&E(D,"display","none")},Mr=function(){!Er&&D&&E(D,"display","")};_s&&!_r&&document.addEventListener("click",function(t){if(rs)return t.preventDefault(),t.stopPropagation&&t.stopPropagation(),t.stopImmediatePropagation&&t.stopImmediatePropagation(),rs=!1,!1},!0);var nt=function(e){if(b){e=e.touches?e.touches[0]:e;var n=sc(e.clientX,e.clientY);if(n){var s={};for(var a in e)e.hasOwnProperty(a)&&(s[a]=e[a]);s.target=s.rootEl=n,s.preventDefault=void 0,s.stopPropagation=void 0,n[ce]._onDragOver(s)}}},ac=function(e){b&&b.parentNode[ce]._isOutsideThisEl(e.target)};function T(t,e){if(!(t&&t.nodeType&&t.nodeType===1))throw"Sortable: `el` must be an HTMLElement, not ".concat({}.toString.call(t));this.el=t,this.options=e=Ne({},e),t[ce]=this;var n={group:null,sort:!0,disabled:!1,store:null,handle:null,draggable:/^[uo]l$/i.test(t.nodeName)?">li":">*",swapThreshold:1,invertSwap:!1,invertedSwapThreshold:null,removeCloneOnHide:!0,direction:function(){return Ir(t,this.options)},ghostClass:"sortable-ghost",chosenClass:"sortable-chosen",dragClass:"sortable-drag",ignore:"a, img",filter:null,preventOnFilter:!0,animation:0,easing:null,setData:function(o,l){o.setData("Text",l.textContent)},dropBubble:!1,dragoverBubble:!1,dataIdAttr:"data-id",delay:0,delayOnTouchOnly:!1,touchStartThreshold:(Number.parseInt?Number:window).parseInt(window.devicePixelRatio,10)||1,forceFallback:!1,fallbackClass:"sortable-fallback",fallbackOnBody:!1,fallbackTolerance:0,fallbackOffset:{x:0,y:0},supportPointer:T.supportPointer!==!1&&"PointerEvent"in window&&(!rn||ja),emptyInsertThreshold:5};Cn.initializePlugins(this,t,n);for(var s in n)!(s in e)&&(e[s]=n[s]);Dr(e);for(var a in this)a.charAt(0)==="_"&&typeof this[a]=="function"&&(this[a]=this[a].bind(this));this.nativeDraggable=e.forceFallback?!1:tc,this.nativeDraggable&&(this.options.touchStartThreshold=1),e.supportPointer?L(t,"pointerdown",this._onTapStart):(L(t,"mousedown",this._onTapStart),L(t,"touchstart",this._onTapStart)),this.nativeDraggable&&(L(t,"dragover",this),L(t,"dragenter",this)),os.push(this.el),e.store&&e.store.get&&this.sort(e.store.get(this)||[]),Ne(this,Xl())}T.prototype={constructor:T,_isOutsideThisEl:function(e){!this.el.contains(e)&&e!==this.el&&(vt=null)},_getDirection:function(e,n){return typeof this.options.direction=="function"?this.options.direction.call(this,e,n,b):this.options.direction},_onTapStart:function(e){if(e.cancelable){var n=this,s=this.el,a=this.options,r=a.preventOnFilter,o=e.type,l=e.touches&&e.touches[0]||e.pointerType&&e.pointerType==="touch"&&e,c=(l||e).target,d=e.target.shadowRoot&&(e.path&&e.path[0]||e.composedPath&&e.composedPath()[0])||c,m=a.filter;if(pc(s),!b&&!(/mousedown|pointerdown/.test(o)&&e.button!==0||a.disabled)&&!d.isContentEditable&&!(!this.nativeDraggable&&rn&&c&&c.tagName.toUpperCase()==="SELECT")&&(c=we(c,a.draggable,s,!1),!(c&&c.animated)&&Gn!==c)){if(kt=ve(c),ln=ve(c,a.draggable),typeof m=="function"){if(m.call(this,e,c,this)){re({sortable:n,rootEl:d,name:"filter",targetEl:c,toEl:s,fromEl:s}),le("filter",n,{evt:e}),r&&e.preventDefault();return}}else if(m&&(m=m.split(",").some(function(h){if(h=we(d,h.trim(),s,!1),h)return re({sortable:n,rootEl:h,name:"filter",targetEl:c,fromEl:s,toEl:s}),le("filter",n,{evt:e}),!0}),m)){r&&e.preventDefault();return}a.handle&&!we(d,a.handle,s,!1)||this._prepareDragStart(e,l,c)}}},_prepareDragStart:function(e,n,s){var a=this,r=a.el,o=a.options,l=r.ownerDocument,c;if(s&&!b&&s.parentNode===r){var d=K(s);if(U=r,b=s,W=b.parentNode,at=b.nextSibling,Gn=s,Mn=o.group,T.dragged=b,tt={target:b,clientX:(n||e).clientX,clientY:(n||e).clientY},Si=tt.clientX-d.left,xi=tt.clientY-d.top,this._lastX=(n||e).clientX,this._lastY=(n||e).clientY,b.style["will-change"]="all",c=function(){if(le("delayEnded",a,{evt:e}),T.eventCanceled){a._onDrop();return}a._disableDelayedDragEvents(),!_i&&a.nativeDraggable&&(b.draggable=!0),a._triggerDragStart(e,n),re({sortable:a,name:"choose",originalEvent:e}),pe(b,o.chosenClass,!0)},o.ignore.split(",").forEach(function(m){kr(b,m.trim(),Hs)}),L(l,"dragover",nt),L(l,"mousemove",nt),L(l,"touchmove",nt),o.supportPointer?(L(l,"pointerup",a._onDrop),!this.nativeDraggable&&L(l,"pointercancel",a._onDrop)):(L(l,"mouseup",a._onDrop),L(l,"touchend",a._onDrop),L(l,"touchcancel",a._onDrop)),_i&&this.nativeDraggable&&(this.options.touchStartThreshold=4,b.draggable=!0),le("delayStart",this,{evt:e}),o.delay&&(!o.delayOnTouchOnly||n)&&(!this.nativeDraggable||!(xn||Be))){if(T.eventCanceled){this._onDrop();return}o.supportPointer?(L(l,"pointerup",a._disableDelayedDrag),L(l,"pointercancel",a._disableDelayedDrag)):(L(l,"mouseup",a._disableDelayedDrag),L(l,"touchend",a._disableDelayedDrag),L(l,"touchcancel",a._disableDelayedDrag)),L(l,"mousemove",a._delayedDragTouchMoveHandler),L(l,"touchmove",a._delayedDragTouchMoveHandler),o.supportPointer&&L(l,"pointermove",a._delayedDragTouchMoveHandler),a._dragStartTimer=setTimeout(c,o.delay)}else c()}},_delayedDragTouchMoveHandler:function(e){var n=e.touches?e.touches[0]:e;Math.max(Math.abs(n.clientX-this._lastX),Math.abs(n.clientY-this._lastY))>=Math.floor(this.options.touchStartThreshold/(this.nativeDraggable&&window.devicePixelRatio||1))&&this._disableDelayedDrag()},_disableDelayedDrag:function(){b&&Hs(b),clearTimeout(this._dragStartTimer),this._disableDelayedDragEvents()},_disableDelayedDragEvents:function(){var e=this.el.ownerDocument;P(e,"mouseup",this._disableDelayedDrag),P(e,"touchend",this._disableDelayedDrag),P(e,"touchcancel",this._disableDelayedDrag),P(e,"pointerup",this._disableDelayedDrag),P(e,"pointercancel",this._disableDelayedDrag),P(e,"mousemove",this._delayedDragTouchMoveHandler),P(e,"touchmove",this._delayedDragTouchMoveHandler),P(e,"pointermove",this._delayedDragTouchMoveHandler)},_triggerDragStart:function(e,n){n=n||e.pointerType=="touch"&&e,!this.nativeDraggable||n?this.options.supportPointer?L(document,"pointermove",this._onTouchMove):n?L(document,"touchmove",this._onTouchMove):L(document,"mousemove",this._onTouchMove):(L(b,"dragend",this),L(U,"dragstart",this._onDragStart));try{document.selection?Xn(function(){document.selection.empty()}):window.getSelection().removeAllRanges()}catch{}},_dragStarted:function(e,n){if(_t=!1,U&&b){le("dragStarted",this,{evt:n}),this.nativeDraggable&&L(document,"dragover",ac);var s=this.options;!e&&pe(b,s.dragClass,!1),pe(b,s.ghostClass,!0),T.active=this,e&&this._appendGhost(),re({sortable:this,name:"start",originalEvent:n})}else this._nulling()},_emulateDragOver:function(){if(_e){this._lastX=_e.clientX,this._lastY=_e.clientY,Ar();for(var e=document.elementFromPoint(_e.clientX,_e.clientY),n=e;e&&e.shadowRoot&&(e=e.shadowRoot.elementFromPoint(_e.clientX,_e.clientY),e!==n);)n=e;if(b.parentNode[ce]._isOutsideThisEl(e),n)do{if(n[ce]){var s=void 0;if(s=n[ce]._onDragOver({clientX:_e.clientX,clientY:_e.clientY,target:e,rootEl:n}),s&&!this.options.dragoverBubble)break}e=n}while(n=$r(n));Mr()}},_onTouchMove:function(e){if(tt){var n=this.options,s=n.fallbackTolerance,a=n.fallbackOffset,r=e.touches?e.touches[0]:e,o=D&&Et(D,!0),l=D&&o&&o.a,c=D&&o&&o.d,d=Pn&&ne&&ki(ne),m=(r.clientX-tt.clientX+a.x)/(l||1)+(d?d[0]-Ws[0]:0)/(l||1),h=(r.clientY-tt.clientY+a.y)/(c||1)+(d?d[1]-Ws[1]:0)/(c||1);if(!T.active&&!_t){if(s&&Math.max(Math.abs(r.clientX-this._lastX),Math.abs(r.clientY-this._lastY))<s)return;this._onDragStart(e,!0)}if(D){o?(o.e+=m-(Us||0),o.f+=h-(js||0)):o={a:1,b:0,c:0,d:1,e:m,f:h};var g="matrix(".concat(o.a,",").concat(o.b,",").concat(o.c,",").concat(o.d,",").concat(o.e,",").concat(o.f,")");E(D,"webkitTransform",g),E(D,"mozTransform",g),E(D,"msTransform",g),E(D,"transform",g),Us=m,js=h,_e=r}e.cancelable&&e.preventDefault()}},_appendGhost:function(){if(!D){var e=this.options.fallbackOnBody?document.body:U,n=K(b,!0,Pn,!0,e),s=this.options;if(Pn){for(ne=e;E(ne,"position")==="static"&&E(ne,"transform")==="none"&&ne!==document;)ne=ne.parentNode;ne!==document.body&&ne!==document.documentElement?(ne===document&&(ne=Te()),n.top+=ne.scrollTop,n.left+=ne.scrollLeft):ne=Te(),Ws=ki(ne)}D=b.cloneNode(!0),pe(D,s.ghostClass,!1),pe(D,s.fallbackClass,!0),pe(D,s.dragClass,!0),E(D,"transition",""),E(D,"transform",""),E(D,"box-sizing","border-box"),E(D,"margin",0),E(D,"top",n.top),E(D,"left",n.left),E(D,"width",n.width),E(D,"height",n.height),E(D,"opacity","0.8"),E(D,"position",Pn?"absolute":"fixed"),E(D,"zIndex","100000"),E(D,"pointerEvents","none"),T.ghost=D,e.appendChild(D),E(D,"transform-origin",Si/parseInt(D.style.width)*100+"% "+xi/parseInt(D.style.height)*100+"%")}},_onDragStart:function(e,n){var s=this,a=e.dataTransfer,r=s.options;if(le("dragStart",this,{evt:e}),T.eventCanceled){this._onDrop();return}le("setupClone",this),T.eventCanceled||(j=Cr(b),j.removeAttribute("id"),j.draggable=!1,j.style["will-change"]="",this._hideClone(),pe(j,this.options.chosenClass,!1),T.clone=j),s.cloneId=Xn(function(){le("clone",s),!T.eventCanceled&&(s.options.removeCloneOnHide||U.insertBefore(j,b),s._hideClone(),re({sortable:s,name:"clone"}))}),!n&&pe(b,r.dragClass,!0),n?(rs=!0,s._loopId=setInterval(s._emulateDragOver,50)):(P(document,"mouseup",s._onDrop),P(document,"touchend",s._onDrop),P(document,"touchcancel",s._onDrop),a&&(a.effectAllowed="move",r.setData&&r.setData.call(s,a,b)),L(document,"drop",s),E(b,"transform","translateZ(0)")),_t=!0,s._dragStartId=Xn(s._dragStarted.bind(s,n,e)),L(document,"selectstart",s),Zt=!0,window.getSelection().removeAllRanges(),rn&&E(document.body,"user-select","none")},_onDragOver:function(e){var n=this.el,s=e.target,a,r,o,l=this.options,c=l.group,d=T.active,m=Mn===c,h=l.sort,g=Q||d,_,$=this,w=!1;if(_a)return;function O(Ht,wo){le(Ht,$,De({evt:e,isOwner:m,axis:_?"vertical":"horizontal",revert:o,dragRect:a,targetRect:r,canSort:h,fromSortable:g,target:s,completed:q,onMove:function(ai,$o){return Ln(U,n,b,a,ai,K(ai),e,$o)},changed:ae},wo))}function C(){O("dragOverAnimationCapture"),$.captureAnimationState(),$!==g&&g.captureAnimationState()}function q(Ht){return O("dragOverCompleted",{insertion:Ht}),Ht&&(m?d._hideClone():d._showClone($),$!==g&&(pe(b,Q?Q.options.ghostClass:d.options.ghostClass,!1),pe(b,l.ghostClass,!0)),Q!==$&&$!==T.active?Q=$:$===T.active&&Q&&(Q=null),g===$&&($._ignoreWhileAnimating=s),$.animateAll(function(){O("dragOverAnimationComplete"),$._ignoreWhileAnimating=null}),$!==g&&(g.animateAll(),g._ignoreWhileAnimating=null)),(s===b&&!b.animated||s===n&&!s.animated)&&(vt=null),!l.dragoverBubble&&!e.rootEl&&s!==document&&(b.parentNode[ce]._isOutsideThisEl(e.target),!Ht&&nt(e)),!l.dragoverBubble&&e.stopPropagation&&e.stopPropagation(),w=!0}function ae(){fe=ve(b),je=ve(b,l.draggable),re({sortable:$,name:"change",toEl:n,newIndex:fe,newDraggableIndex:je,originalEvent:e})}if(e.preventDefault!==void 0&&e.cancelable&&e.preventDefault(),s=we(s,l.draggable,n,!0),O("dragOver"),T.eventCanceled)return w;if(b.contains(e.target)||s.animated&&s.animatingX&&s.animatingY||$._ignoreWhileAnimating===s)return q(!1);if(rs=!1,d&&!l.disabled&&(m?h||(o=W!==U):Q===this||(this.lastPutMode=Mn.checkPull(this,d,b,e))&&c.checkPut(this,d,b,e))){if(_=this._getDirection(e,s)==="vertical",a=K(b),O("dragOverValid"),T.eventCanceled)return w;if(o)return W=U,C(),this._hideClone(),O("revert"),T.eventCanceled||(at?U.insertBefore(b,at):U.appendChild(b)),q(!0);var Y=Wa(n,l.draggable);if(!Y||lc(e,_,this)&&!Y.animated){if(Y===b)return q(!1);if(Y&&n===e.target&&(s=Y),s&&(r=K(s)),Ln(U,n,b,a,s,r,e,!!s)!==!1)return C(),Y&&Y.nextSibling?n.insertBefore(b,Y.nextSibling):n.appendChild(b),W=n,ae(),q(!0)}else if(Y&&oc(e,_,this)){var ge=qt(n,0,l,!0);if(ge===b)return q(!1);if(s=ge,r=K(s),Ln(U,n,b,a,s,r,e,!1)!==!1)return C(),n.insertBefore(b,ge),W=n,ae(),q(!0)}else if(s.parentNode===n){r=K(s);var ke=0,Xe,zt=b.parentNode!==n,ue=!nc(b.animated&&b.toRect||a,s.animated&&s.toRect||r,_),Ut=_?"top":"left",Fe=$i(s,"top","top")||$i(b,"top","top"),jt=Fe?Fe.scrollTop:void 0;vt!==s&&(Xe=r[Ut],dn=!1,On=!ue&&l.invertSwap||zt),ke=cc(e,s,r,_,ue?1:l.swapThreshold,l.invertedSwapThreshold==null?l.swapThreshold:l.invertedSwapThreshold,On,vt===s);var Me;if(ke!==0){var Qe=ve(b);do Qe-=ke,Me=W.children[Qe];while(Me&&(E(Me,"display")==="none"||Me===D))}if(ke===0||Me===s)return q(!1);vt=s,cn=ke;var Wt=s.nextElementSibling,ze=!1;ze=ke===1;var Dn=Ln(U,n,b,a,s,r,e,ze);if(Dn!==!1)return(Dn===1||Dn===-1)&&(ze=Dn===1),_a=!0,setTimeout(rc,30),C(),ze&&!Wt?n.appendChild(b):s.parentNode.insertBefore(b,ze?Wt:s),Fe&&xr(Fe,0,jt-Fe.scrollTop),W=b.parentNode,Xe!==void 0&&!On&&(Yn=Math.abs(Xe-K(s)[Ut])),ae(),q(!0)}if(n.contains(b))return q(!1)}return!1},_ignoreWhileAnimating:null,_offMoveEvents:function(){P(document,"mousemove",this._onTouchMove),P(document,"touchmove",this._onTouchMove),P(document,"pointermove",this._onTouchMove),P(document,"dragover",nt),P(document,"mousemove",nt),P(document,"touchmove",nt)},_offUpEvents:function(){var e=this.el.ownerDocument;P(e,"mouseup",this._onDrop),P(e,"touchend",this._onDrop),P(e,"pointerup",this._onDrop),P(e,"pointercancel",this._onDrop),P(e,"touchcancel",this._onDrop),P(document,"selectstart",this)},_onDrop:function(e){var n=this.el,s=this.options;if(fe=ve(b),je=ve(b,s.draggable),le("drop",this,{evt:e}),W=b&&b.parentNode,fe=ve(b),je=ve(b,s.draggable),T.eventCanceled){this._nulling();return}_t=!1,On=!1,dn=!1,clearInterval(this._loopId),clearTimeout(this._dragStartTimer),wa(this.cloneId),wa(this._dragStartId),this.nativeDraggable&&(P(document,"drop",this),P(n,"dragstart",this._onDragStart)),this._offMoveEvents(),this._offUpEvents(),rn&&E(document.body,"user-select",""),E(b,"transform",""),e&&(Zt&&(e.cancelable&&e.preventDefault(),!s.dropBubble&&e.stopPropagation()),D&&D.parentNode&&D.parentNode.removeChild(D),(U===W||Q&&Q.lastPutMode!=="clone")&&j&&j.parentNode&&j.parentNode.removeChild(j),b&&(this.nativeDraggable&&P(b,"dragend",this),Hs(b),b.style["will-change"]="",Zt&&!_t&&pe(b,Q?Q.options.ghostClass:this.options.ghostClass,!1),pe(b,this.options.chosenClass,!1),re({sortable:this,name:"unchoose",toEl:W,newIndex:null,newDraggableIndex:null,originalEvent:e}),U!==W?(fe>=0&&(re({rootEl:W,name:"add",toEl:W,fromEl:U,originalEvent:e}),re({sortable:this,name:"remove",toEl:W,originalEvent:e}),re({rootEl:W,name:"sort",toEl:W,fromEl:U,originalEvent:e}),re({sortable:this,name:"sort",toEl:W,originalEvent:e})),Q&&Q.save()):fe!==kt&&fe>=0&&(re({sortable:this,name:"update",toEl:W,originalEvent:e}),re({sortable:this,name:"sort",toEl:W,originalEvent:e})),T.active&&((fe==null||fe===-1)&&(fe=kt,je=ln),re({sortable:this,name:"end",toEl:W,originalEvent:e}),this.save()))),this._nulling()},_nulling:function(){le("nulling",this),U=b=W=D=at=j=Gn=He=tt=_e=Zt=fe=je=kt=ln=vt=cn=Q=Mn=T.dragged=T.ghost=T.clone=T.active=null;var e=this.el;ls.forEach(function(n){e.contains(n)&&(n.checked=!0)}),ls.length=Us=js=0},handleEvent:function(e){switch(e.type){case"drop":case"dragend":this._onDrop(e);break;case"dragenter":case"dragover":b&&(this._onDragOver(e),ic(e));break;case"selectstart":e.preventDefault();break}},toArray:function(){for(var e=[],n,s=this.el.children,a=0,r=s.length,o=this.options;a<r;a++)n=s[a],we(n,o.draggable,this.el,!1)&&e.push(n.getAttribute(o.dataIdAttr)||uc(n));return e},sort:function(e,n){var s={},a=this.el;this.toArray().forEach(function(r,o){var l=a.children[o];we(l,this.options.draggable,a,!1)&&(s[r]=l)},this),n&&this.captureAnimationState(),e.forEach(function(r){s[r]&&(a.removeChild(s[r]),a.appendChild(s[r]))}),n&&this.animateAll()},save:function(){var e=this.options.store;e&&e.set&&e.set(this)},closest:function(e,n){return we(e,n||this.options.draggable,this.el,!1)},option:function(e,n){var s=this.options;if(n===void 0)return s[e];var a=Cn.modifyOption(this,e,n);typeof a<"u"?s[e]=a:s[e]=n,e==="group"&&Dr(s)},destroy:function(){le("destroy",this);var e=this.el;e[ce]=null,P(e,"mousedown",this._onTapStart),P(e,"touchstart",this._onTapStart),P(e,"pointerdown",this._onTapStart),this.nativeDraggable&&(P(e,"dragover",this),P(e,"dragenter",this)),Array.prototype.forEach.call(e.querySelectorAll("[draggable]"),function(n){n.removeAttribute("draggable")}),this._onDrop(),this._disableDelayedDragEvents(),os.splice(os.indexOf(this.el),1),this.el=e=null},_hideClone:function(){if(!He){if(le("hideClone",this),T.eventCanceled)return;E(j,"display","none"),this.options.removeCloneOnHide&&j.parentNode&&j.parentNode.removeChild(j),He=!0}},_showClone:function(e){if(e.lastPutMode!=="clone"){this._hideClone();return}if(He){if(le("showClone",this),T.eventCanceled)return;b.parentNode==U&&!this.options.group.revertClone?U.insertBefore(j,b):at?U.insertBefore(j,at):U.appendChild(j),this.options.group.revertClone&&this.animate(b,j),E(j,"display",""),He=!1}}};function ic(t){t.dataTransfer&&(t.dataTransfer.dropEffect="move"),t.cancelable&&t.preventDefault()}function Ln(t,e,n,s,a,r,o,l){var c,d=t[ce],m=d.options.onMove,h;return window.CustomEvent&&!Be&&!xn?c=new CustomEvent("move",{bubbles:!0,cancelable:!0}):(c=document.createEvent("Event"),c.initEvent("move",!0,!0)),c.to=e,c.from=t,c.dragged=n,c.draggedRect=s,c.related=a||e,c.relatedRect=r||K(e),c.willInsertAfter=l,c.originalEvent=o,t.dispatchEvent(c),m&&(h=m.call(d,c,o)),h}function Hs(t){t.draggable=!1}function rc(){_a=!1}function oc(t,e,n){var s=K(qt(n.el,0,n.options,!0)),a=Tr(n.el,n.options,D),r=10;return e?t.clientX<a.left-r||t.clientY<s.top&&t.clientX<s.right:t.clientY<a.top-r||t.clientY<s.bottom&&t.clientX<s.left}function lc(t,e,n){var s=K(Wa(n.el,n.options.draggable)),a=Tr(n.el,n.options,D),r=10;return e?t.clientX>a.right+r||t.clientY>s.bottom&&t.clientX>s.left:t.clientY>a.bottom+r||t.clientX>s.right&&t.clientY>s.top}function cc(t,e,n,s,a,r,o,l){var c=s?t.clientY:t.clientX,d=s?n.height:n.width,m=s?n.top:n.left,h=s?n.bottom:n.right,g=!1;if(!o){if(l&&Yn<d*a){if(!dn&&(cn===1?c>m+d*r/2:c<h-d*r/2)&&(dn=!0),dn)g=!0;else if(cn===1?c<m+Yn:c>h-Yn)return-cn}else if(c>m+d*(1-a)/2&&c<h-d*(1-a)/2)return dc(e)}return g=g||o,g&&(c<m+d*r/2||c>h-d*r/2)?c>m+d/2?1:-1:0}function dc(t){return ve(b)<ve(t)?1:-1}function uc(t){for(var e=t.tagName+t.className+t.src+t.href+t.textContent,n=e.length,s=0;n--;)s+=e.charCodeAt(n);return s.toString(36)}function pc(t){ls.length=0;for(var e=t.getElementsByTagName("input"),n=e.length;n--;){var s=e[n];s.checked&&ls.push(s)}}function Xn(t){return setTimeout(t,0)}function wa(t){return clearTimeout(t)}_s&&L(document,"touchmove",function(t){(T.active||_t)&&t.cancelable&&t.preventDefault()});T.utils={on:L,off:P,css:E,find:kr,is:function(e,n){return!!we(e,n,e,!1)},extend:Gl,throttle:Sr,closest:we,toggleClass:pe,clone:Cr,index:ve,nextTick:Xn,cancelNextTick:wa,detectDirection:Ir,getChild:qt,expando:ce};T.get=function(t){return t[ce]};T.mount=function(){for(var t=arguments.length,e=new Array(t),n=0;n<t;n++)e[n]=arguments[n];e[0].constructor===Array&&(e=e[0]),e.forEach(function(s){if(!s.prototype||!s.prototype.constructor)throw"Sortable: Mounted plugin must be a constructor function, not ".concat({}.toString.call(s));s.utils&&(T.utils=De(De({},T.utils),s.utils)),Cn.mount(s)})};T.create=function(t,e){return new T(t,e)};T.version=Vl;var H=[],en,$a,ka=!1,Vs,Ks,cs,tn;function fc(){function t(){this.defaults={scroll:!0,forceAutoScrollFallback:!1,scrollSensitivity:30,scrollSpeed:10,bubbleScroll:!0};for(var e in this)e.charAt(0)==="_"&&typeof this[e]=="function"&&(this[e]=this[e].bind(this))}return t.prototype={dragStarted:function(n){var s=n.originalEvent;this.sortable.nativeDraggable?L(document,"dragover",this._handleAutoScroll):this.options.supportPointer?L(document,"pointermove",this._handleFallbackAutoScroll):s.touches?L(document,"touchmove",this._handleFallbackAutoScroll):L(document,"mousemove",this._handleFallbackAutoScroll)},dragOverCompleted:function(n){var s=n.originalEvent;!this.options.dragOverBubble&&!s.rootEl&&this._handleAutoScroll(s)},drop:function(){this.sortable.nativeDraggable?P(document,"dragover",this._handleAutoScroll):(P(document,"pointermove",this._handleFallbackAutoScroll),P(document,"touchmove",this._handleFallbackAutoScroll),P(document,"mousemove",this._handleFallbackAutoScroll)),Ti(),Qn(),Yl()},nulling:function(){cs=$a=en=ka=tn=Vs=Ks=null,H.length=0},_handleFallbackAutoScroll:function(n){this._handleAutoScroll(n,!0)},_handleAutoScroll:function(n,s){var a=this,r=(n.touches?n.touches[0]:n).clientX,o=(n.touches?n.touches[0]:n).clientY,l=document.elementFromPoint(r,o);if(cs=n,s||this.options.forceAutoScrollFallback||xn||Be||rn){Gs(n,this.options,l,s);var c=Ve(l,!0);ka&&(!tn||r!==Vs||o!==Ks)&&(tn&&Ti(),tn=setInterval(function(){var d=Ve(document.elementFromPoint(r,o),!0);d!==c&&(c=d,Qn()),Gs(n,a.options,d,s)},10),Vs=r,Ks=o)}else{if(!this.options.bubbleScroll||Ve(l,!0)===Te()){Qn();return}Gs(n,this.options,Ve(l,!1),!1)}}},Ne(t,{pluginName:"scroll",initializeByDefault:!0})}function Qn(){H.forEach(function(t){clearInterval(t.pid)}),H=[]}function Ti(){clearInterval(tn)}var Gs=Sr(function(t,e,n,s){if(e.scroll){var a=(t.touches?t.touches[0]:t).clientX,r=(t.touches?t.touches[0]:t).clientY,o=e.scrollSensitivity,l=e.scrollSpeed,c=Te(),d=!1,m;$a!==n&&($a=n,Qn(),en=e.scroll,m=e.scrollFn,en===!0&&(en=Ve(n,!0)));var h=0,g=en;do{var _=g,$=K(_),w=$.top,O=$.bottom,C=$.left,q=$.right,ae=$.width,Y=$.height,ge=void 0,ke=void 0,Xe=_.scrollWidth,zt=_.scrollHeight,ue=E(_),Ut=_.scrollLeft,Fe=_.scrollTop;_===c?(ge=ae<Xe&&(ue.overflowX==="auto"||ue.overflowX==="scroll"||ue.overflowX==="visible"),ke=Y<zt&&(ue.overflowY==="auto"||ue.overflowY==="scroll"||ue.overflowY==="visible")):(ge=ae<Xe&&(ue.overflowX==="auto"||ue.overflowX==="scroll"),ke=Y<zt&&(ue.overflowY==="auto"||ue.overflowY==="scroll"));var jt=ge&&(Math.abs(q-a)<=o&&Ut+ae<Xe)-(Math.abs(C-a)<=o&&!!Ut),Me=ke&&(Math.abs(O-r)<=o&&Fe+Y<zt)-(Math.abs(w-r)<=o&&!!Fe);if(!H[h])for(var Qe=0;Qe<=h;Qe++)H[Qe]||(H[Qe]={});(H[h].vx!=jt||H[h].vy!=Me||H[h].el!==_)&&(H[h].el=_,H[h].vx=jt,H[h].vy=Me,clearInterval(H[h].pid),(jt!=0||Me!=0)&&(d=!0,H[h].pid=setInterval(function(){s&&this.layer===0&&T.active._onTouchMove(cs);var Wt=H[this.layer].vy?H[this.layer].vy*l:0,ze=H[this.layer].vx?H[this.layer].vx*l:0;typeof m=="function"&&m.call(T.dragged.parentNode[ce],ze,Wt,t,cs,H[this.layer].el)!=="continue"||xr(H[this.layer].el,ze,Wt)}.bind({layer:h}),24))),h++}while(e.bubbleScroll&&g!==c&&(g=Ve(g,!1)));ka=d}},30),Or=function(e){var n=e.originalEvent,s=e.putSortable,a=e.dragEl,r=e.activeSortable,o=e.dispatchSortableEvent,l=e.hideGhostForTarget,c=e.unhideGhostForTarget;if(n){var d=s||r;l();var m=n.changedTouches&&n.changedTouches.length?n.changedTouches[0]:n,h=document.elementFromPoint(m.clientX,m.clientY);c(),d&&!d.el.contains(h)&&(o("spill"),this.onSpill({dragEl:a,putSortable:s}))}};function Ha(){}Ha.prototype={startIndex:null,dragStart:function(e){var n=e.oldDraggableIndex;this.startIndex=n},onSpill:function(e){var n=e.dragEl,s=e.putSortable;this.sortable.captureAnimationState(),s&&s.captureAnimationState();var a=qt(this.sortable.el,this.startIndex,this.options);a?this.sortable.el.insertBefore(n,a):this.sortable.el.appendChild(n),this.sortable.animateAll(),s&&s.animateAll()},drop:Or};Ne(Ha,{pluginName:"revertOnSpill"});function Va(){}Va.prototype={onSpill:function(e){var n=e.dragEl,s=e.putSortable,a=s||this.sortable;a.captureAnimationState(),n.parentNode&&n.parentNode.removeChild(n),a.animateAll()},drop:Or};Ne(Va,{pluginName:"removeOnSpill"});T.mount(new fc);T.mount(Va,Ha);class hc extends me{static properties={playlistId:{type:String}};constructor(){super(),this.playlistId="",this._query=""}deps(){return[i.playlistVersion,i.songs,this.playlistId,this._query]}get already(){const e=i.playlists.find(n=>n.id===this.playlistId);return new Set(e?.songIds||[])}get filtered(){const e=this._query.trim().toLowerCase();return e?i.songs.filter(n=>`${n.title} ${n.artist} ${n.album}`.toLowerCase().includes(e)):i.songs}render(){const e=this.already,n=this.filtered,s=i.songs.filter(a=>!e.has(a.id)).length;return p`
      <input
        class="input"
        id="addsongs-filter"
        type="text"
    ...
    `}setAll(e){for(const n of this.querySelectorAll("[data-song-check]:not(:disabled)"))n.checked=e}}te("mp-add-songs",hc);function Pr(t){ee({title:"新建歌单",desc:"歌单名称可以随时修改。",body:p`<input class="input" data-field="name" type="text" placeholder="例如：深夜循环" maxlength="40" />`,okText:"创建",onOk:e=>{const n=String(e.name||"").trim();if(!n)return"请输入歌单名称";if(i.playlists.some(a=>a.name===n))return"已存在同名歌单";const s=Do(n);return t?.(s),u(`已创建歌单「${n}」`,{tone:"success"}),!0}})}function mc(t,e){const n=Re(t);!n||n.locked||ee({title:"重命名歌单",body:p`<input class="input" data-field="name" type="text" .value=${n.name} maxlength="40" />`,okText:"保存",onOk:s=>{const a=String(s.name||"").trim();return a?(Mo(t,a),!0):"名称不能为空"}})}function gc(t,e){const n=Re(t);!n||n.locked||ee({title:`删除歌单「${n.name}」？`,desc:"只会删除歌单本身，本地音乐文件不会被删除。",okText:"删除",danger:!0,onOk:()=>(Ao(t),e?.(),u("歌单已删除"),!0)})}function ds(t,e){const n=Re(t);if(!n)return;const s=Io(t,e);s?u(`已添加 ${s} 首到「${n.name}」`,{tone:"success"}):u("所选歌曲已在该歌单中")}function vc(t){const e=Re(t);if(!e)return;if(!i.songs.length){u("本地曲库还是空的，先扫描音乐文件夹吧",{tone:"warning"});return}const n=new Set(e.songIds);ee({title:`添加歌曲到「${e.name}」`,desc:"勾选要加入的歌曲；已经在歌单里的会保持选中。",body:p`<mp-add-songs .playlistId=${t}></mp-add-songs>`,okText:"加入歌单",onOk:(s,a)=>{const o=[...a.querySelectorAll("[data-song-check]:checked")].map(l=>l.dataset.songCheck).filter(l=>!n.has(l));return o.length?(ds(t,o),!0):"没有选中新的歌曲"}})}function Sa(t,e){const n=Re(t);if(!n)return;const s=[{id:"play",label:"播放这个歌单",icon:"play"},{id:"queue",label:"加入播放列表",icon:"queue"},{id:"sep1",kind:"sep"}];n.locked||(s.push({id:"rename",label:"重命名",icon:"edit"}),s.push({id:"delete",label:"删除歌单",icon:"trash",danger:!0}),s.push({id:"sep2",kind:"sep"})),s.push({id:"export",label:"导出为 m3u",icon:"file"});const a=e.getBoundingClientRect();vn({x:a.left,y:a.bottom+6,align:"right",items:s,onPick:async r=>{switch(r){case"play":bc(n);break;case"queue":{(await pt(()=>import("./base-DT2k5XGZ.js").then(l=>l.a3),__vite__mapDeps([0,1]))).appendToQueue(n.songIds),u(`已把 ${A(n.songIds.length)} 首加入播放列表`,{tone:"success"});break}case"rename":mc(n.id);break;case"delete":gc(n.id,()=>Ct("library"));break;case"export":u("导出 m3u 需要接入后端后实现",{duration:2200});break}}})}function bc(t){pt(async()=>{const{playContext:e}=await import("./base-DT2k5XGZ.js").then(n=>n.a3);return{playContext:e}},__vite__mapDeps([0,1])).then(({playContext:e})=>{e(t.songIds.slice(),0,{type:"playlist",id:t.id})})}let Ei=0;class yc extends me{static deps=e=>[e.view,e.playlistId,e.playlistVersion,e.songs.length,e.queue.length];firstUpdated(){this.bindDrag()}bindDrag(){const e=this.querySelector("#playlist-nav");!e||this._sortable||(this._sortable=T.create(e,{draggable:".navitem",filter:'[data-locked="true"]',animation:0,ghostClass:"is-dragging",onEnd:n=>this.onDragEnd(n)}))}onDragEnd(e){Ei=Date.now();const n=e.oldIndex,s=e.newIndex;if(n==null||s==null||n===s)return;const a=e.from,r=Array.from(a.children).filter(o=>o!==e.item);a.insertBefore(e.item,r[n]??null),Oo(n-1,s-1),u("已调整歌单顺序",{duration:1400})}onSidebarClick(e){if(Date.now()-Ei<260)return;const n=e.target.closest('[data-act="pl-more"]');if(n){e.stopPropagation(),Sa(n.dataset.id,n);return}const s=e.target.closest("[data-nav]");if(!s)return;const a=s.dataset.nav;a==="playlist"?Ct("playlist",s.dataset.playlist):Ct(a)}render(){const e=i.playlists.filter(a=>a.id!==Wn),s=[Re(Wn),...e].filter(Boolean);return p`
      <aside
        class="sidebar"
        id="sidebar"
        @click=${a=>this.onSidebarClick(a)}
        @contextmenu=${a=>{const r=a.target.closest('[data-nav="playlist"]');r&&(a.preventDefault(),Sa(r.dataset.playlist,r))}}
      >
    ...
    `}}te("mp-sidebar",yc);const _c=Na(class extends Ba{constructor(){super(...arguments),this.key=M}render(t,e){return this.key=t,e}update(t,[e,n]){return e!==this.key&&(ur(t),this.key=e),n}}),Ka=[{id:"auto",label:"自动识别（按接口地址与模型名判断）",hint:"识别不出时按 OpenAI 兼容接口处理"},{id:"openai",label:"OpenAI（GPT-5 系列 / o 系列）",hint:"o 系列无法完全关闭思考，只能降到最低档"},{id:"deepseek",label:"DeepSeek（deepseek-chat / reasoner）",hint:"思考模式下 temperature 会被忽略"},{id:"anthropic",label:"Anthropic Claude",hint:"开启思考时 temperature 必须为 1，程序会自动去掉它"},{id:"gemini",label:"Google Gemini",hint:"Pro 系列无法关闭思考"},{id:"qwen",label:"阿里通义千问 Qwen",hint:"仅「混合思考」模型可关闭；部分开源模型只支持流式"},{id:"glm",label:"智谱 GLM",hint:"GLM-5.3 系列传 disabled 会报错"},{id:"kimi",label:"月之暗面 Kimi",hint:"kimi-k3 / k2.7-code 始终思考，传 thinking 会报错"},{id:"minimax",label:"MiniMax",hint:"官方未提供关闭思考的参数，只能保持默认"},{id:"xai",label:"xAI Grok",hint:"reasoning_effort=none 可真正关闭"},{id:"openrouter",label:"OpenRouter（统一网关）",hint:"统一 reasoning 字段；标记 mandatory 的模型不接受关闭"},{id:"siliconflow",label:"SiliconFlow（硅基流动）",hint:"R1 类纯推理模型无法关闭"},{id:"ollama",label:"Ollama（本地，OpenAI 兼容）",hint:"本地兼容层用 reasoning_effort；GPT-OSS 无法完全关闭"}];function wc(t){return Ka.find(e=>e.id===t)?.label||t||"自动识别"}function Lr(t){return Ka.find(e=>e.id===t)?.hint||""}const qr=["off","auto","mica","acrylic","tabbed"],Ii={off:"关闭（不透明窗口）",auto:"自动（系统决定）",mica:"Mica（Win11 材质）",acrylic:"Acrylic（亚克力）",tabbed:"Tabbed（标签页材质）"};function Jn(t){return Ii[t]||Ii.off}function $c(t){const e=document.documentElement;!t||t==="off"?delete e.dataset.backdrop:e.dataset.backdrop=t}async function kc(){let t=null;if(S())try{t=await y.backdrop()}catch(e){console.warn("[backdrop] 读取窗口材质状态失败",e)}return t?t.preview=!1:t={configured:i.config.nativeBackdrop||"off",active:"off",supported:!1,os:"",restartRequired:!1,preview:!S()},i.backdropState=t,$c(t.active),t}let oe=null,qn=null,Di=0,It=null,us=null,xa=0;const Rr=1500,Dt="idle",Rt="loading";let $e=Dt,rt=null,ot=!1,Ys=0;const Sc=12e3;let be=null,xe=null,Ai=null,Zn=!1,We=null,St=null;function xc(t){if(Zn)return!1;if(be&&xe)return!0;const e=window.AudioContext||window.webkitAudioContext;if(!e)return Zn=!0,!1;try{be=new e,xe=be.createGain(),xe.gain.value=1,Ai=be.createMediaElementSource(t),Ai.connect(xe),xe.connect(be.destination);try{We=be.createAnalyser(),We.fftSize=512,We.smoothingTimeConstant=.76,St=new Uint8Array(We.frequencyBinCount),xe.connect(We)}catch{We=null,St=null}return us=null,!0}catch(n){return console.warn("[audio] Web Audio 链路建立失败，退回元素音量",n),Zn=!0,!1}}function Nr(){const t=i.config.loudnessMode||"off";let e=0;t!=="off"&&i.currentId&&(e=i.loudnessGains?.[i.currentId]??0);const n=10**(e/20);return(i.muted?0:i.volume)*n}function Nt(){const t=oe,e=Nr();if(be&&xe&&!Zn){const n=be.currentTime;try{xe.gain.cancelScheduledValues(n),xe.gain.setTargetAtTime(e,n,.015)}catch{xe.gain.value=e}t&&(t.volume=1),us=e;return}t&&(t.volume=Math.max(0,Math.min(1,e))),us=e}function _n(){Nr()!==us&&Nt()}function Cc(t){return t?(be?.state==="suspended"&&be.resume().catch(()=>{}),t.play().catch(e=>{Oc(e)||u(`播放失败：${e?.message??e}`,{tone:"error",duration:5e3})})):Promise.resolve()}function Ca(t){if(t){if(i.playing&&t.paused){Cc(t);return}!i.playing&&!t.paused&&(ot=!0,t.pause())}}function Tc(t){const e=Number.isFinite(t.duration)&&t.duration>0?t.duration*1e3:i.duration||0;return e?(Number.isFinite(t.currentTime)?t.currentTime*1e3:i.position)>=e-300:!1}function Ec(){$e=Rt,ot=!1,rt&&clearTimeout(rt),rt=setTimeout(()=>{rt=null,$e===Rt&&Br(oe)},Sc)}function Br(t){rt&&(clearTimeout(rt),rt=null),$e===Rt&&($e=Dt,Ca(t||oe))}function Ga(){return oe||(oe=document.getElementById("audio-engine"),oe||(oe=document.createElement("audio"),oe.id="audio-engine",oe.preload="auto",oe.hidden=!0,document.body.appendChild(oe)),oe.crossOrigin="anonymous",Dc(oe),oe)}function Ic(){try{return Ga()}catch(t){return console.warn("[audio] 音频元素不可用",t),null}}function Dc(t){t.dataset.bound!=="1"&&(t.dataset.bound="1",t.addEventListener("loadedmetadata",()=>{if(Number.isFinite(t.duration)&&t.duration>0&&(i.duration=t.duration*1e3,it(),x()),It!=null){const e=It;It=null;try{t.currentTime=Math.max(0,Math.min(e,i.duration||0)/1e3)}catch{}}Br(t)}),t.addEventListener("timeupdate",()=>{document.getElementById("progress")?.dataset.dragging!=="true"&&(i.position=t.currentTime*1e3,it())}),t.addEventListener("play",()=>{$e!==Rt&&(ot=!1,i.playing=!0,be?.state==="suspended"&&be.resume().catch(()=>{}),it())}),t.addEventListener("pause",()=>{if(ot){ot=!1;return}$e!==Rt&&(t.ended||Tc(t)||Ys&&performance.now()-Ys<Rr||(i.playing=!1,it()))}),t.addEventListener("ended",()=>{if(Ys=performance.now(),i.sleepTimer?.type==="after-song"){hn(!0);return}if(i.playMode==="loop-one"){t.currentTime=0,t.play().catch(()=>{});return}hn(!0)}),t.addEventListener("error",()=>{$e=Dt,ot=!1;const e=Mt();if(!e||Ac(t.error))return;const n=t.error?.code;u(`${n===4?"格式无法播放（解码失败）":n===3?"音频数据损坏":n===2?"网络中断":"音频加载失败"}：${e.title}`,{tone:"error",duration:4e3})}))}function Ac(t){return xa&&performance.now()-xa<Rr?!0:!t||!t.code}async function Mc(){if(!S())return;const t=Ga(),e=Mt();if(!e){qn!==null&&(t.pause(),t.removeAttribute("src"),t.load(),qn=null,$e=Dt,ot=!1);return}if(qn!==e.id){qn=e.id,Ec();const n=++Di;let s=null;try{s=e.streamUrl||await y.mediaUrl(e.id)}catch(a){$e=Dt,u(`无法播放：${a?.message??"取播放地址失败"}`,{tone:"error",duration:5e3});return}if(n!==Di)return;if(!s){$e=Dt,u("无法播放：后端没有返回地址",{tone:"error",duration:5e3});return}It=0,t.src=s,xa=performance.now(),t.load(),xc(t),Nt(),e.online||Fr(e.id),Ca(t);return}$e!==Rt&&Ca(t)}function Oc(t){const e=t?.name||"";if(e==="AbortError"||e==="NotAllowedError")return!0;const n=String(t?.message||"");return/abort|interrupted by a new load|play\(\) request was interrupted/i.test(n)}const Rn=new Map;async function Fr(t){const e=i.config.loudnessMode||"off";if(e==="off"||!S()||!t||i.loudnessGains?.[t]!==void 0)return;if(Rn.has(t))return Rn.get(t);const n=(async()=>{try{const s=i.config.loudnessTarget??-16,a=await y.loudnessLookup(t,s);if(a?.measured){Mi(t,a.gainDB);return}if(e==="album")return;const r=await y.loudnessMeasure(t,s);r?.measured&&Mi(t,r.gainDB??Pc(r,s))}catch(s){console.warn("[audio] 响度补偿获取失败",s)}finally{Rn.delete(t)}})();return Rn.set(t,n),n}function Pc(t,e){if(!t?.integrated)return 0;let n=e-t.integrated;if(t.truePeak){const s=-1-t.truePeak;n>s&&(n=s)}return n>24&&(n=24),n<-24&&(n=-24),Math.round(n*100)/100}function Mi(t,e){i.loudnessGains||(i.loudnessGains={}),i.loudnessGains[t]=e,t===i.currentId&&Nt(),it()}async function Lc(){const t=i.config.loudnessTarget??-16;if(i.loudnessGains={},_n(),it(),!!S())try{await y.loudnessInvalidateTarget(t)}catch(e){console.warn("[loudness] 失效旧补偿失败",e)}}async function ws(){if(!S())return;const t=i.config.loudnessMode||"off";if(t==="off"){i.loudnessGains={},_n();return}const e=i.config.loudnessTarget??-16;try{const n=t==="album"?await y.loudnessAlbumGains(e):await y.loudnessGainMap(e);i.loudnessGains=n||{},_n(),it(),t==="track"&&i.currentId&&Fr(i.currentId)}catch(n){console.warn("[loudness] 拉取补偿增益失败",n)}}async function un(){if(!S())return null;try{const t=await y.loudnessState();return t&&(i.loudnessState=t),t}catch{return null}}function ps(t){$t(t),qc(t)}function qc(t){if(!S())return;const e=Ga();if(!e.src){It=t;return}const n=Math.max(0,Math.min(t,i.duration||0))/1e3;try{e.currentTime=n}catch{It=t}}function Ya(t=32){if(!We||!St)return null;We.getByteFrequencyData(St);const e=Math.max(1,Math.min(128,Math.floor(t)||32)),n=new Float32Array(e),s=St.length;for(let a=0;a<e;a+=1){const r=Math.floor(s*(a/e)**1.7),o=Math.min(s,Math.max(r+1,Math.floor(s*((a+1)/e)**1.7)));let l=0;for(let c=r;c<o;c+=1)l+=St[c];n[a]=l/((o-r)*255)}return n}let Ta="";function Tn(){return i.config.showDesktopLyrics===!0}async function Oi(t,{force:e=!1}={}){const n=!!t,s=Tn()!==n;if(i.config.showDesktopLyrics=n,Ta="",!s&&!e)return he(),{ok:!0,enabled:n,unchanged:!0};if(!S())return $s({enabled:n}),{ok:!0,preview:!0,enabled:n};try{const a=await y.desktopLyrics(n);return n&&a?.ok===!1&&(i.config.showDesktopLyrics=!1,he()),a}catch(a){return console.warn("[desktop-lyrics] 打开/关闭桌面歌词失败",a),i.config.showDesktopLyrics=!1,he(),{ok:!1,enabled:n,error:String(a?.message??a)}}}function Rc({text:t="",playing:e=!1,fontSize:n=26}={}){if(!Tn())return;const s=[t,e?1:0,Math.round(n)].join("|");if(s!==Ta){if(Ta=s,!S()){$s({text:t,playing:e});return}y.updateDesktopLyrics({text:t,playing:e,fontSize:n}).catch(a=>{console.warn("[desktop-lyrics] 同步歌词失败",a?.message??a)})}}function $s({text:t="",playing:e=!1,enabled:n=null}={}){const s=n===null?Tn():!!n,a=!S()&&s&&e&&!!t;i.floatingLyrics={show:a,text:t},he()}function Nc(){return Math.round(Bt()*1.3)}const Bc="/skins/";let Ce=new Map;const Ea=new Set,Xs=new Set;function de(){return Ge(i.currentId)}function Fc(){const t=i.config.lyricsSources;return!Array.isArray(t)||!t.length?!0:t.includes("online")}async function zr(t){if(!t)return{lines:[],text:"",source:"none"};if(Ce.has(t.id))return Ce.get(t.id);let e="",n="none";if(S()){const a=await y.loadLyrics(t.id);a&&typeof a=="object"&&typeof a.lrc=="string"?(e=a.lrc,n=a.source||"backend"):typeof a=="string"&&(e=a,n="backend"),!e&&Fc()&&(e=await zc(t),e&&(n="online"))}if(!e){if(S()){const r={lines:[],text:"",source:"none"};return Ce.set(t.id,r),r}const a=i.songs.findIndex(r=>r.id===t.id);e=a===0?Po:a===1?Lo:Uc(t),n="preview"}const s={lines:ua(e),text:e,source:n};return Ce.set(t.id,s),s}async function zc(t){if(Ea.has(t.id))return"";Ea.add(t.id);try{if(t.online){const n=await y.onlineLyrics(t.title||"",t.artist||"",t.duration||0),s=typeof n?.lrc=="string"?n.lrc:"";return s?(y.lyricsSave(t.id,s,n?.source||"online",!1).catch(()=>{}),s):""}const e=await y.lyricsAutoMatch(t.id);return typeof e?.lrc=="string"?e.lrc:""}catch(e){return console.warn("[lyrics] 在线自动匹配失败",e),""}}function Uc(t){const e=[];for(let n=12;n<Math.max(60,Math.floor((t.duration||18e4)/1e3)-10);n+=9)e.push(`[00:${String(n).padStart(2,"0")}.00]（${t.title} · 暂无歌词文件，接入后端后可读取 .lrc 或内嵌歌词）`);return e.join(`
`)}const Ia=new Map;function At(t){return Ia.get(t)||0}function ct(t,e){if(!t)return 0;const n=Math.round(Number(e)||0);return n?Ia.set(t,n):Ia.delete(t),z.lyricsText=null,k.ctx&&de()?.id===t&&Z({type:"lyrics",...Ae()}),n}let Nn={songId:"",offset:0,lines:[]};function Xa(t){const n=(t?Ce.get(t.id):null)?.lines||[],s=At(t?.id);if(!s||!n.length)return n;if(Nn.songId===t.id&&Nn.offset===s)return Nn.lines;const a=n.map(r=>({time:r.time+s,text:r.text}));return Nn={songId:t.id,offset:s,lines:a},a}function ye(t){const e=t?Ge(t):de(),n=e?Ce.get(e.id):null;return{song:e||null,songId:e?.id||"",text:n?.text||"",source:n?.source||"none",lines:n?.lines||[]}}function Pi(t){switch(t){case"embedded":return"音频内嵌";case"lrc-file":return"同名 .lrc 文件";case"cache":return"程序缓存";case"online":return"在线匹配";case"manual":return"手动编辑";case"preview":return"预览数据";default:return"暂无"}}async function fs(){const t=de();if(!(!t||Ce.has(t.id)||Xs.has(t.id))){Xs.add(t.id);try{await zr(t)}finally{Xs.delete(t.id)}}}function jc(){const t=de();if(!t)return"";const e=Xa(t);if(!e.length)return"";const n=Ra(e,i.position);return n>=0?e[n].text:""}function Wc(){const t={prev:"",text:"",next:""},e=de();if(!e)return t;const n=Xa(e);if(!n.length)return t;const s=Ra(n,i.position);return s<0?t:{prev:n[s-1]?.text||"",text:n[s].text||"",next:n[s+1]?.text||""}}async function Qs(t,e,n="online",s={}){if(!t||!e)return!1;Ce.set(t,{lines:ua(e),text:e,source:n}),Ea.add(t),z.lyricsText=null;let a=null;if(!s.transient&&S()){const r=s.embed??i.config.embedMeta===!0;try{const o=await y.lyricsSave(t,e,n,r);a=o||null;const l=typeof o?.lrc=="string"&&o.lrc?o.lrc:e;l!==e&&(Ce.set(t,{lines:ua(l),text:l,source:n}),z.lyricsText=null)}catch(o){console.warn("[lyrics] 写入缓存失败",o)}}return k.ctx&&de()?.id===t&&Z({type:"lyrics",...Ae()}),a||{ok:!0}}const Da=[],Js=new Set;let es=null;async function Qa(){return es||(es=Vc()),es}async function Hc(){try{await Qa()}catch(t){console.warn("[skins] 启动扫描样式失败",t)}return Pt()}async function Vc(){if(!S())return Pt();try{const t=await y.listSkins(),e=Array.isArray(t)?t:[];Da.length=0;const n=new Set;for(const s of e){if(!s?.id||!s?.module)continue;const a=`${Bc}${encodeURIComponent(s.id)}/`;try{await Vo({id:s.id,name:s.name,module:a+String(s.module).replace(/^\/+/,""),styles:(Array.isArray(s.styles)?s.styles:[]).map(r=>a+String(r).replace(/^\/+/,""))}),Js.add(s.id),n.add(s.id)}catch(r){Da.push({id:s.id,reason:r?.message??String(r)}),console.warn(`[skins] 样式「${s.id}」加载失败：`,r)}}for(const s of[...Js])n.has(s)||(Js.delete(s),Ko(s))}catch(t){console.warn("[skins] 皮肤目录扫描失败",t)}return Pt()}async function Ja(){es=null,await Qa(),Gc()}async function Kc(t){await y.deleteSkin(t),await Ja();const e=Pt().some(n=>n.id===t);return!e&&(i.pvMode===t||i.config.playerViewMode===t)&&wn(Sn("").skin?.id||""),{removed:!e,skinIds:Pt().map(n=>n.id)}}function Ur(){return Da.slice()}let jr=0;function Wr(){return jr}function Gc(){jr+=1,he()}const k={view:null,stage:null,backgroundRoot:null,skin:null,ctx:null,mountedId:null,closeTimer:null,resizeObserver:null,themeObserver:null,carouselTimer:null,carouselIndex:0,carouselLastAdvance:0,carouselSongId:null},z={songId:null,cover:null,lyricsText:null,options:null,playing:null,themeId:null};function ks(){return{position:i.position,duration:i.duration,playing:i.playing,volume:i.volume,muted:i.muted}}function Za(t){if(!t)return[Ke];const e=i.coverSets.get(t.id)?.items,n=Array.isArray(e)?e.map(s=>s.preview).filter(Boolean):[];return n.length?n:[ht(t)]}function ei(t){const e=t?Ce.get(t.id):null,n=Xa(t);return{lines:n,text:e?.text||"",source:e?.source||"none",index:Ra(n,i.position)}}function Yc(t){return t?{id:t.id??"",title:t.title||"",artist:t.artist||"",album:t.album||"",duration:t.duration||0}:null}function Ae(){const t=de(),e=Za(t),n=Ue(k.carouselIndex,0,Math.max(0,e.length-1));return{song:Yc(t),cover:e[n]||Ke,covers:e,coverIndex:n,lyrics:ei(t)}}function Ss(){return{showLyrics:i.config.showLyrics!==!1,lyricsFontSize:i.config.lyricsFontSize,animations:i.config.animations!==!1,coverCarousel:i.config.coverCarousel===!0,coverCarouselInterval:Kr().seconds,interactive:!0}}function Xc(){return Ae()}function Hr(){return ks()}function Qc(t={}){return{...Ss(),...t}}function Jc(){const t=new Map,e={root:k.stage,backgroundRoot:k.backgroundRoot,audio:Ic(),spectrum:Ya,defaultCover:Ke,get themeId(){return document.documentElement.dataset.theme||""},get mode(){return document.documentElement.dataset.mode==="light"?"light":"dark"},playback:ks,media:Ae,options:Ss,actions:{seek(n){ps(n),Gr({force:!0})},togglePlay:$n,next:()=>hn(!1),prev:()=>qa(),openFolder(){const n=de();n?.path&&y.revealInExplorer(n.path)},openCoverPanel(){const n=de();!n||n.online||pt(()=>Promise.resolve().then(()=>si),void 0).then(s=>s.openCoverPanel(n.id))}},on(n,s){return typeof s!="function"?()=>{}:(t.has(n)||t.set(n,new Set),t.get(n).add(s),()=>t.get(n)?.delete(s))},push(n){try{k.skin?.update?.(e,n)}catch(s){console.warn(`[skins] ${k.mountedId} 处理 ${n.type} 更新失败`,s)}for(const[s,a]of t)if(!(s!==n.type&&s!=="*"))for(const r of a)try{r(n)}catch(o){console.warn(`[skins] ${s} 订阅回调失败`,o)}}};return e}function Z(t){k.ctx?.push(t)}function Zc(t){const{skin:e,fellBack:n}=Sn(t);if(!e)return;n&&console.warn(`[skins] 样式「${t}」不存在，已回退到「${e.name}」`),Vr(),k.skin=e,k.mountedId=e.id,k.stage.innerHTML="",k.view.dataset.skin=e.id,k.view.dataset.skinBackground=e.background?"yes":"no",document.getElementById("app")?.setAttribute("data-mode",e.id),i.pvMode=e.id;const s=Jc();k.ctx=s;try{e.mount(s)}catch(a){console.error(`[skins] ${e.id} 挂载失败`,a),k.stage.innerHTML=`<div class="skin-error">样式「${ii(e.name)}」加载失败：${ii(a?.message??a)}</div>`;return}s.push({type:"mount",...Ae(),...ks(),options:Ss()}),ed(),Aa("closed")}function Aa(t){const e=k.backgroundRoot;e&&(e.dataset.state=t)}function Vr(){if(k.skin){Z({type:"close"}),Z({type:"destroy"});try{k.skin.destroy?.(k.ctx)}catch(t){console.warn(`[skins] ${k.mountedId} 卸载失败`,t)}k.stage.innerHTML="",k.skin=null,k.ctx=null,k.mountedId=null,k.resizeObserver&&(k.resizeObserver.disconnect(),k.resizeObserver=null)}}function ed(){k.resizeObserver||typeof ResizeObserver!="function"||(k.resizeObserver=new ResizeObserver(()=>{const t=k.stage.getBoundingClientRect();Z({type:"resize",width:Math.round(t.width),height:Math.round(t.height)})}),k.resizeObserver.observe(k.stage))}function Kr(){const t=Number(i.config.coverCarouselInterval),e=Number.isFinite(t)&&t>0?Math.max(2,t):10;return{enabled:i.config.coverCarousel===!0,seconds:e,intervalMs:e*1e3}}function td(){const t=de();k.carouselSongId!==(t?.id??null)&&(k.carouselSongId=t?.id??null,k.carouselIndex=i.coverSets.get(t?.id)?.active??0,k.carouselLastAdvance=Date.now());const{enabled:e,intervalMs:n}=Kr(),s=Za(t);!e||!i.playerOpen||!i.playing||s.length<2||Date.now()-k.carouselLastAdvance<n||(k.carouselLastAdvance=Date.now(),k.carouselIndex=(k.carouselIndex+1)%s.length,Z({type:"media",...Ae()}))}function nd(){k.carouselTimer||(k.carouselTimer=setInterval(td,1e3))}function sd(){const t=Za(de());return t.length<2?!1:(k.carouselIndex=(k.carouselIndex+1)%t.length,k.carouselLastAdvance=Date.now(),Z({type:"media",...Ae()}),!0)}function Li(){z.cover=null,k.ctx&&Z({type:"media",...Ae()})}function Zs(t={}){const e=Ae(),n=t.type==="song"||t.type==="lyrics"||t.type==="media",s=e.cover!==z.cover||e.song?.id!==z.songId;z.cover=e.cover,!(!s&&!n)&&Z({...t,...e})}function qi(){const t=Ss(),e=JSON.stringify(t);e!==z.options&&(z.options=e,Z({type:"options",options:t}))}async function ad(){if(!k.view){if(k.view=hi("#playerview"),k.stage=hi("#playerview-stage"),k.backgroundRoot=document.getElementById("skin-background"),!k.view||!k.stage)return;cd(),nd()}const t=k.view,e=de();if(!!!i.playerOpen){t.dataset.state!=="closed"&&(t.dataset.state="closed",Aa("closed"),k.closeTimer&&clearTimeout(k.closeTimer),k.closeTimer=setTimeout(()=>{k.closeTimer=null,!i.playerOpen&&(t.hidden=!0,Vr(),hs())},Nc()+20));return}k.closeTimer&&(clearTimeout(k.closeTimer),k.closeTimer=null),t.hidden=!1,await Qa();const s=i.pvMode||i.config.playerViewMode||"",a=k.mountedId!==s;if(a&&(Zc(s),hs()),(t.dataset.state!=="opened"||a)&&(t.offsetHeight,t.dataset.state="opened",Aa("opened")),!k.skin)return;if(z.songId!==(e?.id??null)){z.songId=e?.id??null,z.cover=null,z.lyricsText=null,k.carouselSongId=e?.id??null,k.carouselIndex=i.coverSets.get(e?.id)?.active??0,Zs({type:"song"});const o=e?.id??null,l=await zr(e);if((de()?.id??null)!==o)return;z.lyricsText=l.text,Zs({type:"lyrics"}),qi();return}Zs();const r=ei(e);r.text!==z.lyricsText&&(z.lyricsText=r.text,Z({type:"lyrics",...Ae()})),qi(),Gr()}function hs(){z.songId=null,z.cover=null,z.lyricsText=null,z.options=null,z.playing=null}function Gr({force:t=!1}={}){if(!i.playerOpen||!k.skin)return;const e=ks();(z.playing!==e.playing||t)&&(z.playing=e.playing,Z({type:"state",...e})),Z({type:"progress",...e,lyricIndex:ei(de()).index}),ld(e.playing)}const id=30,rd=32;let Kt=0,Gt=!1;function od(){const t=k.skin?.spectrum;if(!t)return 0;const e=Number(t);return!Number.isFinite(e)||e<=0?rd:Math.max(1,Math.min(256,Math.round(e)))}function ld(t){const e=t===!0?od():0;if(!e){if(Kt=0,!Gt)return;Gt=!1,Z({type:"spectrum",bands:null});return}const n=typeof performance<"u"&&performance.now?performance.now():Date.now();if(Kt&&n-Kt<1e3/id)return;const s=Ya(e);if(!s){if(!Gt)return;Kt=0,Gt=!1,Z({type:"spectrum",bands:null});return}Kt=n,Gt=!0,Z({type:"spectrum",bands:Array.from(s,a=>Math.round(a*1e3)/1e3)})}function cd(){k.themeObserver||(z.themeId=document.documentElement.dataset.theme||"",k.themeObserver=new MutationObserver(()=>{const t=document.documentElement.dataset.theme||"",e=document.documentElement.dataset.mode||"dark";t!==z.themeId&&(z.themeId=t,Z({type:"theme",themeId:t,mode:e}))}),k.themeObserver.observe(document.documentElement,{attributes:!0,attributeFilter:["data-theme","data-mode"]}))}function wn(t){const{skin:e,fellBack:n}=Sn(t);e&&(i.pvMode=e.id,i.config.playerViewMode=e.id,hs(),x(),n&&console.warn(`[skins] 样式「${t}」不可用，已切换到「${e.name}」`))}function Yr(){i.playerOpen=!0,i.pvMode=Sn(i.config.playerViewMode||"").skin?.id||i.pvMode,hs(),x()}function xs(){i.playerOpen=!1,x()}function Ma(){i.playerOpen?xs():Yr()}function ms(){return Pt().map(t=>({id:t.id,name:t.name,icon:t.icon||"disc",builtin:t.builtin!==!1,source:t.source||""}))}const dd=Ho;function En(){return i.config.showDesktopWallpaper===!0}function ea(){he()}async function ud(){if(!S())return!0;let t=!0,e="";try{const n=await y.desktopWallpaperState();t=n?.supported!==!1,e=n?.reason||""}catch(n){return console.info("[desktop-wallpaper] 能力探测失败",n?.message??n),!0}return t?!0:(i.desktopWallpaperSupport={supported:!1,reason:e||"当前系统不支持桌面背景歌词"},he(),!1)}async function Ri(t,{force:e=!1}={}){const n=!!t,s=En()!==n;if(i.config.showDesktopWallpaper=n,ea(),!s&&!e)return{ok:!0,enabled:n,unchanged:!0};if(!S())return n?(Oa(),{ok:!0,preview:!0,enabled:n}):($s({enabled:!1}),{ok:!0,preview:!0,enabled:n});try{const a=await y.desktopWallpaper(n);return n&&a?.ok===!1?(i.config.showDesktopWallpaper=!1,ea(),x()):n&&(pd(),Oa()),a}catch(a){return console.warn("[desktop-wallpaper] 打开/关闭桌面背景歌词失败",a),i.config.showDesktopWallpaper=!1,ea(),x(),{ok:!1,enabled:n,error:String(a?.message??a)}}}const I={setup:"",songId:"\0",cover:"\0",lyricsText:"\0",options:"",playing:null,volume:null,muted:null,duration:-1,lyricIndex:-2,position:-1,progressAt:0,progressPlaying:null};function pd(){I.setup="",I.songId="\0",I.cover="\0",I.lyricsText="\0",I.options="",I.playing=null,I.volume=null,I.muted=null,I.duration=-1,I.lyricIndex=-2,I.position=-1,I.progressAt=0,I.progressPlaying=null}function fd(){const t=[],e=bd();e.signature!==I.setup&&(I.setup=e.signature,t.push({type:"theme",skinId:e.skinId,themeId:e.theme,theme:e.theme,mode:e.mode,density:e.density,tokens:e.tokens}));const n=Xc(),s=Hr(),a=Qc({interactive:!1}),r=n.song?.id??"";r!==I.songId?(I.songId=r,I.cover=n.cover,I.lyricsText=n.lyrics.text,I.lyricIndex=n.lyrics.index,I.duration=s.duration,I.progressPlaying=s.playing,I.progressAt=Ni(),t.push({type:"song",song:n.song,cover:n.cover,covers:n.covers,coverIndex:n.coverIndex,lyrics:n.lyrics})):(n.cover!==I.cover&&(I.cover=n.cover,t.push({type:"media",cover:n.cover,covers:n.covers,coverIndex:n.coverIndex})),n.lyrics.text!==I.lyricsText&&(I.lyricsText=n.lyrics.text,I.lyricIndex=n.lyrics.index,t.push({type:"lyrics",lyrics:n.lyrics})));const o=JSON.stringify(a);o!==I.options&&(I.options=o,t.push({type:"options",options:a})),(s.playing!==I.playing||s.volume!==I.volume||s.muted!==I.muted)&&(I.playing=s.playing,I.volume=s.volume,I.muted=s.muted,t.push({type:"state",playing:s.playing,volume:s.volume,muted:s.muted}));const l=Ni(),c=vd(l,s.playing);return c&&t.push(c),(s.position!==I.position||n.lyrics.index!==I.lyricIndex||s.duration!==I.duration||s.playing!==I.progressPlaying)&&(I.position=s.position,I.lyricIndex=n.lyrics.index,I.duration=s.duration,I.progressPlaying=s.playing,I.progressAt=l,t.push({type:"progress",position:s.position,duration:s.duration,playing:s.playing,lyricIndex:n.lyrics.index})),t}function Ni(){return typeof performance<"u"&&performance.now?performance.now():Date.now()}const hd=40,md=32;let Yt=0,Xt=!1;function gd(){const t=i.pvMode||i.config.playerViewMode||"";try{const e=Sn(t).skin?.spectrum;if(!e)return 0;const n=Number(e);return!Number.isFinite(n)||n<=0?md:Math.max(1,Math.min(256,Math.round(n)))}catch{return 0}}function vd(t,e){const n=En()&&e===!0?gd():0;if(!n)return Yt=0,Xt?(Xt=!1,{type:"spectrum",bands:null}):null;if(Yt&&t-Yt<hd)return null;const s=Ya(n);return s?(Yt=t,Xt=!0,{type:"spectrum",bands:Array.from(s,a=>Math.round(a*100)/100)}):Xt?(Yt=0,Xt=!1,{type:"spectrum",bands:null}):null}function Oa(){if(En()){if(!S()){const t=Wc();$s({text:t.text,playing:Hr().playing});return}for(const t of fd())y.updateDesktopWallpaper(t).catch(e=>{console.warn("[desktop-wallpaper] 同步背景歌词失败",e?.message??e)})}}function bd(){const t=_d(),e=i.pvMode||i.config.playerViewMode||"",n=document.documentElement.dataset.theme||"",s=document.documentElement.dataset.mode||"dark",a=document.documentElement.dataset.density||"";return{skinId:e,theme:n,mode:s,density:a,tokens:t.values,signature:[e,n,s,a,t.signature].join("|")}}function yd(){const t=i.config||{};return[document.documentElement.dataset.theme||"",document.documentElement.dataset.mode||"",document.documentElement.dataset.density||"",t.glassBlurCustom?t.glassBlur:"",t.glassAlphaCustom?t.glassAlpha:"",t.accentFromCover?1:0,t.coverSeed||"",t.coverSeed2||"",t.animations===!1?0:1,t.animationsSpeed||"",t.lyricsFontSize,t.listDensity||""].join("|")}let Bi="\0",Fi={};function _d(){const t=yd();return t!==Bi&&(Bi=t,Fi=wd()),{signature:t,values:Fi}}function wd(){const t=new Set(Object.keys(sl()));for(const s of document.styleSheets){let a=null;try{a=s.cssRules}catch{continue}Xr(a,t,0)}const e=getComputedStyle(document.documentElement),n={};for(const s of t){const a=e.getPropertyValue(s).trim();!a||/[;{}]/.test(a)||(n[s]=a)}return n}function Xr(t,e,n){if(!(!t||n>3))for(const s of t){if(s.style)for(const a of s.style)a.startsWith("--")&&e.add(a);s.cssRules&&Xr(s.cssRules,e,n+1)}}const G=Object.freeze({off:"off",lyrics:"lyrics",wallpaper:"wallpaper"});function $d(){return i.config.showDesktopWallpaper===!0?G.wallpaper:i.config.showDesktopLyrics===!0?G.lyrics:G.off}async function Qr(t){const e=kd(t),n=$d();if(e===n)return{ok:!0,mode:e,unchanged:!0};const s=await zi(e);return s?.ok!==!1?{ok:!0,...s,mode:e}:n!==G.off&&(await zi(n))?.ok!==!1?{ok:!1,...s,mode:n,restored:!0}:{ok:!1,...s,mode:G.off}}async function zi(t){return t!==G.lyrics&&await Oi(!1),t!==G.wallpaper&&await Ri(!1),t===G.lyrics?Oi(!0):t===G.wallpaper?Ri(!0):{ok:!0}}function kd(t){return t===G.lyrics?G.lyrics:t===G.wallpaper?G.wallpaper:G.off}const Sd=[{value:"next",label:"加入下一首播放"},{value:"play",label:"立即播放"},{value:"append",label:"加入列表末尾"}],xd=[{value:"compact",label:"紧凑"},{value:"cozy",label:"标准"},{value:"roomy",label:"宽松"}],Cd=[{value:"fast",label:"快速 0.2s"},{value:"medium",label:"适中 0.35s"},{value:"slow",label:"缓慢 0.5s"}],Td={embedded:"内嵌歌词","lrc-file":"同目录 .lrc",cache:"歌词缓存",online:"在线自动匹配"};function Ed(){const e=(Array.isArray(i.config.lyricsSources)?i.config.lyricsSources:[]).map(n=>Td[n]||n);return e.length?e.join(" → "):"（未配置）"}function ti(){const t=i.coverCache;if(!t)return"正在读取…";const e=((t.bytes||0)/1024/1024).toFixed(1);return`已缓存 ${A(t.covers||0)} 张封面、${A(t.lyrics||0)} 份歌词，共 ${e} MB`}function Jr(){const t=i.coverCache||{};return(Number(t.covers)||0)+(Number(t.lyrics)||0)}function Id(){const t="默认关闭：封面与歌词都只放在缓存目录里。开启后下载 / 更换封面时会把它们写进文件标签，这样把文件拷到别的播放器上也能看到封面与歌词（m4a / flac 支持，mp3 等格式会明确跳过）";return i.coverCache?Jr()===0?`${t}。当前缓存里还没有封面或歌词可写`:`${t}。缓存里已经有 ${ti()}`:t}function Dd(){return`上面那个开关只对「之后」下载 / 更换的封面生效。缓存里已经存着的封面与歌词（${ti()}）可以用这个按钮一次性写进歌曲文件；mp3 / wav 等暂不支持写标签的格式会被跳过，不会动你的文件。`}function Ui(){const t=bs(),e=[];for(const s of t)for(const a of s.swatch||[])e.includes(a)||e.push(a);const n=e.map((s,a)=>`[data-swatch="${a}"]{background:${s}}`).join(`
`);return Fa("swatch-styles",n),s=>(s.swatch||[]).map(a=>e.indexOf(a))}function Ad(t){if(!t?.dir)return`（浏览器预览模式读不到本机目录，以下是源码仓库里的参考文件）
...
【风格要求 · 由使用者自行填写（本行只是占位，本提示词不提供任何风格建议）】
`}function Zr({copyKey:t,importKind:e,importLabel:n}){return p`
    ...
    ${Zr({copyKey:"skin",importKind:"skin",importLabel:"导入样式包…"})}
    <div class="setting__hint">接口的唯一定义在 frontend/packages/player-skins/src/contract.js；样式目录里也有现成的 _template 示例可以直接复制改名。</div>`,{root:n}=ee({title:"用 AI 创建播放界面样式",body:e,okText:"知道了",cancelText:"关闭",onOk:()=>!0});eo(n,t)}function Fd(t={}){const e=p`
    <div class="setting__hint setting__hint--steps">
    ...
    ${Zr({copyKey:"theme",importKind:"theme",importLabel:"导入主题…"})}
    <div class="setting__hint setting__hint--steps">
    ...
    </div>`,{root:n}=ee({title:"添加自定义主题",body:e,okText:"知道了",cancelText:"关闭",onOk:()=>!0});eo(n,t)}async function zd(t,e,n){if(!S()){u("浏览器预览模式下不能移除，请手动删除主题文件",{tone:"warning",duration:3600});return}const s=u("正在移除主题…",{duration:0});try{const a=await ml(t);if(s.close(),!a.removed){u(`没有移除「${e}」`,{tone:"warning"});return}await Ie(i.config),n.commit?.(),n.render?.(),u(`已移除主题「${e}」`,{tone:"success"})}catch(a){s.close(),u(`移除失败：${a?.message??a}`,{tone:"error",duration:6e3})}}function Ud(t,e){const n=t.dataset.id,s=t.dataset.name||n;ee({title:`移除主题「${s}」？`,desc:"会删掉主题目录里对应的那个 CSS 文件。内置主题由程序在每次启动时重新生成，所以不提供移除。",okText:"移除",danger:!0,onOk:async()=>(await zd(n,s,e),!0)})}async function jd(t,e,n){if(!S()){u("浏览器预览模式下不能移除，请手动删除样式目录",{tone:"warning",duration:3600});return}const s=u("正在移除样式…",{duration:0});try{const a=await Kc(t);if(s.close(),!a.removed){u(`没有移除「${e}」`,{tone:"warning"});return}n.commit?.(),n.render?.(),u(`已移除样式「${e}」`,{tone:"success"})}catch(a){s.close(),u(`移除失败：${a?.message??a}`,{tone:"error",duration:6e3})}}function Wd(t,e){const n=t.dataset.id,s=t.dataset.name||n;ee({title:`移除样式「${s}」？`,desc:"会把样式目录里对应的整个文件夹删掉（里面只有这个样式的文件，不含歌曲）。",okText:"移除",danger:!0,onOk:async()=>(await jd(n,s,e),!0)})}async function gs(t,e={}){const n=t.dataset.act,s=t.dataset.id;switch(n){case"reset-desktop-lyrics-pos":{if(!S()){u("浏览器预览模式下没有独立歌词窗口",{duration:2200});return}try{const a=await y.resetDesktopLyricsPosition();a&&a.applied===!1?u("已清掉位置记忆；下次打开桌面歌词会用默认位置",{tone:"success",duration:2600}):u("桌面歌词已移回默认位置",{tone:"success",duration:2e3})}catch(a){u(`重置失败：${a?.message??a}`,{tone:"error",duration:5e3})}return}case"ai-field":{const a=t.dataset.key;if(!a)return;i.config[a]=t.value,e.commit?.();return}case"add-folder":{if(S()){let r=null;try{r=await y.addFolder("")}catch(o){u(`系统目录选择器不可用：${o?.message??o}`,{tone:"warning",duration:5e3}),r=null}if(r===null){const o=await Hi({manual:!0});if(!o)return;try{r=await y.addFolder(o)}catch(l){u(`添加失败：${l?.message??l}`,{tone:"error",duration:6e3});return}}if(r?.cancelled)return;if(r?.duplicated){u(`该文件夹已在曲库中：${r.path}`,{tone:"warning"});return}r?.folder?(i.folders=[...i.folders.filter(o=>o.id!==r.folder.id),r.folder],e.commit?.(),u(`已添加并开始扫描：${r.folder.path}`,{tone:"success"})):u("添加文件夹失败：后端没有返回结果",{tone:"error",duration:6e3});return}const a=await Hi();if(!a)return;i.folders.push({id:wt("folder"),path:a,trackCount:0,status:"ok",watching:i.config.watchFolders,addedAt:Date.now()}),e.commit?.(),u(`已添加文件夹：${a}`,{tone:"success"}),e.rescan?.();break}case"remove-folder":{const a=i.folders.find(r=>r.id===s);if(!a)return;ee({title:"移除音乐文件夹？",desc:`${a.path}
仅从曲库中移除，不会删除任何本地文件。`,okText:"移除",danger:!0,onOk:async()=>(S()&&await y.removeFolder(s),i.folders=i.folders.filter(r=>r.id!==s),e.commit?.(),u("已移除文件夹"),e.rescan?.({manual:!1}),!0)});break}case"scan-now":e.rescan?.({manual:!0});break;case"rescan-folder":u("正在重新扫描该文件夹…"),e.rescan?.({manual:!0});break;case"rule-add":i.filterRules.push({id:wt("rule"),type:"regex",op:"match",value:"",scope:"exclude",enabled:!0}),e.commit?.();break;case"rule-del":i.filterRules=i.filterRules.filter(a=>a.id!==s),e.commit?.(),e.refreshRules?.();break;case"rule-toggle":{const a=i.filterRules.find(r=>r.id===s);a&&(a.enabled=!a.enabled),e.commit?.(),e.refreshRules?.();break}case"rule-scope":{const a=i.filterRules.find(r=>r.id===s);a&&(a.scope=t.dataset.scope),e.commit?.(),e.refreshRules?.();break}case"preset-small":i.filterRules.push({id:wt("rule"),type:"size",op:"lt",value:"10240",unit:"B",scope:"exclude",enabled:!0}),e.commit?.(),e.refreshRules?.(),u("已添加：排除小于 10KB 的文件",{tone:"success"});break;case"preset-mp4":i.filterRules.push({id:wt("rule"),type:"regex",op:"match",value:"\\.mp4$",scope:"exclude",enabled:!0}),e.commit?.(),e.refreshRules?.(),u("已添加：排除 .mp4 文件",{tone:"success"});break;case"theme-pick":{const r=bs().find(o=>o.id===s);if(!r)return;i.config.theme=r.id,i.config.themeMode=r.mode,await Ie(i.config),e.commit?.(),e.render?.(),u(`已切换到主题「${r.name}」`,{tone:"success",duration:1600});break}case"open-theme-dir":{if(!S()){u("主题目录：frontend/src/styles/themes/",{duration:3200});break}try{const a=await y.themeDir();await y.revealThemeDir(),u(a?`已打开主题目录：${a}`:"已打开主题目录",{duration:3200})}catch(a){u(`打开主题目录失败：${a?.message??a}`,{tone:"error",duration:5e3})}break}case"theme-help":Fd(e);break;case"theme-remove":Ud(t,e);break;case"reload-themes":if(S()){const a=await y.reloadThemes();await ys(),await Ie(i.config),e.commit?.(),u(`已重新扫描到 ${a?.length??0} 个主题`,{tone:"success"})}else u("浏览器预览模式下仅内置主题可用",{tone:"warning"});break;case"clear-cache":u("缓存清理需在后端实现（当前仅保存元数据缓存文件）",{tone:"warning"});break;case"skin-pick":{const a=ms().find(r=>r.id===s);if(!a)return;wn(a.id),e.commit?.(),e.render?.(),u(`播放界面已切换到「${a.name}」`,{tone:"success",duration:1600});break}case"open-skin-dir":{if(!S()){u("样式目录：frontend/packages/player-skins/",{duration:3200});break}try{const a=await y.skinDir();await y.revealSkinDir(),u(a?`已打开样式目录：${a}`:"已打开样式目录",{duration:3200})}catch(a){u(`打开样式目录失败：${a?.message??a}`,{tone:"error",duration:5e3})}break}case"reload-skins":try{S()&&await y.reloadSkins(),await Ja(),wn(i.pvMode||i.config.playerViewMode||""),e.render?.();const a=ms().length,r=Ur();u(r.length?`已扫描到 ${a} 个样式，${r.length} 个加载失败`:`已扫描到 ${a} 个样式`,{tone:r.length?"warning":"success"})}catch(a){u(`重新扫描失败：${a?.message??a}`,{tone:"error"})}break;case"skin-help":Bd(e);break;case"skin-remove":Wd(t,e);break;case"ai-vendor":{const a=String(t.value||"auto");if(a===(i.config.aiVendor||"auto"))break;i.config.aiVendor=a,e.commit?.(),e.render?.();const r=Lr(a);u(`模型类型已设为「${wc(a)}」${r?"："+r:""}`,{duration:3600});break}case"backdrop-mode":{const a=qr.includes(t.value)?t.value:"off";if(a===(i.config.nativeBackdrop||"off"))break;i.config.nativeBackdrop=a,e.commit?.(),e.render?.(),u(a==="off"?"已关闭窗口原生材质，重启应用后生效":`已选择「${Jn(a)}」，重启应用后生效`,{tone:"success",duration:3200});break}case"backdrop-restart":{if(!S()){u("浏览器预览无法重启应用",{tone:"warning"});break}u("正在重启应用…",{duration:2e3});try{await y.restartApp()}catch(a){u(`重启失败：${a?.message??a}`,{tone:"error",duration:6e3})}break}case"loudness-measure-all":{if(!S()){u("响度测量需要后端支持，浏览器预览不可用",{tone:"warning"});return}const a=document.querySelector("#loudness-progress");a&&(a.hidden=!1);try{const r=await y.loudnessMeasureAll(i.config.loudnessTarget??-16);if(!r?.started){u(r?.reason==="already-measuring"?"已在测量中":`无法开始测量：${r?.reason??"未知原因"}`,{tone:"warning"}),a&&(a.hidden=!0);return}u(`开始预热 ${r.total} 首歌曲的响度（可选操作，不预热也会在播放时按需计算）…`,{duration:3e3})}catch(r){a&&(a.hidden=!0),u(`无法开始测量：${r?.message??r}`,{tone:"error",duration:6e3})}break}case"loudness-cancel":S()&&(await y.loudnessCancel(),u("已请求停止测量"));break;case"loudness-refresh":{if(!S())return;await ws();const a=await un();e.commit?.(),u(`已重新拉取补偿（已测量 ${a?.measured??0} 首）`,{tone:"success"});break}case"loudness-clear":{if(!S())return;ee({title:"清除响度测量数据？",desc:"只会删除测量缓存，不会动你的音乐文件。清除后再次启用响度均衡会重新测量。",okText:"清除",danger:!0,onOk:async()=>(await y.loudnessClear(),i.loudnessGains={},await un(),e.commit?.(),e.render?.(),u("已清除响度测量数据",{tone:"success"}),!0)});break}case"loudness-target":{const a=Number(t.value),r=i.config.loudnessTarget;if(a===r)break;i.config.loudnessTarget=a,e.commit?.(),await Lc(),await un(),e.render?.(),u(`目标响度已设为 ${a} LUFS，旧补偿已失效，将按新标准重算`,{tone:"success",duration:3200});break}case"download-dir-pick":{if(!S()){u("浏览器预览无法调用系统目录选择器",{tone:"warning"});break}try{const a=await y.downloadPickDir();if(a?.cancelled)break;await ji(a,e)}catch(a){u(`无法更改下载位置：${a?.message??a}`,{tone:"error",duration:6e3})}break}case"download-dir-open":{if(!S())break;try{await y.downloadOpenDir(i.config.downloadDir||"")}catch(a){u(`打开失败：${a?.message??a}`,{tone:"error",duration:5e3})}break}case"download-dir-reset":{if(!S())break;try{const a=await y.downloadSetDir("");if(a?.cancelled)break;const r=a?.next?a:await y.downloadSetDir("");await ji(r,e)}catch(a){u(`恢复默认失败：${a?.message??a}`,{tone:"error",duration:6e3})}break}case"cache-open-covers":case"cache-open-lyrics":{if(!S())break;try{await y.coverOpenCacheDir(n==="cache-open-covers"?"covers":"lyrics")}catch(a){u(`打开缓存目录失败：${a?.message??a}`,{tone:"error",duration:5e3})}break}case"cover-refresh":{if(!S())break;try{const a=await y.coverClearCache();i.coverCache=await y.coverCacheStats(),await no(),e.commit?.(),e.render?.(),u(`已清空缓存（封面 ${a?.covers??0} 张、歌词 ${a?.lyrics??0} 份）`,{tone:"success"})}catch(a){u(`清空失败：${a?.message??a}`,{tone:"error",duration:5e3})}break}case"embed-cache-write":await to({ctx:e,force:!0});break}}async function to({ctx:t={},force:e=!1}={}){if(!S()){e&&u("写入歌曲文件需要后端支持，浏览器预览不可用",{tone:"warning"});return}for(let a=0;a<20&&!i.coverCache;a++)await new Promise(r=>setTimeout(r,100));if(!i.coverCache&&e)try{i.coverCache=await y.coverCacheStats()}catch{}if(Jr()===0){e?u(i.coverCache?"缓存里还没有封面或歌词，暂时没有可写入的内容":"暂时读不到缓存统计，请稍后再试",{duration:3400}):i.coverCache&&u("已开启：以后下载 / 更换封面时会把封面与歌词写进歌曲文件",{duration:3600});return}const n=Number(i.coverCache?.covers)||0,s=Number(i.coverCache?.lyrics)||0;ee({title:"要把已有的缓存写进歌曲文件吗？",body:p`
    ...
    <div class="setting__hint">不迁移的话，旧目录里的歌曲会留在原地；新目录会成为新的默认保存位置。</div>`;ee({title:"更改下载位置",body:o,okText:"迁移并更改",cancelText:"不迁移，只更改位置",onOk:async()=>(await ta(n,!0,e),!0),onCancel:async()=>{await ta(n,!1,e)}})}async function ta(t,e,n){try{const s=await y.downloadApplyDir(t,e);if(s?.dir&&(i.config.downloadDir=s.dir),n.commit?.(),n.render?.(),!e){u(`下载位置已改为：${s?.dir||t}`,{tone:"success",duration:3200});return}const a=Number(s?.migrated)||0,r=Number(s?.skipped)||0,o=Array.isArray(s?.failed)?s.failed:[];let l=`已迁移 ${A(a)} 首`;r&&(l+=`，跳过 ${A(r)} 首（新目录已有同名文件）`),o.length&&(l+=`，${A(o.length)} 首失败`),u(`${l}；新位置：${s?.dir||t}`,{tone:o.length?"warning":"success",duration:4200})}catch(s){u(`更改下载位置失败：${s?.message??s}`,{tone:"error",duration:6e3})}}async function no(){if(!S())return i.coverProviders=[],i.coverBreaker={},null;try{const t=await y.coverProviders();return i.coverProviders=Array.isArray(t?.providers)?t.providers:[],i.coverBreaker=t?.breaker&&typeof t.breaker=="object"?t.breaker:{},t}catch{return i.coverProviders=[],i.coverBreaker={},null}}let Wi=!1;function Vd(){if(Wi)return;Wi=!0;const t=S()?y.coverCacheStats().then(e=>(i.coverCache=e,e)).catch(()=>null):Promise.resolve(null);Promise.all([no(),t]).then(()=>{he()})}function Hi({manual:t=!1}={}){return new Promise(e=>{ee({title:"添加音乐文件夹",desc:t?"系统目录选择器没能打开，请直接粘贴文件夹完整路径。":"浏览器预览模式下无法调用系统目录选择器，请手动输入路径。",body:p`<input class="input" data-field="path" type="text" placeholder="C:\\Users\\Example\\Music" />`,okText:"添加",onOk:n=>{const s=String(n.path||"").trim();return s?(e(s),!0):"请输入路径"}})})}function Kd(t,e={}){const n=t.dataset.toggle;if(n){const a=t.getAttribute("aria-checked")!=="true";return n==="showDesktopLyrics"||n==="showDesktopWallpaper"?(Qr(n==="showDesktopLyrics"?a?"lyrics":"off":a?"wallpaper":"off").then(o=>{o.ok===!1&&u(`打不开：${o.reason||o.error||"未知原因"}`,{tone:"warning",duration:3200}),e.commit?.()}),e.commit?.(),!0):(t.setAttribute("aria-checked",String(a)),n in i.config&&(i.config[n]=a,n==="animations"&&lt("--dur",fa(i.config)),n==="minimizeToTray"&&S()&&y.minimizeToTray(a).catch(r=>{console.warn("[settings] 同步托盘开关失败",r)}),n==="watchFolders"&&(i.folders.forEach(r=>r.watching=a),S()&&y.setWatchers(a).catch(r=>{console.warn("[settings] 切换实时监听失败",r)}))),e.commit?.(),n==="embedMeta"&&a&&to(),!0)}const s=t.closest("[data-segment]")?.dataset.segment;if(s){const a=t.dataset.value;if(t.parentElement.querySelectorAll(".segmented__btn").forEach(r=>{r.setAttribute("aria-pressed",String(r===t))}),s==="themeMode"){i.config.themeMode=a;const r=bs(),o=window.matchMedia("(prefers-color-scheme: dark)").matches,l=a==="system"?o?"dark":"light":a,c=r.find(d=>d.mode===l&&d.id!=="cover-dark")||r[0];i.config.theme=c.id,Ie(i.config)}else if(s in i.config){const r=["lyricsLines","scanConcurrency"];i.config[s]=r.includes(s)?Number(a):a,s==="lyricsLines"&&lt("--lyric-pad",`${50-Number(a)*4}%`),s==="animationsSpeed"&&lt("--dur",fa(i.config)),s==="loudnessMode"&&ws()}return e.commit?.(),!0}return!1}function Gd(t,{silent:e=!1}={}){const n=t?.dataset?.id;if(!n)return;const s=i.config.rowClickAction||"next";if(s==="play"){const a=i.visibleSongs.map(r=>r.id);ut(a,Number(t.dataset.index),mn());return}if(s==="append"){ar([n]),e||u("已加入播放列表末尾",{tone:"success",duration:1500});return}ir(n),e||u("已设为下一首播放",{tone:"success",duration:1500})}const na=[{id:"album",label:"专辑",icon:"album",isOn:()=>i.config.showAlbumColumn!==!1,set:t=>{i.config.showAlbumColumn=t}}];function Yd(t,e){const n=[{kind:"label",label:"显示的列"}];for(const s of na)n.push({id:`col-${s.id}`,label:s.label,icon:s.icon,checked:s.isOn()});n.push({kind:"sep"}),n.push({id:"col-reset",label:"恢复默认列",icon:"refresh"}),vn({x:t,y:e,items:n,onPick:s=>{if(s==="col-reset"){for(const o of na)o.set(!0);x(),u("已恢复默认列",{duration:1400});return}const a=na.find(o=>`col-${o.id}`===s);if(!a)return;const r=!a.isOn();a.set(r),x(),u(r?`已显示「${a.label}」列`:`已隐藏「${a.label}」列`,{duration:1400})}})}function Vi(t,e,n=null){const s=Ge(e);if(!s)return;const a=!!s.online,r=Ot(e),o=i.queue.includes(e),l=[{id:"play",label:"播放",icon:"play"},{id:"play-next",label:"下一首播放",icon:"arrow-right"},{id:"sep1",kind:"sep"},{id:"queue-add",label:o?"从播放列表移除":"加入播放列表",icon:"queue"},{id:"like",label:r?"取消喜欢":"加入我喜欢",icon:"heart"},{id:"add-to",label:"加入歌单…",icon:"plus"}];if(a||l.push({id:"cover",label:"更换封面…",icon:"image"}),i.view==="queue")l.push({id:"sep2",kind:"sep"}),l.push({id:"remove-here",label:"从播放列表移除",icon:"trash",danger:!0});else if(i.view==="playlist"&&i.playlistId){const d=Re(i.playlistId);d&&!d.locked&&(l.push({id:"sep2",kind:"sep"}),l.push({id:"remove-here",label:`从「${d.name}」移除`,icon:"trash",danger:!0}))}a||(l.push({id:"sep3",kind:"sep"}),l.push({id:"reveal",label:"在文件夹中显示",icon:"folder"}));const c=d=>{switch(d){case"play":{const m=i.visibleSongs.map(g=>g.id),h=m.indexOf(e);h<0?ut([e],0,{type:"online",id:null}):ut(m,h,mn());break}case"cover":pt(()=>Promise.resolve().then(()=>si),void 0).then(m=>m.openCoverPanel(e));break;case"play-next":ir(e),u("已设为下一首播放",{tone:"success",duration:1500});break;case"queue-add":o?(la(e),u("已从播放列表移除")):(ar([e]),u("已加入播放列表",{tone:"success",duration:1500}));break;case"like":vs(e),u(r?"已从「我喜欢」移除":"已加入「我喜欢」",{tone:r?"info":"success",duration:1500});break;case"add-to":Xd(e);break;case"remove-here":i.view==="queue"?(la(e),u("已从播放列表移除")):i.playlistId&&(rr(i.playlistId,[e]),u("已从歌单移除"));break;case"reveal":pt(()=>import("./bridge-CJD-9QGY.js").then(m=>m.v),[]).then(m=>{m.backend.revealInExplorer(s.path),u("已在文件夹中定位（需接入后端）",{duration:1800})});break}};if(n)vn({x:n.x,y:n.y,items:l,onPick:c});else{const d=t.getBoundingClientRect();vn({x:d.left,y:d.bottom+6,items:l,onPick:c,align:"right"})}}function Xd(t){const e=i.playlists,{root:n}=ee({title:"加入歌单",body:p`
      <div class="setting__hint">点击歌单即可把这首歌加进去。</div>
      <div class="u-row u-wrap">
        ${e.map(s=>p`
            <button class="btn btn--sm" type="button" data-pl=${s.id}>
              <svg aria-hidden="true"><use href="#i-${s.id===Wn?"heart":"playlist"}"></use></svg>
              <span>${s.name}</span>
            </button>`)}
      </div>
    `,okText:"完成",cancelText:"关闭",onOk:()=>!0});n.addEventListener("click",s=>{const a=s.target.closest("[data-pl]");a&&ds(a.dataset.pl,[t])})}const Qd=1500;function Jd(t){t&&(t.classList.remove("is-located"),t.offsetWidth,t.classList.add("is-located"),window.setTimeout(()=>t.classList.remove("is-located"),Qd))}function so(t){if(t){try{t.scrollIntoView({block:"nearest",inline:"nearest"})}catch{Zd(t)}Jd(t)}}function Zd(t){const e=t.closest(".content-body, .queue-panel__body");if(!e)return;const n=t.getBoundingClientRect(),s=e.getBoundingClientRect(),a=e.classList.contains("content-body")?50:8,r=s.top+a;n.top<r?e.scrollTop-=r-n.top:n.bottom>s.bottom&&(e.scrollTop+=n.bottom-s.bottom)}function eu(t){const e=i.currentId;if(!e)return null;const n=t.querySelector(`.track[data-id="${CSS.escape(e)}"]`);return n?{el:n}:null}function tu(){const t=i.currentId;return t&&document.querySelector("#queue-panel-body")?.querySelector(`.queue-item[data-queue-id="${CSS.escape(t)}"]`)||null}function nu({notify:t=!0}={}){if(!i.currentId)return t&&u("当前没有正在播放的歌曲",{tone:"info",duration:1600}),!1;const e=document.getElementById("content-body"),n=e?eu(e):null;return n?(so(n.el),!0):(t&&u("当前播放的歌曲不在这个列表里",{tone:"info",duration:2200}),!1)}function ao({notify:t=!0}={}){if(!i.queue.length)return t&&u("播放列表是空的",{tone:"info",duration:1600}),!1;const e=tu();return e?(so(e),!0):(t&&u("当前播放的歌曲不在播放列表里",{tone:"info",duration:2200}),!1)}let io=0;function ro(){io=Date.now()}function oo(){return Date.now()-io<260}function su(t=!1){const e=i.visibleSongs.map(n=>n.id);if(e.length){if(t)for(let n=e.length-1;n>0;n-=1){const s=Math.floor(Math.random()*(n+1));[e[n],e[s]]=[e[s],e[n]]}ut(e,0,mn()),u(t?"已随机播放":`开始播放 ${A(e.length)} 首`,{duration:1600})}}const au={library:"本地歌曲",queue:"播放列表",playlist:"歌单"},Ki={commit:x,rescan:()=>yn({manual:!0})};class iu extends me{static deps=e=>[e.view,e.playlistId,e.playlistVersion,e.query,e.visibleVersion,e.visibleSongs.length,e.sortKey,e.sortDir,e.songs.length,e.folders.length,e.scanning,e.playlistSelecting,e.selectedIds,e.lastScan?.at??0,e.config.listDensity];render(){const e=i.view,n=e==="playlist"?Re(i.playlistId):null;return p`
    ...
    `}async onHeaderClick(e){const n=e.target.closest("[data-empty-act]")?.dataset.emptyAct;if(n){n==="add-folder"?await gs({dataset:{act:"add-folder"}},Ki):n==="goto-library"?Ct("library"):n==="clear-search"&&Ps();return}const s=e.target.closest("[data-tool]")?.dataset.tool;s&&await this.handleTool(s)}onHeaderChange(e){e.target.id==="select-sort"&&(i.sortKey=e.target.value,x())}async handleTool(e){switch(e){case"rescan":yn({manual:!0});break;case"add-folder":await gs({dataset:{act:"add-folder"}},Ki);break;case"play-all":su(!1);break;case"locate":nu();break;case"queue-clear":or(),u("播放列表已清空");break;case"pl-select":ri(!i.playlistSelecting);break;case"pl-add":i.playlistId&&vc(i.playlistId);break;case"sel-all":{const n=i.visibleSongs.length>0&&i.visibleSongs.every(s=>i.selectedIds.has(s.id));qo(n?[]:i.visibleSongs.map(s=>s.id));break}case"sel-remove":{const n=[...i.selectedIds];if(!n.length)break;const s=Re(i.playlistId),a=rr(i.playlistId,n);ri(!1),u(`已从「${s?.name??"歌单"}」移除 ${A(a)} 首`,{tone:"success"});break}case"pl-more":Sa(i.playlistId,this.querySelector('#content-header [data-tool="pl-more"]'));break}}}te("mp-content",iu);const ru=Na(class extends Ba{render(){return bt}update(t,[e]){const n=t.element;if(!n)return bt;dl(n);const s=e||Ke;if(n.getAttribute("src")===s)return bt;if(s.startsWith("data:"))return n.src=s,bt;n.__coverWant=s;const a=new Image;a.decoding="async";const r=()=>{n.__coverWant===s&&(n.src=s)};return a.addEventListener("load",r),a.addEventListener("error",r),a.src=s,bt}}),ni=t=>ru(t);class ou extends me{static deps=e=>[e.view,e.playlistId,e.visibleVersion,e.sortKey,e.sortDir,e.config.listDensity,e.config.showAlbumColumn,e.playlistSelecting,e.selectedIds,e.currentId,e.playing,e.likedIds,kn(),e.visibleSongs.length];get mode(){return i.view==="queue"?"playlist":"library"}get selecting(){return i.view==="playlist"&&i.playlistSelecting}updated(){i.view==="queue"?this.bindQueueSort():this._sortable&&(this._sortable.destroy(),this._sortable=null)}disconnectedCallback(){this._sortable?.destroy(),this._sortable=null,super.disconnectedCallback()}bindQueueSort(){const e=this.querySelector(".tracks__body");e&&(this._sortable&&this._sortable.el===e||(this._sortable?.destroy(),this._sortable=T.create(e,{handle:"[data-handle]",draggable:".track",animation:0,ghostClass:"is-dragging",chosenClass:"is-dragging",onEnd:n=>{ro();const s=n.oldIndex,a=n.newIndex;if(s==null||a==null||s===a)return;const r=n.from,o=Array.from(r.children).filter(l=>l!==n.item);r.insertBefore(n.item,o[s]??null),lr(s,a),u("已调整播放顺序 · 播放模式已切回列表循环",{duration:1800})}})))}render(){const e=this.mode,n=i.visibleSongs;return p`
    ...
    `}rowTemplate(e,n,s){const a=this.selecting,r=e.id===i.currentId,o=Ot(e.id),l=a&&i.selectedIds.has(e.id);return p`
      <div
        class="track"
        data-id=${e.id}
        data-index=${n}
      ...
      >
        ...
        <div class="track__cover">
          <img src=${ni(ht(e))} alt="" loading="lazy" draggable="false" />
        </div>
        ...
        <div class="track__time">${xt(e.duration)}</div>
        <button
          class="track__heart"
          type="button"
          data-act="like"
    ...
    `}onClick(e){if(oo())return;const n=e.target.closest(".track");if(n&&i.view==="playlist"&&i.playlistSelecting){e.preventDefault(),Ro(n.dataset.id);return}const s=e.target.closest("[data-sort]");if(s){const l=s.dataset.sort;i.sortKey===l?i.sortDir=i.sortDir==="asc"?"desc":"asc":(i.sortKey=l,i.sortDir=l==="addedAt"?"desc":"asc"),x();return}const a=e.target.closest("[data-act]");if(!a){const l=e.target.closest(".track");l&&Gd(l,{silent:!1});return}const r=a.closest(".track"),o=r?.dataset.id;if(o)switch(a.dataset.act){case"play":{const l=i.visibleSongs.map(c=>c.id);ut(l,Number(r.dataset.index),mn());break}case"like":{vs(o);const l=Ot(o);u(l?"已加入「我喜欢」":"已从「我喜欢」移除",{tone:l?"success":"info",duration:1500});break}case"more":Vi(a,o);break}}onDblClick(e){if(i.view==="playlist"&&i.playlistSelecting)return;const n=e.target.closest(".track");if(!n)return;const s=i.visibleSongs.map(a=>a.id);ut(s,Number(n.dataset.index),mn()),i.playerOpen=!0,i.pvMode=i.config.playerViewMode,x()}onContextMenu(e){if(e.target.closest(".tracks__head")){e.preventDefault(),Yd(e.clientX,e.clientY);return}const s=e.target.closest(".track");s&&(e.preventDefault(),Vi(null,s.dataset.id,{x:e.clientX,y:e.clientY}))}}te("mp-track-table",ou);class lu extends me{static deps=e=>[e.playerOpen,e.pvMode,e.currentId,e.playing,e.position,e.duration,e.config.showLyrics,e.config.coverCarousel,e.config.coverCarouselInterval,kn(),Wr()];updated(){ad()}render(){const e=Mt(),s=this.coverList(e).length>1,a=i.config.coverCarousel===!0&&s,r=!e||!!e.online,o=ms();return p`
      <section
        class="playerview"
        id="playerview"
        hidden
    ...
    `}coverList(e){if(!e)return[];const n=i.coverSets.get(e.id)?.items;return Array.isArray(n)?n.filter(s=>s?.preview):[]}carouselTip(e,n){if(!e)return"这首歌只有一张封面";const s=Number(i.config.coverCarouselInterval)||10;return n?"关闭封面轮播":`开启封面轮播（每 ${s} 秒换一张）`}openCoverPanel(e){!e||e.online||pt(()=>Promise.resolve().then(()=>si),void 0).then(n=>n.openCoverPanel(e.id))}toggleCarousel(){i.config.coverCarousel=!i.config.coverCarousel,x(),u(i.config.coverCarousel?`已开启封面轮播（每 ${Number(i.config.coverCarouselInterval)||10} 秒换一张）`:"已关闭封面轮播",{duration:1600})}}te("mp-playerview",lu);function dt(t,e={}){const n=e.min??0,s=e.max??1,a=e.step??.001;let r=Ue(e.value??n,n,s),o=!1;const l=t.querySelector(".slider__fill"),c=t.querySelector(".slider__buffer"),d=t.querySelector(".slider__thumb"),m=t.querySelector(".slider__bubble");function h(){const w=s===n?0:(r-n)/(s-n)*100;l&&(l.style.width=`${w}%`),d&&(d.style.left=`${w}%`),m&&e.format&&(m.textContent=e.format(r)),t.setAttribute("aria-valuenow",String(Math.round(w)))}function g(w){const O=t.getBoundingClientRect();if(O.width<=0)return r;const C=Ue((w.clientX-O.left)/O.width,0,1),q=n+C*(s-n),ae=Math.round(q/a)*a;return Ue(Number(ae.toFixed(6)),n,s)}function _(w){if(!m)return;const O=t.getBoundingClientRect(),C=Ue(w.clientX-O.left,0,O.width);m.style.left=`${C}px`}t.addEventListener("pointerdown",w=>{t.dataset.disabled!=="true"&&(w.preventDefault(),o=!0,t.dataset.dragging="true",t.setPointerCapture?.(w.pointerId),r=g(w),h(),_(w),e.onChange?.(r))}),t.addEventListener("pointermove",w=>{_(w),o&&(r=g(w),h(),e.onChange?.(r))});const $=w=>{o&&(o=!1,t.dataset.dragging="false",t.releasePointerCapture?.(w.pointerId),e.onCommit?.(r))};return t.addEventListener("pointerup",$),t.addEventListener("pointercancel",$),t.addEventListener("keydown",w=>{if(t.dataset.disabled==="true")return;const O=(s-n)/10,C=a*10;let q=r;switch(w.key){case"ArrowRight":case"ArrowUp":q=r+C;break;case"ArrowLeft":case"ArrowDown":q=r-C;break;case"PageUp":q=r+O;break;case"PageDown":q=r-O;break;case"Home":q=n;break;case"End":q=s;break;default:return}w.preventDefault(),r=Ue(Number(q.toFixed(6)),n,s),h(),e.onChange?.(r),e.onCommit?.(r)}),h(),{get value(){return r},set(w,{silent:O=!1}={}){const C=Ue(w,n,s);C===r&&!O||(r=C,h(),O||e.onChange?.(r))},setDisabled(w){t.dataset.disabled=w?"true":"false"},setBuffer(w){c&&(c.style.width=`${Ue(w,0,100)}%`)},text(w=r){return e.format?e.format(w):String(w)},paint:h}}const cu="../bindings/musicplayer/index.js";let Bn=null;async function sa(){if(Bn)return Bn;try{const t=await import(cu);Bn=t&&t.OnlineService?t.OnlineService:null}catch(t){console.info("[online] backend unavailable",t)}return Bn}const du=new Set(["m4a","mp4","m4b","alac","aac","flac"]);let V="online";const v={songId:"",title:"",lines:[],cursor:0,undo:[],dirty:!1,kept:0,stale:!1};class uu extends me{static deps=e=>[e.lyricsOpen,e.currentId,e.position,e.playing,V,lo,i.config.embedMeta];constructor(){super(),this._draftText="",this._pendingText=null,this._nowIndex=-1,this._onlineMessage="",this._candidates=[],this._searching=!1,this._onlineKeyword="",this._draftTimer=null,this._lastNowPaint=0,this._lastScrolledNow=-1,this._lastScrolledCursor=-1,this._followHold=0,this._followAuto=!1,this._lastOnlineHint="在线歌词来源"}onConnected(){this._onKeyDownCapture=e=>this.onPanelKeyDown(e),document.addEventListener("keydown",this._onKeyDownCapture,!0)}onDisconnected(){document.removeEventListener("keydown",this._onKeyDownCapture,!0),this._draftTimer&&clearTimeout(this._draftTimer)}get open(){return i.lyricsOpen===!0}get panelEl(){return this.querySelector("#lyrics-panel")}updated(){const e=this.panelEl;if(e){if(e.hidden=!this.open,e.dataset.open=this.open?"true":"false",this._pendingText!==null){const n=this.querySelector("[data-editor-text]");n&&(n.value=this._pendingText),this._pendingText=null}this.open&&(V==="nudge"&&this.paintNudgeFollow(),V==="edit"&&this.paintNowRow())}}refreshAll(){this._refreshHeader(),fs().then(()=>{this._refreshHeader(),V==="online"&&this.refreshOnlineHint(),V==="edit"&&this.ensureDraft().then(()=>this.forceUpdate())})}_refreshHeader(){F()}render(){const e=ye(),n=e.song;return p`
      ...
      >
        <header class="lyricspanel__head">
          ...
          <button class="lyricspanel__close" type="button" data-act="close" aria-label="关闭" @click=${()=>Pa()}>${f("close")}</button>
        </header>
    ...
    `}noticeTemplate(e){const n=V==="nudge"||V==="edit",s=e.source==="embedded"||e.source==="lrc-file";if(!n||!s)return M;const a=Pi(e.source),r=mu(e.song),o=du.has(r);return p`
                      ...
                      <div class="candidate">
                        <div class="candidate__main">
                          ...
                          <div class="candidate__sub">
                            ${(e.provider||"")+" · score "+(e.score||0)+" · "+xt(e.duration)}
                          </div>
                        </div>
    ...
    `}nudgePane(e){const n=e.songId?At(e.songId):0,s=n<0?e.lines.filter(r=>r.time+n<0).length:0,a={lower:-1e4,upper:1e4};return p`
      <section class="lyricspanel__pane" data-pane="nudge" ?hidden=${V!=="nudge"}>
        ...
        <div class="nudge__block">
          ...
          <div class="nudge__feel">
            <button class="btn" type="button" data-act="nudge-feel" data-delta="500" @click=${()=>aa(500)}>
        ...
        <div class="nudge__block">
          ...
          <div class="nudge__steps">
            ${[-1e3,-500,-100,100,500,1e3].map(r=>p`<button class="btn btn--sm" type="button" data-act="nudge-step" data-delta=${r} @click=${()=>aa(r)}>${r>0?"+":"−"}${(Math.abs(r)/1e3).toFixed(1)}</button>`)}
          </div>
          <input
            class="nudge__range"
            type="range"
    ...
    `}nudgePreview(e,n){if(!e.text)return"这首歌还没有歌词。可以先用「在线匹配」找一份，或者切到「手动编辑」自己贴一份。";const s=e.lines,a=Xi(s,n),r=Math.max(0,a-5),o=Math.min(s.length,a+6),l=[];for(let c=r;c<o;c+=1){const d=s[c],m=Math.max(0,d.time+n);l.push(p`
        ...
        `)}return l}paintNudgeFollow(){if(V!=="nudge")return;const e=this.querySelector("[data-nudge-preview]");if(!e)return;const n=ye();if(!n.lines.length)return;const s=n.songId?At(n.songId):0,a=Xi(n.lines,s),r=e.querySelectorAll(".nudge__line");if(!r.length)return;const o=Number(r[0].dataset.index??-1);if(o<0)return;if(a<o||a>=o+r.length){F();return}const l=a-o;r.forEach((c,d)=>c.classList.toggle("is-active",d===l)),this.followScroll(e,r[l])}editPane(){const e=v.lines.filter(o=>typeof o.time=="number").length,n=uo(),s=v.lines.length-e,a=n?`草稿属于《${Ge(v.songId)?.title||"上一首"}》`:s>0&&e>0?`还有 ${s} 行没有时间`:"",r=n?"已切歌，草稿仍属于上一首":v.kept>0?`已沿用 ${v.kept} 行原有时间`:v.dirty?"未保存":"";return p`
      <section class="lyricspanel__pane" data-pane="edit" ?hidden=${V!=="edit"}>
        ...
        <div class="editor__transport">
          ...
          <button class="btn btn--sm" type="button" data-act="editor-back" @click=${()=>$t(Math.max(0,i.position-5e3))}>−5s</button>
          <button class="btn btn--sm" type="button" data-act="editor-fwd" @click=${()=>$t(i.position+5e3)}>+5s</button>
        ...
        <button class="editor__tap" type="button" data-act="editor-tap" @click=${()=>ia()}>
    ...
    `}draftList(){return v.lines.length?Ee(v.lines,(e,n)=>n,(e,n)=>{const s=typeof e.time=="number",a=["drow"];return n===v.cursor&&a.push("is-cursor"),s||a.push("is-untimed"),n===this._nowIndex&&a.push("is-now"),p`
          <div class=${a.join(" ")} data-act="editor-cursor" data-i=${n} @click=${()=>La(n)}>
        ...
        `}):p`<div class="editor__empty">还没有歌词文本。把歌词粘到上面的文本框里，或点「载入当前歌词」。</div>`}onClick(e){const n=e.target.closest("[data-act], [data-tab]");if(!n||!this.contains(n))return;const s=n.dataset.act,a=Number(n.dataset.i);switch(s){case"close":Pa();return;case"nudge-seek":$t(Number(n.dataset.ms));return;case"editor-cursor":La(a);return;case"editor-tap":ia();return}}onInput(e){const n=e.target;if(n.matches("[data-editor-text]")){this.scheduleDraftSettle();return}n.matches('[data-act="nudge-range"]')&&Qi(Number(n.value))}onPanelKeyDown(e){if(!this.open||V!=="edit"||e.key!==" "||e.ctrlKey||e.metaKey||e.altKey)return;const n=e.target;n&&(n.tagName==="TEXTAREA"||n.tagName==="INPUT")||this.contains(n)&&(e.preventDefault(),e.stopPropagation(),ia())}onFollowScroll(){this._followAuto||(this._followHold=Date.now()+4e3)}followScroll(e,n){if(!e||!n||Date.now()<this._followHold)return;const s=n.offsetTop-e.clientHeight/2+n.offsetHeight/2,a=Math.max(0,s);Math.abs(e.scrollTop-a)<2||(this._followAuto=!0,e.scrollTo({top:a,behavior:"smooth"}),setTimeout(()=>{this._followAuto=!1},120))}async refreshOnlineHint(){const e=await sa();if(e)try{const n=await e.LyricsProviders?.(),s=Array.isArray(n?.providers)?n.providers:[];s.length&&(this._lastOnlineHint="在线歌词来源："+s.join(" / "),F())}catch{}}async searchLyrics(){const e=(this._onlineKeyword||"").trim();if(!e){u("请输入歌词搜索关键词",{duration:1500});return}const n=await sa();if(!n){u("在线歌词后端未就绪",{tone:"error"});return}const s=Gi();this._searching=!0,this._onlineMessage="",F();try{const a=await n.SearchLyrics(e,s?s.title:"",s?s.artist:"",s?s.duration:0);this._candidates=Array.isArray(a)?a:[],this._onlineMessage=this._candidates.length?"":"没有找到候选歌词"}catch(a){this._candidates=[],this._onlineMessage="搜索失败："+(a.message||a)}finally{this._searching=!1,F()}}async applyCandidate(e){const n=this._candidates[e];if(!n)return;const s=Gi();if(!s){u("请先播放一首歌曲",{tone:"warning"});return}const a=await sa();if(!a){u("在线歌词后端未就绪",{tone:"error"});return}try{const r=await a.FetchLyrics(n.provider,n.id);if(!r||!r.lrc){u("没有取到歌词",{tone:"warning"});return}const o=await Qs(s.id,r.lrc,r.source||"online",{embed:i.config.embedMeta===!0});ct(s.id,0),v.songId="",u(o?.note||"歌词已应用并保存",{tone:"success",duration:2e3}),F()}catch(r){u("获取歌词失败："+(r.message||r),{tone:"error"})}}async applyNudge(){const e=ye();if(!e.songId){u("请先播放一首歌曲",{tone:"warning"});return}const n=At(e.songId);if(!n){u("当前没有需要应用的调整",{duration:1800});return}if(!e.text){u("这首歌还没有歌词",{tone:"warning"});return}const s=Go(e.text,n),a=await Qs(e.songId,s,"edit:offset",{embed:Yi(e,this)});a!==!1&&(ct(e.songId,0),F(),u(a?.note||"已应用并保存",{tone:"success",duration:2600}))}async ensureDraft(e=!1){const n=ye();!e&&v.songId===n.songId&&v.lines.length||(v.songId=n.songId,v.title=n.song?.title||"",v.lines=n.text?pa(n.text):[],v.cursor=0,v.undo=[],v.dirty=!1,v.kept=0,v.stale=!1,this._nowIndex=-1,this._lastScrolledNow=-1,this._lastScrolledCursor=-1,this._pendingText=n.text||"",F())}scheduleDraftSettle(){this._draftTimer&&clearTimeout(this._draftTimer),this._draftTimer=setTimeout(()=>{this._draftTimer=null,this.syncDraftFromText()},300)}syncDraftFromText(){const e=this.querySelector("[data-editor-text]");if(!e)return;const n=pa(e.value),s=Yo(v.lines,n),a=s.filter((r,o)=>typeof r.time=="number"&&!(n[o]&&typeof n[o].time=="number")).length;Ft(),v.lines=s,v.cursor>=s.length&&(v.cursor=Math.max(0,s.length-1)),v.dirty=!0,v.kept=a,F()}serializeDraftText(){return v.lines.map(e=>typeof e.time=="number"?Qt(e.time)+e.text:e.text).join(`
`)}setDraftText(e){this._pendingText=e,F()}async saveDraft(){const e=ye(v.songId);if(!e.songId){u("还没有可保存的内容：先播放一首歌再编辑",{tone:"warning"});return}const n=v.lines.filter(c=>typeof c.time=="number"&&Number.isFinite(c.time));if(!n.length){u("至少要先给一行打上时间",{tone:"warning"});return}const s=v.lines.length-n.length;let a=!1,r=-1/0;for(const c of v.lines)if(typeof c.time=="number"){if(c.time<r){a=!0;break}r=c.time}if(s||a){const c=p`
      ...
      `;if(!await xu({title:s?"还有歌词没有打轴":"时间不是升序",body:c,okText:"继续保存",cancelText:"返回编辑"}))return}const o=li(v.lines),l=await Qs(e.songId,o,"manual",{embed:Yi(e,this)});l!==!1&&(ct(e.songId,0),v.undo=[],v.dirty=!1,v.songId=e.songId,F(),u(l?.note||"歌词已保存",{tone:"success",duration:2600}))}async copyLrc(){const e=li(v.lines);if(!e){u("还没有可复制的歌词",{duration:1800});return}try{await navigator.clipboard.writeText(e),u("LRC 已复制到剪贴板",{tone:"success"})}catch{const n=document.createElement("textarea");n.value=e,n.style.cssText="position:fixed;left:-9999px;top:0;",document.body.appendChild(n),n.select();let s=!1;try{s=document.execCommand("copy")}catch{s=!1}n.remove(),u(s?"LRC 已复制到剪贴板":"复制失败，请手动选中文本",{tone:s?"success":"warning"})}}paintNowRow(){const e=performance.now();if(e-this._lastNowPaint<200)return;this._lastNowPaint=e;let n=-1;for(let s=0;s<v.lines.length;s+=1){const a=v.lines[s].time;typeof a=="number"&&a<=i.position&&(n=s)}if(n===this._nowIndex){this.scrollDraftRows();return}this._nowIndex=n,F()}scrollDraftRows(){const e=this.querySelector("[data-editor-list]");if(e){if(v.cursor!==this._lastScrolledCursor){this._lastScrolledCursor=v.cursor;const n=e.querySelector(`[data-i="${v.cursor}"]`);n&&this.followScroll(e,n)}if(this._nowIndex!==this._lastScrolledNow){this._lastScrolledNow=this._nowIndex;const n=e.querySelector(`[data-i="${this._nowIndex}"]`);n&&this._nowIndex>=0&&this.followScroll(e,n)}}}}te("mp-lyrics-panel",uu);let lo=0;function F(){lo+=1,he()}const Ye=()=>document.querySelector("mp-lyrics-panel");function pu(t){i.lyricsOpen=!0,F();const e=Ye();e&&(e._refreshHeader(),fs().then(()=>{e._pendingText=ye().text||"",V==="edit"&&e.ensureDraft(!0),V==="online"&&e.refreshOnlineHint(),F()}))}function Pa(){i.lyricsOpen=!1;const t=ye();t.songId&&At(t.songId)&&(ct(t.songId,0),u("未应用的微调已丢弃",{duration:1800})),F()}function fu(t){i.lyricsOpen?Pa():pu()}function hu(t){V=t==="nudge"||t==="edit"?t:"online";const e=Ye();e&&(V==="edit"&&e.ensureDraft().then(()=>F()),V==="online"&&e.refreshOnlineHint?.()),F()}function Gi(){return Ge(i.currentId)||null}function mu(t){return String(t?.ext||"").replace(/^\./,"").toLowerCase()}function Yi(t,e){const n=e?.querySelector("[data-embed-toggle]"),s=e?.querySelector("[data-notice-opt]");return(t.source==="embedded"||t.source==="lrc-file")&&s&&n?!!n.checked:i.config.embedMeta===!0}function Xi(t,e){let n=-1;for(let s=0;s<t.length&&t[s].time+e<=i.position;s+=1)n=s;return n}function co(){return{lower:-1e4,upper:1e4}}function aa(t){const e=ye();if(!e.songId){u("请先播放一首歌曲",{tone:"warning"});return}if(!e.text){u("这首歌还没有歌词，先去在线匹配或手动编辑",{tone:"warning",duration:2600});return}const n=co(),s=Math.max(n.lower,Math.min(n.upper,At(e.songId)+t));ct(e.songId,s),F()}function Qi(t){const e=ye();if(!e.songId||!e.text)return;const n=co(),s=Math.max(n.lower,Math.min(n.upper,Math.round(Number(t)||0)));ct(e.songId,s),F()}function gu(){const t=ye();t.songId&&(ct(t.songId,0),F())}function Ft(){v.undo.push({lines:v.lines.map(t=>({...t})),cursor:v.cursor}),v.undo.length>50&&v.undo.shift()}function vu(){const t=v.undo.pop();if(!t){u("没有可撤销的操作",{duration:1500});return}v.lines=t.lines,v.cursor=Math.min(t.cursor,Math.max(0,t.lines.length-1)),v.dirty=!0,Ye()?.setDraftText(Cs()),F()}function Cs(){return v.lines.map(t=>typeof t.time=="number"?Qt(t.time)+t.text:t.text).join(`
`)}function Ji(t){if(!v.lines.length)return;const e=Math.max(0,Math.min(v.lines.length-1,v.cursor+t));e!==v.cursor&&(v.cursor=e,F())}function La(t){!Number.isFinite(t)||t<0||t>=v.lines.length||t===v.cursor||(v.cursor=t,F())}function ia(){if(!v.lines.length){u("先把歌词粘到上面的文本框里",{tone:"warning",duration:2200});return}if(uo()){u("已切歌：先决定这份草稿怎么办（保存它，或点「载入当前歌词」重来）",{tone:"warning",duration:4200});return}const t=v.lines[v.cursor];t&&(Ft(),t.time=Math.round(i.position/10)*10,v.dirty=!0,v.cursor<v.lines.length-1&&(v.cursor+=1),Ye()?.setDraftText(Cs()),F())}function bu(t){const e=v.lines[t];!e||typeof e.time!="number"||(Ft(),e.time=null,v.dirty=!0,Ye()?.setDraftText(Cs()),F())}function yu(){v.lines.length&&(Ft(),v.lines.forEach(t=>{t.time=null}),v.cursor=0,v.dirty=!0,Ye()?.setDraftText(Cs()),u("已清空全部时间，可以重新打轴",{duration:2e3}),F())}function _u(){const t=ye();if(!t.text){u("这首歌还没有歌词可载入",{duration:2e3});return}Ft(),v.lines=pa(t.text),v.cursor=0,v.dirty=!0,v.songId=t.songId,v.title=t.song?.title||"",Ye()?.setDraftText(t.text),u("已载入当前歌词，可以逐行修正时间",{duration:2200}),F()}function wu(){Ft(),v.lines=[],v.cursor=0,v.dirty=!0,Ye()?.setDraftText(""),F()}function $u(t){const e=v.lines[t];if(!e)return;let n=e.time;if(typeof n!="number"){for(let s=t-1;s>=0;s-=1)if(typeof v.lines[s].time=="number"){n=v.lines[s].time;break}}if(typeof n!="number"){u("这一行还没有时间，无法跳转",{duration:1600});return}$t(n),La(t)}function uo(){return!!v.songId&&ye().songId!==v.songId&&ku()}function ku(){return v.lines.some(t=>typeof t.time=="number")}function Su(){$n()}function xu({title:t,body:e,okText:n,cancelText:s}){return new Promise(a=>{let r=!1;const o=l=>{r||(r=!0,a(l))};ee({title:t,body:e,okText:n,cancelText:s,onOk:()=>(o(!0),!0),onCancel:()=>(o(!1),!0)})})}const ra={sequence:{icon:"repeat",label:"列表循环"},"loop-all":{icon:"repeat",label:"列表循环"},"loop-one":{icon:"repeat-one",label:"单曲循环"},shuffle:{icon:"shuffle",label:"随机播放"}};function po(t){const e=typeof t=="boolean"?t:!i.queueOpen;i.queueOpen=e,e&&(i.optionsOpen=!1),x()}function fo(t){const e=typeof t=="boolean"?t:!i.optionsOpen;i.optionsOpen=e,e&&(i.queueOpen=!1),x()}function ho(t){const e=typeof t=="boolean"?t:!i.sleepOpen;i.sleepOpen=e,x()}function mo(){return vo(i.config.showDesktopLyrics?G.off:G.lyrics,{on:"已开启桌面歌词",off:"已关闭桌面歌词"})}function go(){return vo(i.config.showDesktopWallpaper?G.off:G.wallpaper,{on:"已开启桌面背景歌词",off:"已关闭桌面背景歌词"})}async function vo(t,{on:e,off:n}){const s=await Qr(t);return x(),s.ok!==!1?(u(t===G.off?n:e,{duration:1400}),s):(u(`打不开：${s.reason||s.error||"未知原因"}`,{tone:"warning",duration:3200}),s.restored&&u("已保留原来的桌面歌词设置",{duration:1800}),s)}function Cu(t){const e=Math.round(Number(t)||0);if(e<=0){bo("已取消定时停止");return}i.sleepTimer={type:"duration",until:Date.now()+e*6e4,minutes:e},x(),u(`${e} 分钟后停止播放`,{duration:1800})}function bo(t){i.sleepTimer=null,x(),u(t,{duration:1400})}function Tu(t){i.config.sleepAfterSong=!!t,x(),u(i.config.sleepAfterSong?"已开启：倒计时结束后等当前歌曲播完再停":"已关闭：倒计时结束后立即停止",{duration:2200})}function Eu(){const t=i.sleepTimer;if(!(t?.type!=="duration"||Date.now()<t.until)){if(i.config.sleepAfterSong===!0&&i.playing&&i.currentId){i.sleepTimer={type:"after-song"},x(),u("定时到点：等这首播完就停",{duration:2400});return}i.sleepTimer=null,i.playing?$n():x(),u("已按定时停止播放",{duration:1800})}}class Iu extends me{static deps=e=>[e.currentId,e.playing,e.position,e.duration,e.volume,e.muted,e.playMode,e.likedIds,e.queue.length,e.queueOpen,e.optionsOpen,e.sleepOpen,e.sleepTimer,e.config.showDesktopLyrics,e.config.showDesktopWallpaper,e.desktopWallpaperSupport,e.lyricsOpen,kn()];constructor(){super(),this._progress=null,this._volume=null,this._tick=null}onConnected(){this._tick=setInterval(()=>{i.sleepTimer&&this.requestUpdate()},1e3)}onDisconnected(){this._tick&&clearInterval(this._tick),this._tick=null}firstUpdated(){const e=this.querySelector("#progress");this._progress=dt(e,{min:0,max:1e3,step:1,value:0,format:n=>xt(n/1e3*(i.duration||0)),onChange:n=>{i.duration&&(i.position=n/1e3*i.duration,this.requestUpdate())},onCommit:n=>{i.duration&&ps(n/1e3*i.duration)}}),this._volume=dt(this.querySelector("#volume"),{min:0,max:1,step:.01,value:i.volume,format:n=>`${Math.round(n*100)}`,onChange:n=>{ca(n),Nt(),this.requestUpdate()}})}updated(){const e=Math.round(i.position),n=Math.round(i.duration||0),s=this.querySelector("#progress");s&&s.dataset.dragging!=="true"&&n>0&&this._progress?.set(e/n*1e3,{silent:!0}),this._progress?.setDisabled(n<=0);const a=i.muted?0:i.volume,r=this.querySelector("#volume");r&&r.dataset.dragging!=="true"&&this._volume?.set(a,{silent:!0}),Eu()}render(){const e=Mt(),n=i.currentId?Ot(i.currentId):!1,s=ra[i.playMode]||ra.sequence,a=i.muted?0:i.volume,r=a===0?"volume-mute":a<.5?"volume-low":"volume-high",o=e?ht(e):"",l=i.sleepTimer,c=l?.type==="duration"?Math.max(1,Math.ceil((l.until-Date.now())/6e4)):0;return p`
      <footer class="playerbar" id="playerbar">
        <div class="playerbar__progress">
          <span class="progress__time" id="time-current">${xt(i.position)}</span>
          <div
            class="slider"
            id="progress"
            role="slider"
          ...
          <span class="progress__time progress__time--total" id="time-total">${xt(i.duration)}</span>
        </div>
        ...
        <div class="playerbar__row">
          <div class="playerbar__now">
            <button
              ...
              @click=${()=>Ma()}
            >
              <img id="bar-cover-img" alt=${e?`${e.title} 封面`:""} src=${ni(o)} />
              <svg class="playerbar__cover-icon"><use href="#i-expand"></use></svg>
            </button>
            <div class="playerbar__meta" id="bar-meta" data-tip="播放详情页" @click=${()=>Ma()}>
          ...
          <div class="playerbar__center">
            <div class="transport">
              <button class="transport__btn" id="btn-prev" type="button" data-tip="上一曲" aria-label="上一曲" @click=${()=>qa()}>
                ${f("prev")}
              </button>
              <button
              ...
              <button class="transport__btn" id="btn-next" type="button" data-tip="下一曲" aria-label="下一曲" @click=${()=>hn(!1)}>
                ${f("next")}
              </button>
            </div>
          </div>
          ...
          <div class="playerbar__tools">
            ...
            <button
              ...
              data-tip=${s.label}
              aria-label=${s.label}
              @click=${()=>{Bo(),u((ra[i.playMode]||s).label,{duration:1400})}}
            >
    ...
    `}sleepTip(e){return e?.type==="duration"?`定时停止 · 剩余 ${Math.max(0,Math.round((e.until-Date.now())/1e3))} 秒`:e?.type==="after-song"?"定时停止 · 播完当前歌曲":"定时停止"}onLike(){if(!i.currentId)return;vs(i.currentId);const e=Ot(i.currentId);u(e?"已加入「我喜欢」":"已从「我喜欢」移除",{tone:e?"success":"info",duration:1500})}openAddToPlaylistMenu(e){const n=Mt();if(!n){u("还没有正在播放的歌曲",{duration:1600});return}const s=[];for(const a of i.playlists.filter(r=>!r.locked))s.push({id:a.id,label:a.name,icon:a.id==="liked"?"heart":"playlist",checked:a.songIds.includes(n.id)});s.length||s.push({id:"__none",label:"还没有可用的歌单",disabled:!0}),s.push({id:"__sep",kind:"sep"}),s.push({id:"__new",label:"新建歌单…",icon:"plus"}),vn({anchor:e,x:0,y:0,align:"right",items:s,onPick:async a=>{if(!(a==="__none"||a==="__sep")){if(a==="__new"){Pr(r=>{r&&ds(r.id,[n.id])});return}ds(a,[n.id])}}})}}function Du(){const t=i.queueOpen;po(),!t&&i.currentId&&requestAnimationFrame(()=>ao({notify:!1}))}te("mp-playerbar",Iu);class In extends me{get open(){return!1}get panelEl(){return null}updated(){const e=this.panelEl;if(e){if(this.open){this._closeTimer&&(clearTimeout(this._closeTimer),this._closeTimer=null),e.hidden?(e.hidden=!1,e.dataset.state="",requestAnimationFrame(()=>{this.open&&(e.dataset.state="opened")})):e.dataset.state!=="opened"&&(e.dataset.state="opened");return}e.hidden||(e.dataset.state="closed",!this._closeTimer&&(this._closeTimer=setTimeout(()=>{this._closeTimer=null,!this.open&&e&&(e.hidden=!0)},Bt()+40)))}}disconnectedCallback(){this._closeTimer&&clearTimeout(this._closeTimer),this._closeTimer=null,super.disconnectedCallback()}bindDismiss(e){const n=a=>{const r=this.panelEl;!r||r.hidden||r.contains(a.target)||a.target.closest?.(e)||this.close()},s=a=>{if(a.key!=="Escape")return;const r=this.panelEl;r&&!r.hidden&&this.close()};document.addEventListener("pointerdown",n),document.addEventListener("keydown",s),this._undismiss=()=>{document.removeEventListener("pointerdown",n),document.removeEventListener("keydown",s)}}close(){}}class Au extends In{static deps=e=>[e.queueOpen,e.queue,e.currentId,e.playing,kn()];get open(){return!!i.queueOpen}get panelEl(){return this.querySelector("#queue-panel")}close(){po(!1)}firstUpdated(){this.bindDismiss("#btn-playlist"),this.bindDrag()}updated(){super.updated(),this.bindDrag()}bindDrag(){const e=this.querySelector("#queue-panel-body");e&&(this._sortable&&this._sortable.el===e||(this._sortable?.destroy(),this._sortable=T.create(e,{draggable:".queue-item",animation:0,ghostClass:"is-dragging",onEnd:n=>{ro();const s=n.oldIndex,a=n.newIndex;if(s==null||a==null||s===a)return;const r=n.from,o=Array.from(r.children).filter(l=>l!==n.item);r.insertBefore(n.item,o[s]??null),lr(s,a),u("已调整播放顺序 · 播放模式已切回列表循环",{duration:1600})}})))}disconnectedCallback(){this._sortable?.destroy(),this._sortable=null,this._undismiss?.(),super.disconnectedCallback()}render(){const e=i.queueOpen?i.queue.map(n=>Ge(n)).filter(Boolean):[];return p`
      <section class="queue-panel" id="queue-panel" hidden data-state="closed" aria-label="播放列表">
        <div class="queue-panel__head">
          ...
          <button class="queue-panel__btn" id="queue-locate" type="button" data-tip="定位到当前播放" aria-label="定位到当前播放" @click=${()=>ao()}>
            ${f("disc")}
          </button>
          <button
    ...
    `}item(e){const n=i.queue.indexOf(e.id),s=e.id===i.currentId;return p`
      ...
      >
        ...
        <span class="queue-item__cover"><img src=${ni(ht(e))} alt="" loading="lazy" /></span>
    ...
    `}onClick(e){if(oo())return;const n=e.target.closest("[data-queue-del]");if(n){e.stopPropagation(),la(n.dataset.queueDel);return}const s=e.target.closest("[data-queue-id]");s&&oi(s.dataset.queueId)}onKey(e){if(e.key!=="Enter"&&e.key!==" ")return;const n=e.target.closest?.("[data-queue-id]");n&&(e.preventDefault(),oi(n.dataset.queueId))}}te("mp-queue-panel",Au);class Mu extends In{static deps=e=>[e.optionsOpen,e.config.lyricsFontSize,e.config.glassAlpha,e.config.glassBlur,e.config.glassBlurCustom,e.config.showDesktopLyrics,e.config.showDesktopWallpaper];get open(){return!!i.optionsOpen}get panelEl(){return this.querySelector("#options-panel")}close(){fo(!1)}firstUpdated(){this.bindDismiss("#btn-options"),this._sliders={size:dt(this.querySelector("#opt-lyric-size"),{min:12,max:26,step:1,value:i.config.lyricsFontSize,format:e=>`${Math.round(e)}px`,onChange:e=>{i.config.lyricsFontSize=e,lt("--lyric-size",`${e}px`),this.requestUpdate()},onCommit:()=>x()}),alpha:dt(this.querySelector("#opt-alpha"),{min:20,max:95,step:1,value:i.config.glassAlphaCustom?i.config.glassAlpha:ga(),format:e=>`${Math.round(e)}%`,onChange:e=>{i.config.glassAlpha=e,i.config.glassAlphaCustom=!0,Ua(e),this.requestUpdate()},onCommit:()=>x()}),blur:dt(this.querySelector("#opt-blur"),{min:0,max:48,step:1,value:i.config.glassBlurCustom?i.config.glassBlur:va(),format:e=>`${Math.round(e)}px`,onChange:e=>{i.config.glassBlur=e,i.config.glassBlurCustom=!0,lt("--glass-blur",`${e}px`),this.requestUpdate()},onCommit:()=>x()})}}disconnectedCallback(){this._undismiss?.(),super.disconnectedCallback()}render(){const e=Math.round(i.config.lyricsFontSize),n=Math.round(i.config.glassAlphaCustom?i.config.glassAlpha:ga()),s=Math.round(i.config.glassBlurCustom?i.config.glassBlur:va());return p`
      ...
      <section class="sleep-panel" id="sleep-panel" hidden data-state="closed" aria-label="定时停止">
        ...
        <div class="sleep-panel__body" id="sleep-panel-body">
          ...
          <div class="sleep-panel__row">
            <button class="btn btn--sm" type="button" data-sleep-act="off" @click=${()=>bo("已取消定时停止")}>
    ...
    `}}te("mp-download-panel",qu);function Fn(t){const e=Number(t)||0;if(e<=0)return"0 B";const n=["B","KB","MB","GB"];let s=0,a=e;for(;a>=1024&&s<n.length-1;)a/=1024,s+=1;return`${a>=10||s===0?Math.round(a):a.toFixed(1)} ${n[s]}`}function Ru(t){const e=String(t||""),n=Math.max(e.lastIndexOf("\\"),e.lastIndexOf("/"));return n>=0?e.slice(n+1):e}class Nu extends In{static deps=()=>[N.open,N.songId,N.rev,kn(),i.config.coverCarousel,i.config.embedMeta];get open(){return N.open}get panelEl(){return this.querySelector("#cover-layer")}close(){nn()}render(){const e=this.song();return p`
      <div
        class="cover-layer"
        id="cover-layer"
        data-state="closed"
      ...
      >
        <div class="cover-layer__panel" role="dialog" aria-modal="true" aria-label="封面管理">
          <div class="cover-layer__head">
            ...
            <span class="u-spacer"></span>
            <button class="cover-layer__close" type="button" data-cover-close aria-label="关闭封面管理" @click=${()=>nn()}>
              ${f("close")}
            </button>
          </div>
    ...
    `}song(){const e=N.songId;return e&&i.songs.find(n=>n.id===e)||null}panel(e){const n=N,s=So(e);return p`
    ...
    </div>`}function Wu(t){const e=t.aiVendor||"auto",n=Lr(e),s="开启后模型会先推理再给结论，响应更慢；关闭则直接作答";return e==="auto"?s+"；自动识别："+(n||"按接口地址与模型名判断厂商"):n?s+"；该厂商："+n:s}function Un(t,e,n){return p`
    <div class="rangeslider">
    ...
    </div>`}class Hu extends me{static deps=e=>[e.settingsOpen,e.settingsRev,e.settingsSection,e.view,e.folders,e.filterRules,e.songs,e.allSongsRaw,e.lastScan?.at??0,e.scanning,fl(),Wr(),e.config,e.coverProviders,e.coverBreaker,e.coverCache,e.loudnessState,e.ffmpegState,e.backdropState,e.volume];constructor(){super(),this._activeSection=zn[0].id,this._navPausedUntil=0,this._sliders=new WeakMap}get open(){return mr()}get panelEl(){return this.querySelector("#settings-layer")}updated(){const e=this.panelEl;if(e){if(this.open){if(this._closeTimer&&(clearTimeout(this._closeTimer),this._closeTimer=null),e.hidden){e.hidden=!1,e.dataset.state="",requestAnimationFrame(()=>{this.open&&(e.dataset.state="opened")});const n=this.querySelector(".settings-layer__body");n&&(n.scrollTop=0)}this.bindSliders(),Vd();return}e.hidden||(e.dataset.state="closed",!this._closeTimer&&(this._closeTimer=setTimeout(()=>{this._closeTimer=null,!this.open&&e&&(e.hidden=!0)},Bt()+40)))}}disconnectedCallback(){this._closeTimer&&clearTimeout(this._closeTimer),this._closeTimer=null,super.disconnectedCallback()}render(){return Ui(),p`
      <section
          ...
          <div class="settings-layer__body">
            <div class="settings">
              <div class="settings__nav" role="tablist">
                ${zn.map(e=>p`<button class="settings__nav-item" type="button" role="tab" data-goto=${e.id} aria-selected=${String(e.id===this._activeSection)}>${e.label}</button>`)}
              </div>
              ${this.foldersCard()}
              ${this.rulesCard()}
              ${this.themeCard()}
    ...
    `}foldersCard(){const e=i.folders.length?i.folders.map(n=>{const s=n.status==="ok"?p`<span class="chip chip--ok"><i class="chip__dot"></i>${n.watching?"监听中":"已停止监听"}</span>`:n.status==="missing"?p`<span class="chip chip--error"><i class="chip__dot"></i>路径不存在</span>`:p`<span class="chip chip--warn"><i class="chip__dot"></i>无访问权限</span>`,a=i.songs.filter(r=>r.path.startsWith(n.path)).length;return p`
      ...
      </div>`}rulesCard(){const{kept:e,excluded:n,total:s}=cr(i.allSongsRaw,i.filterRules);return p`
      ...
      </section>`}themeCard(){const e=bs(),n=Ui(),s=window.matchMedia("(prefers-color-scheme: dark)").matches;return p`
      <section class="card" id="sec-appearance" data-section="appearance">
        ...
        <div class="card__body">
          ...
          ${B({label:"窗口原生材质",hint:"用系统原生的半透明材质当窗口底色（桌面壁纸会透出来）。仅 Windows 11 Build 22621+ 有完整效果，改动需重启应用",control:p`
              <div class="select">
                <select class="select__field" data-act="backdrop-mode" aria-label="窗口原生材质">
                  ${qr.map(a=>p`<option value=${a} ?selected=${(i.config.nativeBackdrop||"off")===a}>${Jn(a)}</option>`)}
                </select>
          ...
          ${B({label:"过渡速度",hint:"弹出层、菜单、面板的进出动画时长；默认快速 0.2 秒",control:Oe("animationsSpeed",Cd,i.config.animationsSpeed||"fast")})}
      ...
      </div>`}playerCard(){const e=ms(),n=Ur();return p`
      ...
      <section class="card" id="sec-playback" data-section="playback">
        ...
        <div class="card__body">
          ...
          ${B({label:"单击歌曲时的行为",hint:"双击始终是「立即播放这一首」；这个设置只影响单击",control:Oe("rowClickAction",Sd,i.config.rowClickAction||"next")})}
        </div>
      ...
      <section class="card" id="sec-loudness" data-section="loudness">
        ...
        <div class="setting setting--stack">
          <div class="progress-line" id="loudness-progress" ?hidden=${!n.running}>
            <div class="progress-line__text" data-role="text">准备测量…</div>
            <div class="progress-line__track"><div class="progress-line__bar" data-role="bar" data-value=${String(n.total?Math.round((n.done||0)/n.total*100):0)}></div></div>
          </div>

          <div class="card__actions">
            <button class="btn btn--sm btn--primary" type="button" data-act="loudness-measure-all">${f("bolt")}<span>预先把全部歌曲算好</span></button>
            <button class="btn btn--sm" type="button" data-act="loudness-cancel">${f("close")}<span>停止</span></button>
        ...
        <div class="card__body">
          ...
          ${B({label:"模型类型",hint:"思考模式的开关参数各家不同，必须选对厂商才会发出正确的请求体；选「自动识别」会按接口地址与模型名判断",control:p`
              <select class="select__field" data-act="ai-vendor" aria-label="模型类型">
                ${Ka.map(a=>p`<option value=${a.id} ?selected=${a.id===(e.aiVendor||"auto")}>${a.label}</option>`)}
              </select>`})}
          ${B({label:"启用思考模式",hint:Wu(e),control:ie("aiThinking",!!e.aiThinking,"启用思考模式")})}
      ...
      <section class="card" id="sec-about" data-section="about">
        ...
        <div class="kv">
          ...
          <div class="kv__k">占用空间</div><div class="kv__v">${xo(s)}</div>
      ...
      </section>`}async onClick(e){if(e.target.closest("[data-settings-close]")||e.target===this.panelEl){ss();return}const n=e.target.closest("[data-goto]")?.dataset.goto;if(n){this.scrollToSection(n);return}const s=e.target.closest("[data-toggle],[data-segment] .segmented__btn");if(s){Kd(s,{commit:x})&&sn(),this.requestUpdate();return}const a=e.target.closest("[data-act]");a&&(await gs(a,{commit:x,render:()=>{i.settingsRev=(i.settingsRev||0)+1,x()},rescan:()=>yn({manual:!0})}),sn())}async onChange(e){if(e.target.dataset.act)try{await gs(e.target,{commit:x,render:()=>{i.settingsRev=(i.settingsRev||0)+1,x()},rescan:()=>yn({manual:!0})}),sn(),this.requestUpdate()}catch(s){console.error("[settings] 处理下拉框失败",s),u(`设置未生效：${s?.message??s}`,{tone:"error",duration:5e3})}}onInput(e){if(e.target.dataset.act!=="rule-value")return;const n=i.filterRules.find(s=>s.id===e.target.dataset.id);n&&(n.value=e.target.value,x(),this.requestUpdate())}onScroll(e){const n=e.target;if(!n.classList?.contains("settings-layer__body")||Date.now()<this._navPausedUntil)return;const s=n.getBoundingClientRect().top+80;let a=zn[0].id;for(const r of zn){const o=this.querySelector(`[data-section="${r.id}"]`);o&&o.getBoundingClientRect().top<=s&&(a=r.id)}a!==this._activeSection&&(this._activeSection=a,this.paintNav())}paintNav(){for(const e of this.querySelectorAll(".settings__nav-item"))e.setAttribute("aria-selected",String(e.dataset.goto===this._activeSection))}scrollToSection(e){const n=this.querySelector(`[data-section="${e}"]`);n&&(this._activeSection=e,this.paintNav(),this._navPausedUntil=Date.now()+600,n.scrollIntoView({behavior:"smooth",block:"start"}))}bindSliders(){for(const e of this.querySelectorAll("[data-slider]")){const n=e.dataset.slider;if(!n)continue;let s=this._sliders.get(e);if(!s){s=dt(e,this.sliderOptions(e,n)),this._sliders.set(e,s);const a=e.parentElement.querySelector(".rangeslider__value");a&&(a.textContent=s.text(this.sliderValue(n)))}s.set(this.sliderValue(n),{silent:!0})}}sliderOptions(e,n){const s=n==="glassBlur",a=n==="glassAlpha",r=n==="coverCarouselInterval",o=r?2:n==="lyricsFontSize"?12:s?0:a?20:0,l=r?60:n==="lyricsFontSize"?26:s?48:a?95:100,c=r?" 秒":s?"px":a?"%":"px";return{min:o,max:l,step:1,value:this.sliderValue(n),format:d=>`${Math.round(d)}${c}`,onChange:d=>{i.config[n]=d;const m=e.parentElement.querySelector(".rangeslider__value");m&&(m.textContent=`${Math.round(d)}${c}`),s&&(i.config.glassBlurCustom=!0,lt("--glass-blur",`${d}px`)),a&&(i.config.glassAlphaCustom=!0,Ua(d)),n==="lyricsFontSize"&&lt("--lyric-size",`${d}px`)},onCommit:()=>x()}}sliderValue(e){return e==="glassBlur"?i.config.glassBlurCustom?i.config.glassBlur:va():e==="glassAlpha"?i.config.glassAlphaCustom?i.config.glassAlpha:ga():i.config[e]??0}}te("mp-settings-layer",Hu);class Vu extends me{static deps=e=>[e.floatingLyrics?.show,e.floatingLyrics?.text];render(){const e=i.floatingLyrics||{show:!1,text:""};return p`
    ...
    `}}te("mp-app",Ku);let pn="";const oa=new Map,jn=new Map;function Gu(){const t=new Image;return t.decoding="async",t.alt="",t}function Yu(t){return!i.config.accentFromCover||!bn(t)?!1:t!==pn}function yo(t){if(!bn(t))return Promise.resolve("");if(oa.has(t))return Promise.resolve(oa.get(t));if(jn.has(t))return jn.get(t);const e=new Promise(n=>{const s=o=>{oa.set(t,o),jn.delete(t),n(o)},a=document.getElementById("bar-cover-img");if(a&&a.getAttribute("src")===t&&a.complete&&a.naturalWidth>0){s(Lt(bi(a)));return}const r=Gu();r.addEventListener("load",()=>s(bn(t)?Lt(bi(r)):"")),r.addEventListener("error",()=>s("")),r.src=t});return jn.set(t,e),e}async function _o(t){t&&Sl(t,t)&&(await sn(),await Ie(i.config))}async function Xu(){if(!i.config.accentFromCover||Lt(i.config.coverSeed))return;const t=i.currentId?Ge(i.currentId):null,e=t?ht(t):"";e&&(pn=e,await _o(await yo(e)))}function Qu(t){if(!i.config.accentFromCover){pn="";return}if(t){if(!bn(t)){pn=t;return}Yu(t)&&(pn=t,yo(t).then(_o))}}function Ju(t){kl(bn(t)?t:"")}let er="";function Zu(t){return[i.currentId??"",i.playing?1:0,Math.round((i.position||0)/250),i.duration||0,i.volume,i.muted?1:0,i.config.loudnessMode||"off",Tn()?1:0,En()?1:0,Math.round(Number(i.config.lyricsFontSize)||16),t].join("|")}function tr(){const t=i.currentId?Ge(i.currentId):null,e=t?ht(t):"",n=Zu(e);n!==er&&(er=n,Mc(),_n(),Tn()&&(i.playing&&fs(),Rc({text:i.playing?jc():"",playing:!!i.playing,fontSize:Math.round((Number(i.config.lyricsFontSize)||16)*1.5)})),En()&&(i.playing&&fs(),Oa()),Qu(e),Ju(e))}function ep(){zo(tr),tr()}const st=new Map;async function tp(){await ys(),await Xu(),await Ie(i.config),window.matchMedia("(prefers-color-scheme: dark)").addEventListener("change",async()=>{i.config.themeMode==="system"&&(await Ie(i.config),x())})}async function np(){if(S())try{const t=await y.coverCachedSets();if(!t||typeof t!="object")return;dr(t);const e=Object.keys(t).length;e&&console.info(`[cover] 已从缓存回填 ${e} 首歌的封面（含多封面）`)}catch(t){console.info("[cover] 封面缓存回填跳过",t?.message??t)}}function sp(){document.addEventListener("keydown",t=>{const e=t.target.tagName,n=e==="INPUT"||e==="TEXTAREA"||e==="SELECT"||t.target.isContentEditable;if(t.key==="Escape"){if(document.getElementById("modal-backdrop")?.hidden===!1)return;Jt(),i.playerOpen&&xs();return}if(!n)switch(t.key){case" ":t.preventDefault(),$n();break;case"ArrowRight":t.ctrlKey||t.metaKey?hn(!1):ps(i.position+5e3);break;case"ArrowLeft":t.ctrlKey||t.metaKey?qa():ps(i.position-5e3);break;case"ArrowUp":t.preventDefault(),ca(i.volume+.05);break;case"ArrowDown":t.preventDefault(),ca(i.volume-.05);break;case"l":case"L":i.currentId&&vs(i.currentId);break;case"p":case"P":Ma();break;case"f":case"F":ap();break}})}async function ap(){if(S()){const t=!document.fullscreenElement;await y.windowSetFullscreen(t);return}document.fullscreenElement?await document.exitFullscreen():await document.documentElement.requestFullscreen().catch(()=>{})}function ip(){se("scan:start",()=>{i.scanning=!0,i.scanText="正在扫描音乐文件夹…",x()}),se("scan:progress",t=>{t&&(t.phase==="walk"?i.scanText="正在遍历音乐文件夹…":t.total&&(i.scanText=`正在读取元数据 ${t.current} / ${t.total}`),x())}),se("scan:done",async t=>{i.scanning=!1;const e=await y.songs();if(Array.isArray(e)){const s=new Set(i.songs.map(o=>o.id));i.allSongsRaw=e;const{kept:a,excluded:r}=cr(e,i.filterRules);i.songs=a,i.lastScan={at:Date.now(),found:e.length,kept:a.length,excluded:r,added:a.filter(o=>!s.has(o.id)).length,removed:[...s].filter(o=>!a.some(l=>l.id===o)).length}}const n=await y.folders();Array.isArray(n)&&(i.folders=n),x(),t?.added&&!t?.firstRun&&u(`文件夹变化：新增 ${t.added} 首`,{tone:"success"})}),se("scan:failed",t=>{i.scanning=!1,x(),u(`扫描失败：${t?.message??"未知错误"}`,{tone:"error",duration:5e3})}),se("theme:changed",t=>{i.config.theme=t,Ie(i.config),x()}),se("player:state",t=>{t&&(typeof t.position=="number"&&(i.position=t.position),typeof t.duration=="number"&&(i.duration=t.duration),typeof t.playing=="boolean"&&(i.playing=t.playing))}),se("cover:changed",async t=>{const e=String(t?.id||"");try{if(!e){const s=await y.coverCachedSets();s&&typeof s=="object"&&dr(s);return}const n=await y.coverList(e);n&&Array.isArray(n.items)&&da(e,n)}catch(n){console.info("[cover] 同步封面失败",n?.message??n)}}),se("loudness:progress",t=>{t&&(i.loudnessState={...i.loudnessState||{},...t,running:!0},x())}),se("loudness:done",async t=>{i.loudnessState={...i.loudnessState||{},running:!1},x();const e=t?.failed??0;u(e?`响度测量完成：成功 ${t?.done-e} 首，失败 ${e} 首`:`响度测量完成：共 ${t?.done??0} 首`,{tone:e?"warning":"success",duration:4e3}),await un(),await ws()}),se("loudness:failed",t=>{i.loudnessState={...i.loudnessState||{},running:!1},x(),u(`响度测量失败：${t?.message??"未知错误"}`,{tone:"error",duration:6e3})}),se("ffmpeg:ready",t=>{t&&(i.ffmpegState=t,x(),console.info(`[ffmpeg] ${t.available?t.describe:"不可用"}`))}),se("download:progress",t=>{if(!t?.bvid)return;const e=t.title||t.bvid,n=Number(t.total)||0,s=Number(t.done)||0,a=n>0?Math.round(s/n*100):0,r=n>0?`下载中 ${a}% · ${e}`:`下载中 ${e}`;st.has(t.bvid)?st.get(t.bvid).update(r):st.set(t.bvid,u(r,{duration:0}))}),se("download:done",t=>{const e=st.get(t?.bvid);st.delete(t?.bvid);const n=`已下载：${t?.title||t?.bvid} → ${t?.path||t?.dir||""}`;e?e.update(n,"success"):u(n,{tone:"success",duration:5e3}),setTimeout(()=>e?.close(),4e3)}),se("download:failed",t=>{const e=st.get(t?.bvid);st.delete(t?.bvid);const n=`下载失败：${t?.message??"未知错误"}`;e?e.update(n,"error"):u(n,{tone:"error",duration:6e3}),setTimeout(()=>e?.close(),6e3)})}function nr(){const t=new URLSearchParams(location.search);if(!t.toString())return;const e=t.get("theme");if(e){i.config.theme=e;const o=ns(e);o?.mode&&(i.config.themeMode=o.mode)}const n=t.get("tab");n==="settings"?i.settingsOpen=!0:n==="queue"?i.view="queue":n==="playlist"&&(i.view="playlist",i.playlistId=t.get("pl")||i.playlists[1]?.id||null);const s=t.get("pv");s&&(i.pvMode=s,i.config.playerViewMode=s),t.get("view")==="player"&&(i.playerOpen=!0),t.get("playing")==="1"&&(i.playing=!0,i.position=Number(t.get("pos")||62e3)),t.get("scan")==="1"&&(i.scanning=!0,setTimeout(()=>{i.scanning=!1,x()},8e3)),t.get("query")&&(i.query=t.get("query"));const a=Number(t.get("songs"));if(!S()&&Number.isFinite(a)&&a>i.songs.length){const o=i.songs.slice();for(;i.songs.length<a;){const l=i.songs.length,c=o[l%o.length];i.songs.push({...c,id:`bench_${l}`,path:`C:/bench/${l}.${c.ext||"mp3"}`})}i.allSongsRaw=i.songs.slice(),x()}const r=t.get("density");r&&["compact","cozy","roomy"].includes(r)&&(i.config.listDensity=r),t.get("album")==="off"&&(i.config.showAlbumColumn=!1)}async function rp(){await jo(),nr();const t=np();await tp(),Hc().then(()=>{mr()&&El()}),await kc(),ul(),Ml(),await Nl(),ud(),sp(),ip(),nr(),ep(),await t,await Ie(i.config),Nt();let e=!1;const n=()=>{e||(e=!0,y.windowReady().catch(()=>{}))};if(setTimeout(n,0),requestAnimationFrame(()=>requestAnimationFrame(n)),await un(),await ws(),Wo(),Co(),window.addEventListener("beforeunload",()=>{sn()}),document.body.dataset.ready="true",new URLSearchParams(location.search).get("probe")==="1"){const{runProbe:s}=await pt(async()=>{const{runProbe:a}=await import("./probe-BTvxc-Wt.js");return{runProbe:a}},[]);setTimeout(()=>{const a=s();window.__probeReport=a,console.info("[probe]",a)},600)}S()||console.info(`%c浏览器预览模式%c
当前使用假数据渲染界面。接入 Go + Wails3 后端后，同名前端的 store/bridge 会自动改走后端方法。`,"background:#fff;color:#000;padding:2px 6px;border-radius:4px;font-weight:700","color:#888")}rp().catch(t=>{console.error("[app] 启动失败",t),u(`启动失败：${t.message}`,{tone:"error",duration:6e3})});window.addEventListener("unhandledrejection",t=>{const e=t.reason,n=e?.message||String(e||"未知错误");/no backend|preview:/i.test(n)||(console.error("[app] 未处理的异步错误",e),u(n.length>120?`${n.slice(0,120)}…`:n,{tone:"error",duration:6e3}))});window.addEventListener("error",t=>{t.message&&console.error("[app] 运行时错误",t.error||t.message)});window.__app={state:i,commit:x,navigate:Ct,openPlayer:Yr,closePlayer:xs,rescan:sr,doRescan:yn,currentSong:Mt,isLiked:Ot,nextIndex:Uo,setPlayerViewMode:wn,applyGainForSong:_n};const si=Object.freeze(Object.defineProperty({__proto__:null,closeCoverPanel:nn,openCoverPanel:Fu},Symbol.toStringTag,{value:"Module"}));
